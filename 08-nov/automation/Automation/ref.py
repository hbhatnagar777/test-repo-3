...
class GoogleCloudVM(HypervisorVM):
    ...
    def __init__(self, hvobj, vm_name):
        ...
        self.validation_function_map = {
            'createPublicIP':  self.validate_public_ip,
            'publicReservedIP': self.validate_public_reserved_ip,
            'privateReservedIP': self.validate_private_reserved_ip,
            'ServiceAccount': self.validate_service_account,
            'CustomMetadata': self.validate_custom_metadata,
            'DiskSnapshotPruning': self.validate_disk_snapshot_pruning,
            'DiskType': self.validate_disk_type,    #change if merged - ask
        }
    ...
    def compute_distribute_workload(self, proxy_obj, vm, **kwargs):
        ...
        for project in vm_dict:
            self.log.info("Project dict info {project}")
    ...
    def validate_disk(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the disk type: pd-standard, pd-ssd, local-ssd, etc.

        Args:

                vm  (object) : Source vm object
                other   (object) : destination VM object
            ...
            Returns:
                If destination's disk is as expected
        
        """
        if len(vm.vm.disk_dict) != len(other.vm.vm.disk_dict):
            self.log.info("Disk Validation failed")
            return False
        return True
    
    def validate_service_account(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the service account of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's service account is as expected
        
        """
        if restore_options.vm_service_account:
    ...
    def validate_custom_metadata(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the custom metadata of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's custom metadata is as expected
    ...
    def validate_disk_type(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the disk type of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's disk type is as expected
    ...
    def validate_public_ip(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the public IP of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's public IP is as expected
    ...
    def validate_public_reserved_ip(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the public reserved IP of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's public reserved IP is as expected
    ...
    def validate_private_reserved_ip(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the private reserved IP of the VM.
        ...
        Args:
            ...
            Returns:
                If destination's private reserved IP is as expected
    ...
    def validate_disk_snapshot_pruning(self, vm, other, method, restore_options, **kwargs):
        """
        Validates the disk snapshot pruning of the VM.
        ...
        Args:
            ...
            Returns:
                If disk snapshot pruning is as expected
