...
"""Helper file that executes the  basic acceptance test cases for EMC Unity, Celerra and VNX NAS Clients

Unity_VNX_BasicAcceptance is the only class defined in this file
...
This class include below cases:
    ...
    10. Restore from secondary copy


Unity_VNX_BasicAcceptance:
...
class Unity_VNX_BasicAcceptance(BasicAcceptance):
