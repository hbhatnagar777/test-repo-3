...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Dell EMC Isilon Replication"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Dell EMC Isilon
        Replication"""
