...
class TestCase(CVTestCase):
    ...
    def run(self):
        ...
        try:
            ...
            self.dedupe_helper = mahelper.DedupeHelper(self)
            ...
            #log_validation
            log_file = "CVMA.log"
            (ml, ms) = self.dedupe_helper.parse_log(self.arrayhelper_obj.controllers,
                                                    'CVMA.log',
                                                    "{0}_COMMVAULT".format(self.child_job_obj.job_id))

            # validating deletion
            if ml and res1 and not res2:
    ...
    def delete_snap(self):
        ...
        self.arrayhelper_obj.controllers = self.tcinputs["ArrayAccessNode"]
        self.arrayhelper_obj.clear_all_access_nodes()
