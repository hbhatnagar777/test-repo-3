...
class TestCase(CVTestCase):
    ...
    def perform_failover(self):
        ...
        self.login()
        job_id = self.replication_helper.perform_unplanned_failover(self.group_name, vms=None,
    ...
    def undo_failover_validations(self, after_operation=False):
        ...
        # Don't perform validations if hypervisor is not vmware or hyper-v
    ...
    def perform_undo_failover(self):
        ...
        if self.unplanned_failover.destination_auto_instance.vsa_instance.instance_name not in ['vmware', 'hyper-v']:
            # Failback VMs which are not from vmware or hyper-v
            self.login()
            ...
            # Undo failover VMs which are vmware or hyper-v
            self.login()
            job_id = (self.replication_helper
    ...
    def post_operation(self):
        """ Run backup and validate sync after undo failover """
        ...
        self.replication.post_validation(validate_test_data=False, job_type="FULL")
