...
TestCase:
    ...
    set_my_helper_object()          --  Creates MySQL helper Object
...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Metallic - Azure MySQL using App Based Authentication
    Example:
        "63090": {
          "Region": "azure region",
          "StorageAccountName": "",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for Azure MySQL using App Based Authentication"
        self.browser = None
    ...
    def tear_down(self):
        ...
        if self.mysql_helper_object:
            ...
            self.mysql_helper_object.cleanup_test_data(database_prefix='metallic_auto_dump_63090')
    ...
    def generate_test_data(self):
        ...
        db_prefix = "metallic_auto_dump_63090"
