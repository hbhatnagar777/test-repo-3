...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Custom Package Installation SP Upgrade on existing Instance"
    ...
    def run(self):
        ...
        try:
            ...
            f_release = self.service_pack[:2] + str(int(self.service_pack[2:]) - self.tcinputs["MinusValue"])
            ...
            # Creating the Custom Package for updating packages on the same Instance
            ...
            self.custom_package_generator.generate_json_for_custom_package(
                **{"CommserveName": self.config_json.Install.commserve_client.client_name,
                   ...
                   "ClientHostName": self.config_json.Install.rc_client.machine_host,
                   "IsToDownload": False,
                   "installOption": "Upgrade Feature Release"
                   })
