...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Hyper V to Amazon conversion in  EBS Direct Mode"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                if self.vsa_obj.source_client == "Hyper-V":
                    ...
                    try:
                        ...
                        self.vsa_obj_aws.transport_mode = "Amazon EBS direct"
                ...
                raise Exception("Source Client is not Hyper-V, Please check the source client vendor and try again", exp)
