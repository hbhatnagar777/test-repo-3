...
"""
Verify pagination options show the corresponding number of rows on the page
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Verify pagination on File Servers page works as expected"
    ...
    def run(self):
        ...
        try:
            self.fs_helper_obj.validate_pagination()
