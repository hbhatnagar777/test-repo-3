...
APIs being validated inside collection file:
    ...
    DELETE /UserGroup/{{userGroupId}}?newUserId=1&newUserGroupId=0
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for User Group operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - User Group Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'UserGroupOperations.collection.json'
