...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.OKTA_url = None
        self.name = "Locked Company Saml Regression when saml app name same company name"
        self.browser = None
    ...
    def init_tc(self):
        ...
        try:
            ...
            self.saml_appname = self.company_name  # Saml app name same as company name
    ...
    def enable_privacy_settings(self):
        """Enable company data privacy for company"""
        self.log.info("Enabling company data privacy for company, {0}.".format(self.company_name))
    ...
    def run(self):
        try:
            ...
            self.log.info("Logging in as tenant admin user")
