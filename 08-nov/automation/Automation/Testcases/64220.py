...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Automation- Nutanix AHV failover validation with controller proxy services down for streaming job"
    ...
    def run(self):
        ...
        try:
            ...
            vmjobs = auto_subclient.check_jobstatus_to_stop_services(proxy_list[1])
            ...
            auto_subclient.start_service(proxy_list[1], self.tcinputs.get('username'), self.tcinputs.get('password'))
