...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VSA GCP backup and Restore [to proxy project] test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA Google cloud Full Backup and Restore [to proxy project] Cases"
