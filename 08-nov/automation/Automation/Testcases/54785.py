...
from NAS.NASUtils.Isiloncifssnapbasicacceptance import IsilonCIFSSnapBasicAcceptance
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("NewAutomation Isilon - V2 - Windows MA - Basic Acceptance "\
    ...
    def run(self):
        ...
        try:
            ...
            basic_acceptance = IsilonCIFSSnapBasicAcceptance(self)
