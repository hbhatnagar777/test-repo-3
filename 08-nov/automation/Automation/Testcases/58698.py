...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Openstack cinder boundary quota validation"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                raise Exception
            self.log.info('-----Getting volume limits for a project-----')
            try:
            ...
            try:
                self.hvobj.OpenStackHandler.set_boundary_quota_volume(project_name)
                self.log.info(
                ...
                raise Exception
            self.log.info(
                '-----Getting volume limits for a project after setting quota before backup-----')
            try:
                quotalimit3 = self.hvobj.OpenStackHandler.get_volume_limits(project_name)
                self.log.info(
                    'Got volume limits for the project'+str(project_name))
            except Exception as err:
                self.log.error(
            ...
            self.log.info('-----Getting volume limits for a project after the backup-----')
            try:
                quotalimit4 = self.hvobj.OpenStackHandler.get_volume_limits(project_name)
                self.log.info(
                    'Got volume limits for the project'+str(project_name))
            except Exception as err:
                self.log.error(
            ...
            self.log.info('-----Getting volume limits for a project after restore-----')
            try:
                quotalimit5 = self.hvobj.OpenStackHandler.get_volume_limits(project_name)
                self.log.info(
                    'Got volume limits for the project'+str(project_name))
            except Exception as err:
                self.log.error(
