...
class TestCase(CVTestCase):
    """Class for executing
        ...
        Step6,  Run a incremental backup followed by synthfull and verify it completes
                    without failures.
    ...
    def __init__(self):
        ...
        self.name = "Restore of single and multiple objects for regular scan"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Step6, Run a incremental backup and  verify it completes without failures.")
