...
class TestCase(CVTestCase):
    """Class for verifying proxy distribution during restore to the same hypervisor for VMware from Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Proxy workload validation for full VM restore to same hypervisor from command center"
