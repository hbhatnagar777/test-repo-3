...
class TestCase(CVTestCase):
    ...
    def setup(self):
        ...
        self.vsa_obj.aux_copy_name = self.tcinputs['Source_copy']
        self.vsa_obj.storage_policy_name = self.tcinputs['Storage_Policy']
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                self.vsa_obj_aws.transport_mode = self.tcinputs['transport_mode']
