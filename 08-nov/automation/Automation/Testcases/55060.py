...
Inputs:
    ...
    SnapEngine          --      snap engine to set at at values :
                				Dell Storage Center Snap (Deprecated)
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Dell Compellent"
        self.snapengine_list = ['Dell Storage Center Snap (Deprecated)']
        self.browser = None
