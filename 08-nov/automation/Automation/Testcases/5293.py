...
class TestCase(CVTestCase):
    ...
    def run_restore(self):
        ...
        redirect_tablespace_path = {self.tablespace_name: self.db2_helper.get_datafile_location() + "_new"}
        restore_job_id = restore_job.in_place_restore(endlogs=True, redirect=True, redirect_tablespace_path=redirect_tablespace_path)
        ...
        self.db2_helper.container_path_validation(self.tablespace_name, self.db2_helper.get_datafile_location() + "_new")
