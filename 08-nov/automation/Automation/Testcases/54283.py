...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Virtual Server - HyperV - Live sync - FULL backup," \
                    " KILL a FULL replication job and validation"
    ...
    def run(self):
        ...
        try:
            ...
            for vm_pair in live_sync_pair.vm_pairs:
                ...
                sync_status = 1
                for vm in job_status:
                    if vm['vmName'] == vm_pair_obj.source_vm:
                        sync_status = int(vm['syncStatus'])
