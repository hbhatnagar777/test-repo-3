...
class TestCase(CVTestCase):
    """Class For executing basic acceptance test of of Sensitive data governance for share point files \
         configured to use Sharepoint Classic (V1) Service account from Activate in AdminConsole"""
    test_step = TestStep()
    ...
    def add_sharepoint_datasource(self):
        ...
        self.gdpr_obj.file_server_lookup_obj.add_share_point_server(
            ...
            cs.USA_COUNTRY_NAME,
            backupset=_SHAREPOINT_CONFIG_DATA.V1.Backupset.ServiceAccount,
            sites=list_of_sites
        )
