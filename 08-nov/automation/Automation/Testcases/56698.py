...
APIs being validated inside collection file:
    GET DIP's for a client
    POST ADD DIP's between two clients
    POST ADD DIP's between client group and client
    POST UPDATE DIP's between two clients
    POST DELETE DIP's
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Data Interface Pair Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'DataInterfacePairs.collection.json'
