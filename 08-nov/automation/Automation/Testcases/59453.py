...
APIs being validated inside collection file:
    GET /AdvanceKeyInfo?relativePath={{CommServDB.GxGlobalParam}}
    POST /Client/{{ClientID}}/AdditionalSettings
    GET /Client/{{ClientID}}/AdditionalSettings?relativePath={{CommServDB.GxGlobalParam}}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Global Developer Settings on Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Developer Settings Command Center - Global settings"
    ...
    def run(self):
        ...
        try:
            collection_json = 'AdditionalSettingsGlobalLevel.collection.json'
