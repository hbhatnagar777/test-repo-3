...
class TestCase(CVTestCase):
    """Class for executing the test case of  Office365 - SharePoint Online: GCC Cloud Basic Acceptance case"""
    ...
    def __init__(self):
        ...
        self.name = "Office365 - SharePoint Online: GCC Cloud Basic Acceptance case"
    ...
    def run(self):
        ...
        try:
            self.sp_client_object.cvoperations.add_share_point_pseudo_client(
                cloud_region=sharepointconstants.CLOUD_REGIONS['U.S. Government GCC'])
