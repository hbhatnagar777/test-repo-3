...
class TestCase(CVTestCase):
    """ GUI Backup and out of place restore to same instance different DB check from Dump location for archived logs """
    ...
    def __init__(self):
        ...
        self.name = "Test for DB2 1 Min RPO from GUI to verify out of place restore from Dump location for archived logs"
    ...
    def setup(self):
        ...
        self.table_name = "T64421"
        self.tablespace_name = "TS64421"
