...
class TestCase(CVTestCase):
    ...
    def setup(self):
        ...
        (self.primary_ma_machine, self.primary_ma_path) = self.ma_helper.generate_automation_path(self.primary_ma, 10000)
        (self.secondary_ma_machine, self.secondary_ma_path) = self.ma_helper.generate_automation_path(self.secondary_ma, 10000)
        (self.ddb_ma_machine, self.ddb_ma_path) = self.ma_helper.generate_automation_path(self.ddb_ma, 10000)
        (self.ddb_ma_secondary_machine, self.ddb_ma_secondary_path) = self.ma_helper.generate_automation_path(self.ddb_ma_secondary, 10000)
    ...
    def run(self):
        try:
            ...
            self.log.info("Powering-off all the Cloud Media Agents")
            self.power_management.power_off_media_agents([self.primary_ma_obj, self.ddb_ma_obj])
