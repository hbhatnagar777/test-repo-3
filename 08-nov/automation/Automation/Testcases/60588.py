...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Vmware Full Snap backup and and cross Vcenter Restore"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = 'VSA VMWARE Full Snap Backup, Backup Copy and cross Vcetner restore'
    ...
    def run(self):
        ...
        try:
            ...
            if not VirtualServerUtils.cross_client_restore_pre_validation(self):
                ...
                self.failure_msg = "Source and destination Vcenters are Same"
