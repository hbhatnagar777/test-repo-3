...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] Performance testing for Plan APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "minutes": self.tcinputs.get("minutes", "18"),
                       "apiList": "get_plan,get_pools,create_plan,get_plan_details",
                       "email": self.tcinputs["email"],
                       "storagePoolName": self.tcinputs["storagePoolName"],
