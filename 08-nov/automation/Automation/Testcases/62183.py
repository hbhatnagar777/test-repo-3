...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ":[REST API - Locust] : Performance testing for Infrastructure Page  (Resource Pool, IndexServer) V4 API"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_resourcepool_papi,get_resourcepool_details,get_indexserver_papi,get_client_details",
