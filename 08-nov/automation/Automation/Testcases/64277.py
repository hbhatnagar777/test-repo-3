...
class TestCase(CVTestCase):
    ...
    @test_step
    def perform_point_in_time_restore_from_first_incremental_job(self):
        """
        Performs a point-in-time restore from the first incremental backup job.
        only old buckets should get restored.
        """
        try:
            self.log.info("Performing Point-in-Time Restore from the First Incremental Backup Job")
            ...
            self.log.info("Point-in-Time Restore from the First Incremental Backup Job Successful")
    ...
    def perform_point_in_time_restore_from_second_incremental_job(self):
        ...
        All buckets should get restored.
        """
        try:
    ...
    def run(self):
        ...
        """
        self.perform_backup()
        self.perform_point_in_time_restore_from_first_incremental_job()
