...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Attach disk restore to same instance from a snap copy for the Tenant account with root volume filtered"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Attach disk restore to Existing instance from snap copy for admin account instance with root volume filtered"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.backup()
            decorative_log("Attach disk restore from Snap copy for the Tenant account")
