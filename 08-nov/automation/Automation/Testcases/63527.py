...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][EdgeMode] - Laptops listing page validation"""
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][EdgeMode] - Laptops listing page validation"
    ...
    def run(self):
        ...
        try:
            ...
            self.edgeHelper_obj.validate_listing_page_in_edgemode(options=self.tcinputs["osc_options"])
