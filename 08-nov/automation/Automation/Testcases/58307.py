...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute
                            ...
                            suspend and resume Snap Backup with Catalog and Backup Copy.
"""
...
class TestCase(CVTestCase):
    """Class for executing suspend and resume Snap Backup with Catalog and Backup Copy"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : suspend and resume Snap Backup with Catalog and Backup Copy"""

    def run(self):
        """Main function for test case execution
        Steps:
            1. Add arrays and create intellisnap entities.
            2. disable skip catalog and enable inline backup copy and Run Full inline Snap backup.
            ...
            7. disable inline backup and run Full snap backup followed by offline backup copy
                which suspends the job in each phase.
            8. verify outplace restore from backup copy followed by run snapshot cataloging for
                remaining jobs.
            9. Cleanup entites and remove array entries.
        """
        ...
        try:
            ...
            self.snapconstants.skip_catalog = False  #disabling skip catalog
            ...
            self.snapconstants.inline_bkp_cpy = False
