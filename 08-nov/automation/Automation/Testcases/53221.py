...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case
         Vplex XtremIO snap (distribued Volume)"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Vplex XtremIO snap - Basic acceptance Test for \
                    intellisnap operations-Distributed volume"

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        # setting revert flag to skip revert operation for this engine
