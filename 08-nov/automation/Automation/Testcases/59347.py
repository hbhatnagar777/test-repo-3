...
class TestCase(CVTestCase):
    """"Class for executing Basic acceptance Test of Intellisnap-Vmware-VSA \
    v2- Shared Snap deletion"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Intellisnap-Vmware-VSA V2- Shared Snap deletion : {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_sharedsnap()
