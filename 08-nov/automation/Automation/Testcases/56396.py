...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VMware Full Backup and Restore from Command center using tenant admin credentials"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                decorative_log("Performing file level restore to source VM to different path")
            ...
            try:
                decorative_log("Performing file level restore to an agentless VM")
