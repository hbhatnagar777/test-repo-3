...
class TestCase(CVTestCase):
    ...
    Metallic Office365 Mail: Basic case with Modern Authentication
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Metallic: office365: Mail: Basic case with Modern Authentication"
        self.browser = None
    ...
    def setup(self):
        ...
        self.tcinputs['office_app_type'] = Office365Metallic.AppType.exchange_online
