...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center Intellisnap : NetApp Open Replication for PMM Configuration"
        self.browser = None
    ...
    def run(self):
        ...
        self.tcinputs['ReplicationType'] = "pmm_replica"
        ...
        try:
            ...
            self.snap_template.snaptemplate2()
