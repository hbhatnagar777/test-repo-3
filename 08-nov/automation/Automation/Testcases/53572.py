...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA VMWARE Full backup without Metadata collection" \
                    " with Unix Proxy and Unix MA"
    ...
    def run(self):
        ...
        try:
            ...
            backup_options.pre_backup_config_checks['min_proxy_os']['os_list'] = ['unix']
            backup_options.pre_backup_config_checks['ma_os']['count'] = 1
            backup_options.pre_backup_config_checks['ma_os']['os_list'] = ['unix']
