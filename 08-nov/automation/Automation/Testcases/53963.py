...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp Open Replication for
    PMV Configuration"""
    ...
    def __init__(self):
        ...
        Open Replication for PMV Configuration"""

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "pmv_replica" #PMV open replication
