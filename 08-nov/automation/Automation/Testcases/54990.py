...
Inputs:
    ...
    SnapEngine          --      snap engine to set at subclient
                                Values: 'Western Digital IntelliFlash Snap'
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Western Digital IntelliFlash Snap"
        self.snapengine_list = ['Western Digital IntelliFlash Snap']
        self.browser = None
