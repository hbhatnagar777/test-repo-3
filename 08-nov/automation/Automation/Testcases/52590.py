...
class TestCase(CVTestCase):
    """Class for executing Workflow - Operations - Business Logic Workflows Basic"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[WORKFLOW] - Operations - Business Logic Workflows Basic"
    ...
    def run(self):
        ...
        try:
            ...
            workflow_name = "DeleteClientAuthorization"
