...
APIs being validated inside collection file:
    ...
    GET /v2/Plan
    GET /v2/Plan/{{planId}}
    GET /v2/Plan/{{planId}}/AssociatedEntities
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Server plans] Backup content and entity association operations"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PlanBackupContentOperations.collection.json'
