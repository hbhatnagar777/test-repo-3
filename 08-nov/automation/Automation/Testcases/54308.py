...
class TestCase(CVTestCase):
    """TestCase to validate Cassandra stage free restore """

    def __init__(self):
        """Initialize TestCase class"""
        super(TestCase, self).__init__()
        self.name = "Stage free restore from admin console - Cassandra"
        self.browser = None
    ...
    def setup(self):
        ...
        self.cassandra_server_name = "automated_cassandra_server_54308"
        ...
        self.keyspace = 'automationks54308'
    ...
    def run(self):
        ...
        try:
            ...
            # truncate table, restore, then validate restored data
            self.cassandra.truncate_table(self.keyspace, self.tablename)
            self.cassandra.verify_restore(
                destinstance=self.destinationinstance, paths=[
                    self.keyspace])
            self.cassandra.validate_restoredata(
