...
APIs being validated inside collection file:
    ...
    PUT Update Network Topology
    POST Push Network Topology
    DELETE Delete Network Topology
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Network Topology Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'NetworkTopologyOperations.collection.json'
