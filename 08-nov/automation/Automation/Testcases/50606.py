...
class TestCase(CVTestCase):
    """Testcase : Download software via CVInternet gateway using Windows client"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Download software via CVInternet gateway using Windows client"
    ...
    def setup(self):
        ...
        self.client_gateway = self.config_json.Install.windows_client.machine_host
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Disabling Http Proxy")
            time.sleep(30)
            ...
            self.log.info("setting gateway for send logs")
            time.sleep(60)
