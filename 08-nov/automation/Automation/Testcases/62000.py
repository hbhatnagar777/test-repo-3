...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VMWARE Full Snap backup, synthetic full
    and Restore test case - v2 Indexing"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA V2 VMWARE SNAP Backup, Synthetic Full and Restore Cases for : {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_v2_synthfull()
