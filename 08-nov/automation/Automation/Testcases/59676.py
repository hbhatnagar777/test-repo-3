...
class TestCase(CVTestCase):
    ...
    Office365- SharePoint V2 - Finalize Phase - Advance Case - Job Suspend and then Kill"""
    test_step = TestStep()
    ...
    def __init__(self):
        ...
        self.name = "Office365- SharePoint Online - Finalize Phase - Advance Case - Job Suspend and then Kill"
    ...
    def run(self):
        ...
        try:
            ...
            self.sp_client_object.cvoperations.run_manual_discovery(wait_for_discovery_to_complete=True)
            num_webs_to_be_processed_to_suspend_job = 1
            self.sp_client_object.cvoperations.subclient.data_readers = num_webs_to_be_processed_to_suspend_job
            ...
            self.sp_client_object.cvoperations.monitor_job_advance_details(job, num_webs_to_be_processed_to_suspend_job)
            self.sp_client_object.cvoperations.suspend_job(job)
