...
class TestCase(CVTestCase):
    ...
    def run(self):
        ...
        try:
            ...
            self.name = """Automation : Basic Acceptance Test for IntelliSnap backup and restore for snap engine {0}
                        """.format(self.tcinputs["SnapEngineAtSubclient"])
