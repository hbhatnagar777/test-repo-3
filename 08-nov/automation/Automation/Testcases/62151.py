...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Dynamics 365: Metallic: Basic Acceptance Test Case for Backup and Restore"
        self.browser = None
        self.navigator = None
    ...
    def run(self):
        ...
        try:
            ...
            self.d365_helper.dynamics365_apps.add_association(assoc_type=D365AssociationTypes.INSTANCE,
                                                              plan=self.d365_plan,
            ...
            _bkp_job_id = self.d365_helper.dynamics365_apps.run_d365client_backup()
