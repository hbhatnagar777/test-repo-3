...
DATABASE = 'tc_62339'
APP_NAME = f"TC_62339_{datetime.now().strftime('%d_%B_%H_%M')}"
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Salesforce: Restore records from recycle bin"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            ...
            self.sf_helper.delete_object_data(self.sf_helper.sf_object, self.data, hard_delete=False)
