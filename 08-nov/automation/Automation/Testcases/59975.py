...
class TestCase(CVTestCase):
    """ Basic acceptance Test for GCP PAAS postgreSQL backup and restore from command center
    Example if instance already exists:
    "59975": {
          "PlanName": "",
          "InstanceName": "pg13db[asia-south1]",
          "DatabaseUser": "",
          "Password": "ImAgine@th15",
          "testdata": [1,1,2],
    ...
    def __init__(self):
        ...
        self.name = "GCP PAAS PostgreSQL ACC1 from command center"
        self.browser = None
    ...
    def navigate_to_instance_page(self):
        ...
        if self.perform_instance_check:
            ...
            if self.db_instance.is_instance_exists(DBInstances.Types.POSTGRES,
                ...
                self.db_instance.add_gcp_postgresql_instance(cloud_account=self.cloud_account,
