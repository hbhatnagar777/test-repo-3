...
class TestCase(CVTestCase):
    """Class for executing VMWare Recovery Target Tags/CA Automation Test Case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VMWare - Recovery Targets - Tags/CA - Automation"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.restore_client = self.tcinputs['RecoveryTarget']
            source_vm_list = list(self.vsa_obj.hvobj.VMs.keys())

            try:
                decorative_log('Case 1: Performing Full VM Restore without adding/removing Custom Attributes and Tags')
