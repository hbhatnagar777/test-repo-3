...
Inputs:
    ...
    CloneMountPath      --      Mount path for Clone

    BackupsetName       --      Name of the Backupset

    SnapEngine          --      Name of the Snap Engine
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Instant Clone feature for FS for Intellisnap"
        self.props = None
        self.client = None
        self.browser = None
    ...
    def run(self, csdb=None):
        ...
        try:
            ...
            self.snap_template = SnapTemplate(self, self.admin_console)
            self.snap_template.snaptemplate3()
