...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Intellisnap-Vmware: VSA V2- Snap backup/backup copy when there is a mix of NFS and VMFS Datastores for vendor : {0}"
    ...
    def run(self):
        ...
        try:
            ...
            vmfs_nfs_vm_config = True
            vsa_snap_templates = VSASNAPTemplates(self)
            return_values = vsa_snap_templates.vsasnap_template_v2(vmfs_nfs_vm_config = vmfs_nfs_vm_config)
