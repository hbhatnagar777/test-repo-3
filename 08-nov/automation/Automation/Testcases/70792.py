...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Commcell level qlogin operation with password change."""
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate_qlogin_operation(local_user=True)
            validator.validate_qlogin_operation(local_user=False)
