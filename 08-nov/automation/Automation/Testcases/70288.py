...
from Web.AdminConsole.GlobalConfigManager.Helper.gcm_usergroup_helper import GCMUserGroupHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "	[GCM][UI]: Create User Group from cloud console and validate propagation to service commcells"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            gcm_helper_obj = GCMUserGroupHelper(self.admin_console)
