...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VMware INCR SNAP backup
    and Restore test case - v2 Indexing"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE SNAP INCR Backup and Restore Cases for v2 indexing"
        ...
        try:
            ...
            try:
                VirtualServerUtils.decorative_log("FULL VM out of Place restores : "
                                                  "v2 Indexing from snap: Child level")
            ...
            try:
                VirtualServerUtils.decorative_log("FULL VM out of Place restores from backup copy: Parent level")
