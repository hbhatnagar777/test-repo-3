...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - LOCUST] Performance testing for Virtualization Page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_vm_details,get_subclient_details,get_vmallocationpolicy,get_permission_details,get_jobs_calendar",
