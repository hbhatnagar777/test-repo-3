    ...
    "testCases":
            {
                ...
                "bkpgw-region":"region name of the backup gateway in metallic page"
                    }
            }
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Amazon S3 Acceptance case for Metallic Command Center with key based Authentication"
        self.browser = None
    ...
    def setup(self):
        ...
        self.s3_session = self.s3_storage_helper.create_session_s3(self.config.aws_access_creds.access_key,
    ...
    def configure_new_client(self):
        ...
        backup_gateway_name = self.oss_metallic_helper.configure(byos_storage_name=f's3_byos_storage{int(time.time())}',
                                                                 ...
                                                                 content=content,
                                                                 auth_type='Access and Secret Key',
                                                                 stack_params=params,
                                                                 region='us-east-1',
    ...
    def cleanup(self):
        ...
        self.oss_metallic_helper.s3_cleanup(self.tcinputs.get('stack_name'))
