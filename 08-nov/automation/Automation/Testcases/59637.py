"""Test Case for SharePoint v2 Client creation with Single Node and Express configuration
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "SharePoint v2 Pseudo Client  : Client creation with Single Node and Express configuration"
        self.browser = None
        self.navigator = None
    ...
    def run(self):
        try:
            ...
            self.log.info("Client creation with Single Node and Express configuration is validated successfully")
