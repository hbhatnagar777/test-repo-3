...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Validate multiple dr jobs initiation [Full + Full + Diff]"
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate(feature="multiple_dr_jobs_initiation",
                               backup_types=['full', 'full', 'full', 'differential', 'full', 'differential'])
