...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = 'Testcase for Verifying Alert notification through SNMP Traps'
        self.cache = None
        tcinputs = {
          "AgentName":None,
          "BackupsetName":None,
    ...
    def run(self):
        ...
        try:
            ...
            alert_data = alert_helper.get_alert_xml(name='Test Backup Restore Job SNMP',
                                                    notif_type=['Snmp'],
            ...
            alert_helper.check_if_snmp_trap_received(wait_interval=30, patterns=[self.cache["job_id"],
