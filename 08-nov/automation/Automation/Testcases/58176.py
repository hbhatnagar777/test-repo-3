...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "CvSolr Multi Node Index server - Validation of adding/removing of role"
        self.tcinputs = {
        ...
        self.exchange_role = IndexServerConstants.ROLE_EXCHANGE_INDEX
    ...
    def setup(self):
        ...
        self.is_helper.update_roles([self.exchange_role])
