...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute
                            ...
                            Suspend and Resume during  vault or mirror OCUM based replication.
"""
...
class TestCase(CVTestCase):
    """Class for executing Suspend and Resume during  vault or mirror OCUM based replication"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : Suspend and Resume during  vault or mirror OCUM based replication"""
    ...
    def run(self):
        ...
        Steps:
            ...
            5. Run Aux copy and after 150 seconds  suspends the job.
            ...
            9. Set Snap copy as Source for backup copy
