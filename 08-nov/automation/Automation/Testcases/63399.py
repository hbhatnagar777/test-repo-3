...
"""Test Case for Dynamics 365: GCC High Client Creation, Backup and Restore
...
class TestCase(CVTestCase):
    """Class for executing Dynamics 365: GCC High Client Creation, Backup and Restore
    ...
    Example for test case inputs:
        "63399":
        {
          ...
          "D365_Instance_URL":[<D365-Instance_URL-to-backup>],
          "D365_Restore_Table": "<name-of-the-table-to-be-restored>"
    ...
    def __init__(self):
        ...
        self.name = "Dynamics 365: GCC High Client Creation, Backup and Restore "
        self.browser = None
        self.navigator = None
    ...
    def run(self):
        try:
            ...
            self.d365_helper.dynamics365_apps.add_association_gcc_high(instances=self.d365_helper.d365instances,
                                                                       instances_url=self.d365_helper.d365instancesurl,
                                                                       plan=self.d365_helper.d365_plan)
            ...
            restore_table = (self.tcinputs.get("D365_Restore_Table"), self.d365_helper.d365instances[0])
