...
class TestCase(CVTestCase):
    """ Class for executing Cross Machine Restore for Oracle RAC to RAC"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Oracle RAC to RAC Restore on Command Center - Cross Machine Restore"
        self.browser = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_62678'
    ...
    def create_helper_object(self):
        ...
        self.dest_instance = self.dest_client.agents.get("oracle rac").instances.get(
