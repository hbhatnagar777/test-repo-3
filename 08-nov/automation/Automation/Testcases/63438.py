...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Attach disk restore to the same instance from a snap copy with root volume filtered in admin account"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Attach disk restore to the same instance from a snap copy with root volume filtered in admin account"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.backup()
            decorative_log("Attach disk restore from Snap Copy with root volume filtered")
