...
"62205": {
              "ClientName": "CvClientName1",
              "AgentName": "DB2",
              "src_instance_name": "dummy_inst1",
              "src_db2_username": "dummy_user1",
              "src_db2_user_password": "test_passwd",
              "plan": "plan name",
              "src_database": "Source Database",
              "destination_client": "CvClientName2",
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center - DB2 Out of place Restore: To Different Instance on Different machine"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            ...
            self.db_instance.select_instance(database_type=self.dbtype,
                                             instance_name=self.tcinputs["src_instance_name"],
    ...
    def verify_db2_version(self):
        ...
        """
        version_cmd = f"{self.db2_base.format(self.tcinputs['src_instance_name'])} db2level"
        ...
        version_cmd = f"{self.db2_base.format(self.tcinputs['dest_instance_name'])} db2level"
    ...
    def get_redirect_path(self):
        ...
        output = self.destination_client.execute_command(command=create_database_cmd)
        self.log.info(output.output)
    ...
    def get_user_details(self, client_machine, client_object, username):
        ...
        if "windows" in client_machine.os_info.lower():
            ...
            db2_username = f"{client_object.client_hostname}/{username}"
        else:
    ...
    @test_step
    def add_db2_instance(self, server_name, instance_name, home_path, username, password):
        """
    ...
    def update_db2_client_machine_property(self):
        ...
        instance = self.agent.instances.get(self.tcinputs['src_instance_name'])
    ...
    def validate_restore_job(self):
        ...
        instance = dest_agent.instances.get(self.tcinputs['dest_instance_name'])
