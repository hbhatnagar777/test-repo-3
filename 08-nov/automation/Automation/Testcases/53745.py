...
APIs being validated inside collection file:
    POST /Organization
    GET /Organization
    GET /Organization/{{providerId}}
    PUT /Organization?organizationId={{providerId}}
    GET /Organization/{{providerId}}
    DELETE /Organization/{{providerId}}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Organization operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Organization Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'OrganizationOperations.collection.json'
