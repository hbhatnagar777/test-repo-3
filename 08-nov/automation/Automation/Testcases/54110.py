...
class TestCase(CVTestCase):
    """Class for executing Software store workflow GetAndProcessAuthorization"""
    ...
    def __init__(self):
        ...
        self.name = "WORKFLOW - [SoftwareStore] - Validate GetAndProcessAuthorization workflow"
    ...
    def run(self):
        ...
        try:
            ...
            workflow_helper.test.log_step("""
                ...
                8. Make Sure once the approval is made through GetAndProcessAuthorization Workflow the Backupset is
                    deleted and GetAndProcessAuthorization workflow is completed.
            """, 200)
            # ---------------------------------------------------------------------------------------------------------
            ...
            """)
            try:
                instances = user_commcell.clients.get(self.client.client_name).agents.get("File system").instances
                backupsets = instances.get('defaultinstancename').backupsets
                self.log.info(
            ...
            workflow_helper.test.log_step("""
                ...
                Make Sure once the approval is made through GetAndProcessAuthorization Workflow the Backupset is
                    deleted and GetAndProcessAuthorization workflow is completed.
            """)
            ...
            self.log.info("GetAndProcessAuthorization workflow approval succeeded and completed successfully.")
            # ---------------------------------------------------------------------------------------------------------
