...
APIs being validated inside collection file:
    GET Client
    GET Client Check Readiness
    GET Client Browse
    POST Install Client
    POST Create Pseudo Client
    POST Configure Pseudo Client
    POST Client Properties
    GET Client Properties
    POST Client Additional Settings
    GET Client Additional Settings
    DELETE Retire Client
    DELETE Client
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Client Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Client Operations with JSON"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "clientAuthUsername":self.tcinputs['clientAuthUsername'],
                       "clientAuthPassword": self.tcinputs['clientAuthPassword'],
    ...
    def run(self):
        ...
        try:
            collection_json = 'ClientOperations.collection.json'
