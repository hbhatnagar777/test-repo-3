...
class TestCase(CVTestCase):
    ...
    Backward Compatibility - One Way Firewall CC->CS - Acceptance validation
    ...
    def __init__(self):
        ...
        self.name = ("[Firewall] : Backward Compatibility - "
                     "One Way Firewall CC->CS - Acceptance validation")
        ...
        self._client_group_name = "CG_48890_CL"
        self._cs_client_group = "CG_48890_CS"
        self.commserv = None
        self._network = None
        self.client_group_obj = None
        self.topology_name = "TOPOLOGY_48890"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("***Creating one-way topology from Clients--->CS***")

            self._network.one_way_topology(self._client_group_name,
                                           self._cs_client_group,
                                           self.topology_name)
