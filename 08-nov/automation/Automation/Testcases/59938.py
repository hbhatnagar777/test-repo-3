"""Test Case for SharePoint v2 Client creation with Client Group and Custom Configuration
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "SharePoint v2 Pseudo Client  : Client creation with Client Group and Custom Configuration"
        self.browser = None
        self.navigator = None
