...
"""Test Case for OneDrive v2 Client creation with Multiple Nodes
and Express configuration and Modification of Configuration
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("OneDrive v2: Client creation with Multiple Nodes and "
                     "Express configuration and Modification of Configuration")
        self.browser = None
        self.navigator = None
    ...
    def setup(self):
        ...
        try:
            ...
            self.tcinputs['Name'] += "_OD_59425"
            self.tcinputs['MaxStreams'] = o365_constants.OneDrive.MAX_STREAMS_COUNT.value
    ...
    def run(self):
        try:
            ...
            self.onedrive.modify_app_config_values(new_server_plan=self.tcinputs['NewServerPlan'],
