...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Interactive - Feature release upgrade using Bootstrapper downloaded media"
    ...
    def run(self):
        ...
        try:
            ...
            silent_helper = SilentInstallHelper.create_installer_object(
                self.config_json.Install.commserve_client.client_name,
                self.service_pack, self.cs_machine, self.install_inputs)
            silent_helper.silent_upgrade()
