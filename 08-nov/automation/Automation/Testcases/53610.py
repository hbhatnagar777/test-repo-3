...
class TestCase(CVTestCase):
    """Class for executing
            IBMi - Regular scan backup validation for SYNCLIB with library level and object level filters
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "IBMi - Regular scan backup validation for SYNCLIB with library level and object level filters"
    ...
    def setup(self):
        ...
        try:
            ...
            self.usr_lib = ["ZKAR0{0}".format(self.id),
                            "ZKAR1{0}".format(self.id),
                            "ZKAR2{0}".format(self.id),
                            "ZKAH{0}".format(self.id)]
    ...
    def configure_sc(self):
        """
               Configure subclient with content, filters and enable Regular scan.
        """
