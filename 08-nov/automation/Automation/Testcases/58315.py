...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Selective Copy Acceptance Cases for Hourly & Last Full Wait Until Configuration With SubClient Disassociation"
        self.tcinputs = {
            "MediaAgentName": None
        }
    ...
    def hourly_last_full_wait_until_sc_disassoc(self):
        ...
        # this is wait until, so we need to wait another hour to be sure the job selection
        # has not happened. giving it another extra 15 min.
        seconds_to_next_hour = (59 - today.minute) * 60 + (60 - today.second) + 15 * 60
