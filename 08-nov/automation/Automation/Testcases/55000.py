...
Inputs:
    ...
    SnapEngine          --      snap engine to set at subclient
                                values :
                                'Fujitsu ETERNUS AF / DX Clone' or
                                'Fujitsu ETERNUS AF / DX Snap' or
                                'Fujitsu ETERNUS AF / DX SnapOPC+'
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Fujitsu ETERNUS AF / DX"
        self.snapengine_list = ['Fujitsu ETERNUS AF / DX Clone',
                                'Fujitsu ETERNUS AF / DX Snap',
                                'Fujitsu ETERNUS AF / DX SnapOPC+']
        self.browser = None
