...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Broken permission report : User group permission case"
        self.tcinputs = {
            "HostToAnalyze": None,
    ...
    def create_broken_permission_folder(self):
        ...
        random_user = self.tcinputs['UserGroupName']
        random_sid = win32security.ConvertSidToStringSid(
            win32security.LookupAccountName(self.machine_name, random_user)[0])
