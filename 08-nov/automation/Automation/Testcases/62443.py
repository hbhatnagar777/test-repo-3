...
class TestCase(CVTestCase):
    """TestCase to validate acceptance from admin console - Couchbase"""
    ...
    def __init__(self):
        ...
        self.utils = None
        self.name = "Acceptance test from admin console - Couchbase"
        self.browser = None
    ...
    def setup(self):
        ...
        self.couchbase_server_name = "automated_couchbase_server"
