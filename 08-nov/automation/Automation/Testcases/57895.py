...
Inputs:
    ...
    ldapUser            -- name of the client for backup

    ldapPassword        -- name of the agent on the client

    ldapDomain          -- name of the backupset to be used

    ldapNetBIOS         -- name of the storage pool to be used
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Domain Operations with JSON"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "ldapPassword":  self.tcinputs['ldapPassword'],
                       "ldapDomain":  self.tcinputs['ldapDomain'],
                       "ldapUser":  self.tcinputs['ldapUser'],
                       "ldapNetBIOS":  self.tcinputs['ldapNetBIOS'],
                       }
    ...
    def run(self):
        ...
        try:
            collection_json = 'DomainOperations.collection.json'
