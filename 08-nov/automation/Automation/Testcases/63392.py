...
class TestCase(CVTestCase):
    """Command Center: REDSHIFT ACC1 test case with IAM Authentication"""
    ...
    def __init__(self):
        ...
        self.name = "REDSHIFT ACC1 test case with IAM Authentication"
        self.browser = None
    ...
    def setup(self):
        ...
        try:
            ...
            if self.redshift_helper.ec2_state(
                    self.tcinputs['EC2InstanceName'], self.tcinputs['EC2Region']).lower() != "running":
                self.redshift_helper.start_ec2_instance(
    ...
    def run(self):
        ...
        try:
            ...
            self.database_instance.add_redshift_instance(
                ...
                auth_type="IAM", access_node=self.tcinputs['access_node'],
                credential_name=None,content=content)
