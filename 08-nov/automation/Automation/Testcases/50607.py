...
class TestCase(CVTestCase):
    """Custom Package creation pointing to CS with Client Authentication Enabled."""
    ...
    def __init__(self):
        ...
        self.name = "Custom Package creation pointing to CS with Client Authentication Enabled"
