...
class TestCase(CVTestCase):
    """ Acc1 for Azure MariaDB from command center
    Example if instance already exists:
    "60020": {
        "PseudoClientName": "pseudo_ash",
        "InstanceName": "mariadb8[us-central1]",
        "testdata": [2,10,100]
    }
    ...
    def __init__(self):
        ...
        self.name = "Acc1 for Azure MariaDB from command center"
        self.browser = None
    ...
    def tear_down(self):
        ...
        if self.mariadb_helper_object:
            ...
            self.mariadb_helper_object.cleanup_test_data(database_prefix='auto_dump')
    ...
    def kill_active_jobs(self):
        ...
        active_jobs = self.commcell.job_controller.active_jobs(self.tcinputs['PseudoClientName'])
        if active_jobs:
    ...
    def connect_to_instance(self):
        ...
        if self.perform_instance_check:
            ...
            if self.db_instance.is_instance_exists(DBInstances.Types.MYSQL,
                ...
                self.db_instance.add_azure_mariadb_instance(cloud_account=self.tcinputs['PseudoClientName'],
        ...
        self._client = self.commcell.clients.get(self.tcinputs['PseudoClientName'])
    ...
    def restore(self):
        ...
        self.db_instance.select_instance(
            ...
            self.tcinputs['InstanceName'], self.tcinputs['PseudoClientName'])
