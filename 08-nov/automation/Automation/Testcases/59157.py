...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Verify TPPM working for windows content extractor service via data cube FS/Open data sources"
        self.tcinputs = {
    ...
    def install_content_analyzer_create_fs_data_source(self):
        ...
        self.ca_helper_obj.install_content_analyzer(
            ...
            platform="Windows",
            sw_cache_client=self.tcinputs['RemoteCacheClient'])
    ...
    def setup(self):
        ...
        try:
            ...
            self.datasource_name = "FreshCAClient_59157_" + str(self.timestamp)
            self.open_datasource_name = "FreshCAClient_59157_Open_" + str(self.timestamp)
    ...
    def tear_down(self):
        ...
        if self.status != constants.FAILED:
            # fetch client id before deleting it for validating tppm entry remove
