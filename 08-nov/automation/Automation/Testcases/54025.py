...
class TestCase(CVTestCase):
    """Class for executing basic testcase for Incremental Backup and restore for VMware Cloud director in admin Console"""""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test of VMware Cloud director Incremental Backup and Restore in AdminConsole"
