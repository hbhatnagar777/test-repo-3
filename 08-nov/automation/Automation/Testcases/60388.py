...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA AZURE V2 Synthetic full Streaming Backup and Restore"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.run_backup(self,
                                     ...
                                     msg='AZURE V2 STREAMING Incremental Backup')

            # CHILD LEVEL RESTORES

            self.tc_utils.run_guest_file_restore(self,
                                                 child_level=True,
                                                 msg='GuestFile restore from CHILD level from Synthetic Full STREAMING Backup')
            ...
            self.tc_utils.run_virtual_machine_restore(self,
                                                      ...
                                                      child_level=True,
                                                      msg='FULL VM out of Place restores from CHILD level from Synthetic Full STREAMING backup')
