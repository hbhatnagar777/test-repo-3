...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VMware Live VM Recovery from Primary copy using v2 client"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test of VMware Live Recovery from Primary copy"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                decorative_log("*" * 10 + "Restoring the VM out-of-place from Primary copy" + "*" * 10)
            ...
            try:
                decorative_log("*" * 10 + "In-place Full VM Restore from Primary copy" + "*" * 10)
                self.vsa_obj.unconditional_overwrite = True
