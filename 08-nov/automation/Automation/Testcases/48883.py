...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Security - User Management Admin Operations."
        ...
        self._role1 = 'Automation_role_48883'
        self._permission_list1 = ['Add, delete and modify a user',
    ...
    def setup(self):
        ...
        user1 = UserProperties(name='TestUser_48883', cs_host=self.commcell.commserv_hostname,
                               password=self.password, full_name='Test User created by automation')
        self._user_list = [user1]
        self._security_dict = {
            'asso1': {
                'commCellName': [self.client if self.tcinputs.get('ClientName') else
    ...
    def run(self):
        ...
        self.log.info("This test verifies that a User Admin can perform only User Operations"
                      "(eg.create user/usergroup) on a particular entity")
        try:
            for user in self._user_list:
                ...
                self._user_helper.create_user(user_name=user.username,
                                              password=user.password, email='test48883@test.com',
