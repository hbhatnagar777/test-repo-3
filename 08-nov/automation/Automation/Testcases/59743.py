...
class TestCase(CVTestCase):
    """Class for performing planned failover and failback of Azure VM's"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Planned failover and failback operations from Command center"
    ...
    def run(self):
        ...
        try:
            decorative_log("Performing a planned failover operation")
            self.replication_helper.do_planned_failover(self.tcinputs['ReplicationGroup'])
