...
class TestCase(CVTestCase):
    """Class for executing basic testcase for Backup and agentless restore for VMware Cloud director in admin Console"""""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "VMware Cloud director Full Backup and Agentless Guest File Restore"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.backup()
            try:
                decorative_log("Performing file level restore to an agentless VM using other VM tab")
