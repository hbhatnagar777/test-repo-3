...
class TestCase(CVTestCase):
    """CommandCenter v2 - Azure- Snap- Synthetic Full"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Azure Snap & Backup copy - Synthetic Full backup using Restore points"
