...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Gsuite page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_client_server,get_client_v2_plan,get_instance_hyperv",
        ...
        self.inputs['get_client_server'] = {
            "PseudoClientType": "CloudApps"
        }
