...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DB2 Restore from Offline Backup"
        self.browser = None
    ...
    def run(self):
        ...
        self.tblcount_full, self.tablespace_list = self.db2_helper.add_data_to_database(self.tablespace_name,
                                                                                        self.table_name,
                                                                                        self.tcinputs["database_name"])
        self.run_backup()
    ...
    def run_backup(self):
        ...
        self.db2_helper.backup_validation(self.operation, self.tablespace_list, backup_time_stamp)
