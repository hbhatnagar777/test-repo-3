...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the first user to login by logging in, installing and activating
    with domain user 1 and then logging in as domain user 2 and restarting the services, only domain user 1 should
    ...
    def __init__(self):
        ...
        by logging in, installing and activating with domain user 1 and then logging in as domain user 2 and restarting\
        the services, only domain user 1 should become the laptop owner"
        self.browser = None
