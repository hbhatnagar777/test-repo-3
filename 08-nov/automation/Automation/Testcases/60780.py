...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Disastor Recovery Page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_replication,get_replicationgroup_detail,get_replication_monitor,get_vmallocationpolicy,get_vmallocationpolicy_details,get_failover_groups",
