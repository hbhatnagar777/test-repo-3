...
class TestCase(CVTestCase):
    "Class for executing New Framework Automation V1 Indexing Acceptance case for  windows IDA using Unix DP"
    ...
    def __init__(self):
        ...
        self.name = """V1 Indexing: Acceptance case for  windows IDA using Unix DP"""
