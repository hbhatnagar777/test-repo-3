...
class TestCase(CVTestCase):
    """Class for executing basic network case to validate two-way network topology
    ...
    def __init__(self):
        ...
        self.name = ("[Network & Firewall] : Two way Network Topology basic acceptance")
        ...
        self._client_group_name1 = 'CG1_49884'
        self._client_group_name2 = 'CG2_49884'
        self.commserv = None
        self._network = None
        self.client_group_obj = None
        self.topology_name = "TOPOLOGY_49884"
    ...
    def run(self):
        ...
        try:
            ...
            self._network.two_way_topology(self._client_group_name1,
                                           self._client_group_name2,
                                           self.topology_name)
            ...
            self._network.validate_two_way_topology(self.topology_name)

            #self._network.validate_fwconfig_file(3, self.client_list[1], self.client_list[2])
            ...
            #self._network.validate_fwconfig_file(3, self.client_list[3], self.client_list[2])
