...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for RenewLoginToken"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API -  RenewLoginToken APIs  with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'RenewLoginToken.collection.json'
