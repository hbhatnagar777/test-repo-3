...
"""Test Case for validating [Laptop Install] - [MSP] - Reinstall and register with different owner - New Activation
...
class TestCase(CVTestCase):
    """Test case class for validating [Laptop Install] - [MSP] - Reinstall and register with
        different owner - New Activation"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = """[Laptop Install] - [MSP] - Reinstall and register with different owner - New Activation"""
    ...
    def run(self):
        ...
        try:
            ...
            laptop_helper.tc.log_step("""
                            REINSTALL WITH DIFFERENT USER AND SAME CLIENT NAME - NEW ACTIVATION
                ...
                6. Install custom package again on the client and register with the different user [user2]
            """, 200)
            #-------------------------------------------------------------------------------------
            ...
            self.install_kwargs['new_client_name'] = client + laptopconstants.REINSTALLED_CLIENT_STR
