...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the first user to login by installing using authcode and domain
    users 1 and 2 are both set as owners of the laptop"""

    test_step = TestStep()

    def __init__(self):
        super(TestCase, self).__init__()
        self.name = "[Laptop] [Admin Console]: Test for setting automatic owner assignment to the first user to\
         login by installing using authcode and domain users 1 and 2 are both set as owners of the laptop"
        self.browser = None
    ...
    def install_and_activate_with_authcode(self):
        ...
        self.tcinputs["Skip_RDP_Users"] = [self.tcinputs["Activation_User3"]]
