...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center HyperV page V4 APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_papi_hyperV,get_papi_hypervDetails,get_client_server,get_vsaclientlist,get_instance_hyperv,get_mediaagent_recoveryenabler,get_jobs_calendar,get_subclient_fileserver",
