...
class TestCase(CVTestCase):
    """
    Class for executing testcase for Full Backup and Standalone Full VM in place Restore for VMware Cloud director in admin Console
    """""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "VMware Cloud director Full Backup and Standalone Full VM in place Restore"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.backup()
            try:
                decorative_log("Performing Full VM in place restore of standalone VMs")
