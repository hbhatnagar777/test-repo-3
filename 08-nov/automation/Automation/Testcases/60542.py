...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the local user groups by logging in as Administrator and
    installing and activating with domain user, such that the users in the local groups specified should become the
    laptop owners"""
    ...
    def __init__(self):
        ...
        logging in as Administrator and installing and activating with domain user, such that the users in the local\
        groups specified should become the laptop owners"
        self.browser = None
    ...
    def setup(self):
        ...
        common_inputs = ["Activation_User2", "Activation_Password2", "Activation_User3", "Activation_Password3",
                         "Activation_User4", "Activation_Password4"]
