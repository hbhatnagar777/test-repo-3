...
"""Acceptance case for Activate Datasource Management : Input manually
...
TestCase:
    ...
    generate_csv_data() --  Generates DS config csv file and returns a dictionary
                            and file path with the config data

    add_data_sources_manually() --  Enters data sources details for all DS configs
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Acceptance case for Activate Datasource Management : Input manually"
        self.browser = None
    ...
    @test_step
    def add_data_sources_manually(self):
        """Adds multiple datasources manually from the generated config dictionary"""
        self.adm_helper.add_multiple_data_sources(ADM_CONFIG_DATA.InventoryName,
                                                  {entry for entry in self.config_data})
    ...
    def run(self):
        try:
            ...
            self.add_data_sources_manually()
