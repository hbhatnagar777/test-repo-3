...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for License Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - License Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'LicenseOperations.collection.json'
