...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] Windows- Interactive - Client to CS via Proxy+HTTP Proxy"
    ...
    def setup(self):
        ...
        self.dummy_client_name = "test_50848_" + self.time_stamp
    ...
    def set_firewall_prerequisites(self):
        ...
        self.log.info("Step 6: Check readiness for all proxy and commserve")
        self._network.serverbase.check_client_readiness([self.proxy_name, self.commserv])

        self.log.info("Step 7: Set one way network Topology from client group to cs via proxy")
