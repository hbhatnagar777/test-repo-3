...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Basic acceptance of Sensitive Data Governance for backed up OneDrive users with passkey enabled"
        self.tcinputs = {
            'ServerPlanName': None,
            'IndexServer': None,
            'AccessNodes': None,
    ...
    def setup(self):
        ...
        try:
            ...
            if not self.commcell.is_passkey_enabled:
                self.commcell.passkey(_ONEDRIVE_CONFIG_DATA.Password, "enable")
    ...
    def perform_cleanup(self):
        ...
        if not self.is_test_step_complete(sc.PERFORM_CLEANUP):
            ...
            self.commcell.passkey(_ONEDRIVE_CONFIG_DATA.Password, "disable")
