...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Azure DevOps IDA - Verify Backup and Restore for Test Plans"
        self.browser = None
    ...
    def setup(self):
        ...
        try:
            ...
            self.tcinputs['repository_group'] = self.tcinputs.get('repository_group', f'auto_inplace_{self.id}_136_Try2')
            self.tcinputs['azure_services'] = ['Test Plans']
    ...
    def download_data_and_backup(self):
        ...
        for project in content:
            self.azure_app_helper.azhelper.download_services_data(project, services=['Test Plans'])
        self.log.info("Successfully downloaded services data for test projects : %s", content)
        backup_details = self.azure_app_helper.backup_from_repository_groups(repository_group, services=['Test Plans'], select=content)
    ...
    def restore_and_validate_data_in_place(self):
        ...
        for iteration in range(0, 2):
            ...
            if iteration == 1:
                ...
                # Choose only Test Plans in iteration 0
                services = ['Test Plans']
            ...
            self.azure_app_helper.download_and_validate_services_data(content, services=['Test Plans'], in_place=True)
    ...
    def restore_and_validate_data_out_of_place(self):
        ...
        for iteration in range(0, 2):
            ...
            self.azure_app_helper.download_and_validate_services_data(new_content, services=['Test Plans'],
                                                                      out_of_place=True,
    ...
    def run(self):
        ...
        2) Backup selected content(projects and repositories) with only Test Plans service,download service data
        3) Restore all projects and repositories for in place azure restore, select only Test Plans service
        ...
        6) Restore all projects and repositories for out of place azure restore, select only Test Plans service
