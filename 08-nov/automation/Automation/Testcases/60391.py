...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA AZURE V2 Synthetic Full Backup copy and Restores"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.run_backup(self,
                                     ...
                                     msg='AZURE V2 Snap Synthetic Full Backup')
            ...
            self.tc_utils.run_guest_file_restore(self,
                                                 child_level=True,
                                                 msg='GuestFile restore from CHILD level from Synthetic full BACKUPCOPY')
            ...
            self.tc_utils.run_virtual_machine_restore(self,
                                                      ...
                                                      child_level=True,
                                                      msg='Full VM out of Place restores from CHILD level from Synthetic full BACKUPCOPY')
