...
class TestCase(CVTestCase):
    """Class for basic Acceptance Test for Re-stubbing for File Archiving System using onepass subclient"""
    ...
    def __init__(self):
        ...
        self.name = "Basic Acceptance Test for Re-stubbing with onepass subclient"
    ...
    def setup(self):
        ...
        #craete backupset and onepass subclient
        ...
        self.OPHelper.testcase.subclient.archiver_retention = False
        self.OPHelper.testcase.subclient.archiver_retention_days = 1

        self.OPHelper.testcase.subclient.backup_retention = True
    ...
    def run(self):
        ...
        _desc = """
        1. Backup and stub the testdata on onepass subclient
        2. Recall the data
        ...
        try:
            ...
            self.log.info('Basic Acceptance tests for Restubbing passed')
            self.log.info('Test case executed successfully.')
            self.status = constants.PASSED

        except Exception as exp:
            self.log.error('Basic Acceptance tests for restubbing failed with error: %s', exp)
