...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "NAS C mode Restartable backups- Single path - Single stream restartabilty (FlexVol)"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("*" * 10 + " Make Subclient Data readers to 1 " + "*" * 10)
            self.log.info("Number of data readers: " + str(self.subclient.data_readers))
            if self.subclient.data_readers != 1:
