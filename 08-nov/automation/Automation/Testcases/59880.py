...
class TestCase(CVTestCase):
    """Class for performing azure dr case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Azure - DR - Replication and Planned failover with data added to source VM, and with extra " \
                    "disks, NIC"
    ...
    def run(self):
        ...
        try:
            # adding a data disk and an NIC to the source vms
            ...
            for vm_name in self.replication_helper.source_vms:
                ...
                self.auto_subclient.hvobj.VMs = vm_name

            # performing a planned failover operation with validation
            self.replication_helper.do_planned_failover(self.tcinputs['ReplicationGroupName'])
