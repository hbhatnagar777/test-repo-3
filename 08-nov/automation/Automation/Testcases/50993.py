...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of Notes Database restore options"""
    ...
    def __init__(self):
        """Initializes test case class object
            ...
            Properties to be initialized:
                ...
                trlogsubclient          (object)     	--  Instance of 'transaction logs' subclient

                machine                 (object)       	--  Object of machine class
        """
        super(TestCase, self).__init__()
        self.name = "Basic acceptance test of advanced restore options for LNDB"
    ...
    def run(self):
        ...
        try:
            self.lnhelp.unconditional_overwrite()
            self.lnhelp.database_replica_id()
            self.lnhelp.do_not_replay_transact_logs()
            self.lnhelp.disable_replication()
    ...
    def tear_down(self):
        ...
        self.backupset.subclients.delete(self.tcinputs['SubclientName'])
