...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Azure KMS with access Node ( Certificate based authentication )"
    ...
    def tear_down(self):
        ...
        try:
            ...
            self.log.info(f"tear_down:: cleanup failed. {str(ex)}")
            self.result_string = f"tear_down:: cleanup failed. {str(ex)}"
