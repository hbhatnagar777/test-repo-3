...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Entity Caching] - validate the data for server group entity"
        self.tcinputs = {
            'fq_filter': None,
    ...
    def setup(self):
        ...
        self._helper = ServerGroupHelper(self.commcell)

    def run(self):
        """ run function of this test case """
        try:
            self._helper.validate_server_groups_cache_data()
    ...
    def tear_down(self):
        ...
        self._helper.cleanup_server_groups('caching_automation_')
