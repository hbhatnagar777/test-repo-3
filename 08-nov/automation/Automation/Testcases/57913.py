...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Commerve Live Sync]: Production Failover cycle"
    ...
    def perform_failover(self, target_node):
        ...
        target_livesync.failover(CSLiveSync.PRODUCTION, CSLiveSync.PLANNED, target_node)
        while True:
            time.sleep(60)
