...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][EdgeMode]- Validation of Versions Restore functionality for Laptop Clients"""
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][EdgeMode]- Validation of Versions Restore functionality for Laptop Clients"
