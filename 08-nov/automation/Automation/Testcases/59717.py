...
class TestCase(CVTestCase):
    """Class for executing Index reconstruction case for PgSQL V2 clients"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()

        self.name = "Index reconstruction case for PgSQL V2 client"
    ...
    def run_restore_validate(
        ...
        """
        self.db_helper.delete_v2_index_restart_service(subclient._backupset_object)
        time.sleep(60)
