...
TestCase:
    ...
    run_and_validate_sweep_job()    -- Runs sweep job on MA and validates it
...
class TestCase(CVTestCase):
    """ GUI Backup's and restore check from sweep backup jobs """
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 Test for DB2 1 Min RPO from GUI to verify restores from Sweep backup jobs"
    ...
    def setup(self):
        ...
        self.table_name = "T64311"
        self.tablespace_name = "TS64311"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info(
                " #### CASE 2 : Archiving logs and checking if logs are moving to dump location #### ")
