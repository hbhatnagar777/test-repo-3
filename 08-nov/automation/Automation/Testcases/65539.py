...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Aws postgres metallic
    Example :
    "65539":{
            "Region": "ap-south-1",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for AWS RDS(Export) PostgreSQL using IAM Role"
        self.browser = None
    ...
    def setup(self):
        ...
        self.awsdatabases = AWSRDSExport(self.admin_console, s3_helper=self.s3_metallic_helper,
                                         ...
                                         database_type=DBInstances.Types.POSTGRES.value)
