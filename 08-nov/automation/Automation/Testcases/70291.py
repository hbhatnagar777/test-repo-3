...
from Web.AdminConsole.GlobalConfigManager.Helper.gcm_region_helper import GCMRegionsHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[GCM][UI]: Create Regions from cloud console and validate propagation to service commcells"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            gcm_helper_obj = GCMRegionsHelper(self.admin_console)
