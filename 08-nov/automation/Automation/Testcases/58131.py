...
TestCase:
    ...
    vertical_expansion() - Add bricks to the existing pool
...
14. Trigger vertical scaleout
15. check tagging on newly aded disks and also on fstab entries
    ...
    def run(self):
        ...
        try:
            ...
            for ransomware_helper_obj in self.ransomware_helper_objs:
                ...
                if not ransomware_helper_obj.check_hyperscale_gluster():
