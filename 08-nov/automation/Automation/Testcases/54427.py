...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Streaming Amazon Backup & Full VM Restore test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "AMAZON V2: Tenant Account: Synth Full backup, File level and Full VM restore"
        self.browser = None
        self.vsa_obj = None
