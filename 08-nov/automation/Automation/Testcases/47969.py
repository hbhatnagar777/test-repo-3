...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Commandline Backup Restore testcase for Informix iDA with SingleJobID registry"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Setting sSKIPSINGLEJOBID registry Key")
            self.client.add_additional_setting("InformixAgent", "sSKIPSINGLEJOBID", "STRING", "Y")
            ...
            ############ performing table level restore in unix #####################
            if "unix" in machine_object.os_info.lower():
                self.log.info("Starting table level restore in 30 seconds")
                time.sleep(30)
            ...
            ################# Set single job id registry key ########################
            self.log.info("Deleting sSKIPSINGLEJOBID registry Key")
