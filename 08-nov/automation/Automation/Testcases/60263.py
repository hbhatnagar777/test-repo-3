...
class TestCase(CVTestCase):
    ...
    activating with a domain user, such that all the logged-in AD users should become the laptop owners"""
    ...
    def __init__(self):
        ...
        in as Administrator and installing and activating with a domain user, such that all the logged-in AD users\
