...
"""Test Case for validating Laptop client reinstall cases
...
class TestCase(CVTestCase):
    """Test case class for validating Laptop client reinstall cases"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = """[Laptop Install] - [MSP] - Reinstall and register with same user - Takeover"""
