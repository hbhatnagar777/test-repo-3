...
"""Main file for executing this test case
     ...
     This Testcase verifies all the RFC operations for a VSA snap backup
...
class TestCase(CVTestCase):
    """
    This Testcase verifies that all  the RFC operations for a VSA snap backup
    ...
    Steps:
        ...
        6. Do live browse and verify the download of browse related RFC files
        7. Run a series of INC and SFULL
        8. Verify RFC upload, download and backup foo each job
...
"""
    ...
    def __init__(self):
        ...
        self.name = 'Indexing - RFC - VSA Snap Backup'
        self.tcinputs = {}
        self.idx_help = None
