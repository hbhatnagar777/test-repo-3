...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp Replication for
    PMM Configuration Using 7mode OCUM Server"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Netapp Replication
        for PMM Configuration Using 7mode OCUM Server"""

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "pmm" #PMM using 7mode OCUM
