...
6: Initiate Restore Jobs on all the 8 SubClients
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = 'Marking Referenced Chunks Bad by Restore Job for DiskLibraries'
        self.tcinputs = {
            "MediaAgentName": None
        }
        self.utility = None
    ...
    def produce_result(self):
        ...
        for sub_case in range(1, 9):
            ...
            # wont mark failed in 1)sfile idx cases 2)cmd cases
            if (sub_case < 5) \
