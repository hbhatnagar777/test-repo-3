...
class TestCase(CVTestCase):
    """ Basic acceptance Test for AWS MySQL metallic
    Example :
    "65541":{
            "Region": "ap-south-1",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for AWS RDS(Export) MySQL using IAM Role"
        self.browser = None
    ...
    def setup(self):
        ...
        self.awsdatabases = AWSRDSExport(self.admin_console, s3_helper=self.s3_metallic_helper,
                                         ...
                                         database_type=DBInstances.Types.MYSQL.value)
    ...
    def create_instance(self):
        ...
        self.cloud_account = f"automation-AWS-MySQL-{self.timestamp}"
        self.plan = f"AWS_MySQL_plan" + datetime.now().strftime("SJ%d%B%H%M").lower()
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Amazon RDS MySQL Backup and Restore Successful!")
