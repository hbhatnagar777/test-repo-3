...
from dynamicindex.utils.constants import USA_COUNTRY_NAME, CLIENT_NAME, FSO_SUBCLIENT_PROPS
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Validation of Export to CSV for Size Distribution Dashboard (Backed up datasource)"
        self.tcinputs = {
            "IndexServer": None,
    ...
    def create_fso_datasource(self):
        ...
        try:
            ...
            self.total_files = int(self.gdpr_base.data_source_discover_obj.get_total_number_after_crawl())
