...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Compliance Search from adminconsole"""
    test_step = TestStep()
    ...
    def __init__(self):
        ...
        self.name = "Basic acceptance Test of Compliance Search from adminconsole"
    ...
    def validate_search_results(self):
        ...
        if int(self.count_compliance_search) == int(self.count_solr):
            ...
            self.test_case_error = "Result count mismatch"
