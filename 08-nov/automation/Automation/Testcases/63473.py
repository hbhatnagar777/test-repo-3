...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Amazon V2 backup and Full VM, Attach Disk Restore test case with
    ...
    def __init__(self):
        ...
        self.name = "AMAZON : V2: Full Snap and backup copy (Tennant Account) " \
                    "and Full VM restore, Attach Disk Restore"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.run_attach_disk_restore(self,
                                                  browse_from_snap=True,
                                                  msg='Attach Disk restore from parent from snap')
            ...
            self.tc_utils.run_attach_disk_restore(self,
                                                  browse_from_snap=False,
                                                  browse_from_backup_copy=True,
                                                  msg='Attach Disk restore from parent from Backup Copy')
