...
Input Example:
        ...
        "testCases": {
                    "63666": {
                        ...
                        "ClientUsername": "root",
                        "ClientPassword": "password for root",
                        "InstanceName":"Name of the Instance",
                        "PdbName":"Name of the pluggable db",
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 for Single DBCS using interactive install"
        self.commcell = None
        self.tcinputs = {
            'HostName': None,
            'ClientUsername': None,
    ...
    def create_tenant(self):
        """create tenant user"""
        self.company_name = datetime.now().strftime("OCI-DB-Automation-II-%d-%B-%H-%M")
    ...
    def oci_initial_setup(self):
        ...
        self.upgrade_client_software(client_name=self.client_name)
    ...
    def uninstall_client_software(self, client_name):
        ...
        self.navigator.navigate_to_servers()
        self.admin_console.refresh_page()
        self.rtable.set_default_filter(filter_id='Type', filter_value='All')
