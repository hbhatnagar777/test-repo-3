...
class TestCase(CVTestCase):
    """Class for executing MySQL Proxy Backup - Failover to source test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "MySQL Proxy Backup - Failover to source"
    ...
    def run(self):
        ...
        try:
            self.mysql_helper.proxy_testcase("PROXY_FAILOVER")
