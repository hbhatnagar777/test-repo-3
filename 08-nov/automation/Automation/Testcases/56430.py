...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for Proxy MA feature - NDMP backup and restore -
    Proxy MA set at subclient level"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Proxy MA feature - NDMP backup and restore - Proxy MA set at subclient level"
        self.tcinputs = {
