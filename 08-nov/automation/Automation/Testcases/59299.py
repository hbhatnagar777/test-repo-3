...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "AHV streaming proxy failover validation with worker node services down"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                auto_subclient.backup(backup_options, job_status=True, op_id=3, entity_id=2)
