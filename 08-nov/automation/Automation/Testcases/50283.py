...
class TestCase(CVTestCase):
    """Class for executing
        IBMi - Verify new data on disk is backed up by inc and diff job for LFS and IFS data
    ...
    def __init__(self):
        ...
        self.name = "IBMi - Verify new data on disk is backed up by inc and diff job for LFS and IFS data"
