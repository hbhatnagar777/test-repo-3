...
Test cases to validate Basic operation window Data Management features on different subclients
...
class TestCase(CVTestCase):
    """Class for executing Basic operation window Data Management features validation on different subclients"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Acceptance] : Basic operation window Data Management features validation on different subclients"
    ...
    def run(self):
        ...
        Follows the following steps
                1) Creates required entities: Two subclients(A and B) [disklibrary, storagepolicy, subclient]
                2) Creates an operation window at subclient(subclient B) level for a list of operations:
        ...
        try:
            ...
            self.log.info("Validating subclient level operation window for the features:%s on different subclients",
                          operations_list)
            ...
            subclient_props = entities.create(["disklibrary", "storagepolicy", "subclient"])
            diff_subclient = subclient_props['subclient']['object']
            op_window = OpHelper(self, diff_subclient)
