...
class TestCase(CVTestCase):
    """Class for executing
        IBMi - Backup and restore of IFS data with Special characters (&,_,#,$)
    ...
    def __init__(self):
        ...
        self.name = "IBMi - Backup and restore of IFS data with Special characters (&,_,#,$)"
    ...
    def generate_ifs_data(self, directory_name, backup_level):
        ...
        if backup_level == "Full":
            ...
            spl_chars = ["EX+", "EX!", "EX,", "EX%", "EX#", "EX@", "EX'", "EX=", "EX^", "EX[", "EX]",
                         "EX{", "EX}", "EX\\", "EX\\<", "EX\\(", "EX\\)", "EX\\;", "EX\\>"]
        elif backup_level == "Incremental":
            spl_chars = ["IN&", "IN_1", "IN#", "IN$", "IN+", "IN!", "IN,", "IN%", "IN#", "IN@", "IN'", "IN=", "IN^",
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("*** STARTING RUN FOR SC: Backup and restore of IFS with Special characters (&,_,#,$)**")
            ...
            self.log.info("**VERIFICATION OF IFS BACKUP AND RESTORE WITH SPECIAL CHARACTERS COMPLETED SUCCESSFULLY**")
