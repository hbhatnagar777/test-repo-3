...
class TestCase(CVTestCase):
    """Testcase : Universal Installer: Use authcode to install a windows client to a company in service commcell using masterCS endpoint"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Use authcode to install a windows client to a company in service commcell using masterCS endpoint"
    ...
    def setup(self):
        ...
        self.organization_helper = Organization(
            self.commcell,
            self.config_json.Install.servicecs.tenants.Firewalltest.name)
