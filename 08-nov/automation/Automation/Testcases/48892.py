...
class TestCase(CVTestCase):
    ...
    Backward Compatibility - Two Way Firewall CC<->CS - Acceptance validation
    ...
    def __init__(self):
        ...
        self.name = ("[Firewall] : Backward Compatibility - "
                     "Two Way Firewall - Acceptance validation")
        ...
        self._client_group_name = "CG_48892_CL"
        self._cs_client_group = "CG_48892_CS"
        self.commserv = None
        self._network = None
        self.client_group_obj = None
        self.topology_name = "TOPOLOGY_48892"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("***Creating two-way topology from CS<-->Clients***")

            self._network.two_way_topology(self._cs_client_group,
