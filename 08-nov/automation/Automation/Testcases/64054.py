...
TestCase:
    ...
    This Testcase verifies the CRUD operation of a Network Topology with Smart Client Group
"""
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center - Create and Edit Smart topology"
        self.browser = None
        self.topology_name = "64054_Testcase_SmartTopology"
        self.admin_console = None
        self.navigator = None
        self._client_group_name1 = "CG_64054_Client"
        self._client_group_name2 = "CG_64054_Server"
        self.tcinputs = {
            "SourceClient": ""
        }
    ...
    def configure_multi_streams(self):
        ...
        try:
            ...
            self.validate_summary(self.client_summary, self.client_name,
                                  self.commserve,
                                  "persistent", "httpsa", '4', '180', self.client_obj.network.tunnel_connection_port,
                                  self._client_group_name1)
    ...
    def validate_encrypt_network(self):
        ...
        try:
            ...
            self.validate_summary(self.client_summary, self.client_name,
                                  self.commserve,
                                  "persistent", "https", '4', '180', self.client_obj.network.tunnel_connection_port,
                                  self._client_group_name1)

            # Validate the network summary of commserve
            self.validate_summary(self.server_summary, self.commserve,
                                  self.client_name,
                                  "passive", "https", '4', '180', self.server_object.network.tunnel_connection_port,
                                  self._client_group_name2)
            ...
            self.validate_summary(self.server_summary, self.commserve,
                                  self.client_name,
                                  "passive", "httpsa", '4', '180', self.server_object.network.tunnel_connection_port,
                                  self._client_group_name2)
        except Exception as e:
            raise CVTestStepFailure(e)
    ...
    def run(self):
        try:
            ...
            self.create_one_way(self._client_group_name1, self.smart_groups[0])
