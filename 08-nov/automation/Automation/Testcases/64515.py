...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Amazon backup and Restore test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Metallic baisc acceptance test for Amazon hosted Infra"
        self.browser = None
        self.vsa_obj = None
        self.admin_console = None
        self.unique_param = None
        self.company_prefix = "VSA-Automation-AWS-HI-"
    ...
    def setup(self):
        try:
            ...
            self.create_tenant()
            # self.company_name = "VSA-Automation-AWS-17-June-22-47"
            # self.cs_user = "VSA-Automation-AWS-17-June-22-47\\uat"
            ...
            if 'm055' in self.inputJSONnode['commcell']["webconsoleHostname"]:
                self.vsa_metallic_helper.hub = False
            else:
            ...
            self.vsa_metallic_helper.metallic_options.cloud_storage_name = self.vsa_metallic_helper.metallic_options.\
                                                                              cloud_storage_name + self.unique_param
    ...
    def tear_down(self):
        try:
            ...
            if self.status == constants.PASSED:
                if not self.vsa_metallic_helper.hypervisor_helper_obj:
                    self.vsa_metallic_helper.create_hypervisor_helper()
                self.vsa_metallic_helper.hypervisor_helper_obj.switch_to_admin_access()
