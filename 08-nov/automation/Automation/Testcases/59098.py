...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Validates password complexity, history and expired user"""
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate(feature='password_complexity_and_history_features',
                               password_history={"level": "commcell",
                                                 "value": 2},
                               complexity_level=3,
                               age_password_days=5)
