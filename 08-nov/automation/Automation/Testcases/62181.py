...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] : Performance testing for Infrastructure Page APIs (Media Agents, Hybrid File Store,Storage Arrays) PAPI"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_mediaagents_papi,get_mediaagent_details,get_storage_arrays,get_storagearray_details",
