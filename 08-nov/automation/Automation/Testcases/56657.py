...
Test cases to validate Basic operation window Data Management features at client level
...
class TestCase(CVTestCase):
    """Class for executing Basic operation window Data Management features validation at client level"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Functional] : Basic operation window Data Management features validation at client level for" \
                    " monthly rule with do not submit job enabled"
    ...
    def run(self):
        ...
        Follows the following steps
                ...
                2) Creates an operation window at client level for a list of operations:
        ...
        try:
            ...
            self.op_window = OpHelper(self, self.client)
