...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Vmware failover validation for backup copy job with MA\Index\RFC services down"
        ...
        try:
            ...
            if set(vmjobs) == set(vmjobs1):
                VirtualServerUtils.decorative_log(
                    'No new child jobs triggered for job completed VMs after restart')
            else:
