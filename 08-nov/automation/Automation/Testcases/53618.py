...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Install & Firewall] Unix - Push - CS can open communication to client"
    ...
    def setup(self):
        ...
        self.dummy_client_name = "test_53618_" + self.time_stamp
    ...
    def set_firewall_prerequisites(self):
        ...
        self._network.enable_firewall([self.commserv], [self.firewall_inputs["portNumber"]])
        ...
        self.client_machine.add_firewall_allow_port_rule(int(22))
        ...
        self._network.set_tunnelport([{'clientName': self.dummy_client_name}], [int(self.firewall_inputs["portNumber"])])
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info(f"Pushing fresh Unix client on {self.machine_name} with Firewall configuration"
