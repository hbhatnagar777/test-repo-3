...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Selective Copy Cases for Hourly & Last Full Configuration Most Recent, Accrued Jobs"
        self.tcinputs = {
            "MediaAgentName": None
        }
    ...
    def run_bkp_jobs(self, create_schedule=True, delete_schedule=False):
    ...
    def check_job_status_on_copy(
        ...
        for row in resultset:
            ...
            if int(row[1]) > 0:
                ...
                self.log.info("Copy %s has Last Full Wait Flag set %s",
    ...
    def hourly_last_full_most_recent_accrued(self):
        ...
        for i in range(len(self.subclient_list) - 1):
            for_appids.append(self.subclient_list[i].subclient_id)
