...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute
                            ...
                            with empty backup cycle followed by backup cycle with data
"""
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Automation : Acceptance Test for IntelliSnap backup and restore
                    for Nimble Array"""
