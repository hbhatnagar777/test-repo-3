...
class TestCase(CVTestCase):
    """Class for executing Acceptance test case for Add/Edit/Delete Array in the Array Management for
        NetApp Intellisnap from Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Add/Edit/Delete Array in the array management for Intellisnap test case from Command center For NetApp"
    ...
    def setup(self):
        """setup function for login and retrieving test case inputs
        """
    ...
    def tear_down(self):
        """Main function for test case tear down"""
        try:
