...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "OI +VOI license (operating instances and Virtual operating instances )"
    ...
    def run(self):
        ...
        try:
            ...
            #C:\Program Files\Commvault\ContentStore\Automation\temp
            '''self.license.applyfrom_ac_licensepage(r"C:\Program Files\Commvault\ContentStore\Automation\temp\CVL_008C678A.xml",
                license_sku_perm,
                license_sku_eval,
