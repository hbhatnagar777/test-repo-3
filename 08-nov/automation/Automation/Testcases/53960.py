...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies
        Netapp Open Replication for PVM Configuration"""

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "pvm_replica" #PVM Open Replication
