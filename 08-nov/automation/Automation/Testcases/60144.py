...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the local user groups by installing using authcode, such that the
    users in the local groups specified should become the laptop owners"""
    ...
    def __init__(self):
        ...
        installing using authcode, such that the users in the local groups specified should become the laptop owners"
        self.browser = None
