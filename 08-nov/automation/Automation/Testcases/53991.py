...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of Email Journaling Case Manager
     Jobs Validation"""
    ...
    def __init__(self):
        ...
        self.name = "Basic acceptance test of Email Journaling Case Manager Jobs Validation"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("***************CONTENTSTORE CASE VALIDATION***************")
