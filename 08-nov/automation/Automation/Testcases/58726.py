...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "FSO basic acceptance test for backed up data(Quick Scan)"
        self.tcinputs = {
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                self.error_dict["Analyze client details page"] = \
                    str(error_status)
            ...
            try:
                self.fso_helper.review_size_distribution_dashboard(crawl_type='Backup', is_fso=True)
