...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Dell EMC VMAX TF VPSnap Replication"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Dell EMC VMAX
        TF VPSnap Replication"""
