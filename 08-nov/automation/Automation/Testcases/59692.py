...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = 'v2: VSA VMWARE Full Backup and IP customization and Hostname verification on Windows VM'
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.sub_client_obj.validate_inputs('windows', '', 'windows', True)
