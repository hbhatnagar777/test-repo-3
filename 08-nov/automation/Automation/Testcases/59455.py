...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Entity Developer Settings on clientgroup level"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Developer Settings Command Center - Entity settings on clientgroup level"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "ClientgroupID": self.tcinputs['ClientgroupID']}

    def run(self):
        """Main function for test case execution"""

        try:
            collection_json = 'AdditionalSettingsEntityClientGroupLevel.collection.json'
