...
Test cases to validate Basic operation window Data Management features at Commcell level
...
class TestCase(CVTestCase):
    """Class for executing Basic operation window Data Management features validation at commcell level"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Functional] : Basic operation window Data Management features validation at commserv level" \
    ...
    def run(self):
        ...
        Follows the following steps
                ...
                2) Creates an operation window at Commserv level for a list of operations:
