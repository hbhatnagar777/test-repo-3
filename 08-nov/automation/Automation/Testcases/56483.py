...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Adminconsole Expiration messages for different licensetypes"
    ...
    def run(self):
        ...
        try:
            ...
            '''check the expiry date for evaluation license'''
            self.license.open_ac_licensepage(validate_popup=True)
            self.license.adminconsole.logout()
            '''Apply  Permanent/Expiry license'''
            ...
            self.license.validate_license_details
            self.license.adminconsole.logout()
            '''check the expiry date for Permanent/Expiry license, the warning window only shows within 60 days before expire'''
            self.license.open_ac_licensepage(validate_popup=True)
            self.license.adminconsole.logout()
            ...
            self.license.validate_license_details
            self.license.adminconsole.logout()
            '''check the expiry date for Permanent license'''
            self.license.open_ac_licensepage(validate_popup=True)
