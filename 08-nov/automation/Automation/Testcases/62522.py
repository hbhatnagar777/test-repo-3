...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DB2 Indexing V2: Reconstruction Case for Traditional DB2."
    ...
    def setup(self):
        ...
        self.src_database_name = "IDXV2DB"
    ...
    def create_database(self, database_name):
        ...
        database_cmd = f"{self.db2_base} db2sampl -name {database_name}"
    ...
    def add_subclient(self):
        ...
        self.backupset.subclients.add(subclient_name=self.id,
                                      storage_policy=self.tcinputs['storage_policy'],
                                      description="Index V1 Reconstruction Traditional")
        self.backupset.refresh()
    ...
    def run_restore(self):
        ...
        restore_job = self.backupset.restore_out_of_place(dest_client_name=self.client.client_name,
                                                          ...
                                                          redirect_tablespace_path=self.redirect_path,
    ...
    def tear_down(self):
        ...
        self.log.info("### Teardown for the test case 62274 ###")
        try:
            self.log.info("Deleting Destination Database created from CS")
            self.instance.backupsets.delete(self.dest_db)
            self.log.info("Dropping Automation Created Entities")
            self.db2_helper_object.drop_tablespace(tblspace_name=self.tablespace_name)
            self.db2_helper_object.drop_storage_group(stogroup_name=self.sto_grp)
