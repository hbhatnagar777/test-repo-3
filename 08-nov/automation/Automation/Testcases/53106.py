...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Custom Report: (DataSet) - SQL Server DataSource"
        self.navigator = None
        ...
        self.dataset = None
        self.table = None
        self.datasource_list = None
        self.tcinputs={
            "DataSourcesList": None
        }
    ...
    def init_tc(self):
        try:
            ...
            self.datasource_list = self.tcinputs['DataSourcesList']
        except Exception as e:
            raise CVTestCaseInitFailure(e) from e

    @test_step
    def create_dataset(self):
        """Create and Preview dataSet with SQL Server DataSource"""
        ...
        self.dataset.set_sql_server_datasources(self.datasource_list)
        self.dataset.set_database("CommServ")
        self.dataset.set_sql_query(SQLQueries.sql_server_q1())
