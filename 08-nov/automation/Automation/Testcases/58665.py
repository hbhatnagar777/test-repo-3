...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Run Restore Job for Subclient of the Cluster Client"
        self.tcinputs = {
            "ClientName": None,
            "ClusterName": None
        }
    ...
    def run_restore_and_validate(self):
        ...
        status = self.helper.run_restore(self.tcinputs['ClusterName'])
        if status:
            self.log.info("Client restore job ran successfully")
        else:
            raise CVTestStepFailure("Client restore job did not complete successfully")
