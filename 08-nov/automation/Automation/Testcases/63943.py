...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = (
            f'OneDrive Content Indexing: Basic verification of CI job not getting triggered'
            f' if CI is not enabled in O365 Plan')
        self.browser = None
    ...
    def _initialize_browser(self):
        ...
        self.admin_console.login(
            self.inputJSONnode['commcell']['adminUsername'],
    ...
    def select_app_run_ci(self):
        ...
        job_status = onedrive.run_ci_job(self.client_name, return_status=True)

        if "Completed" in job_status:
            raise CVTestStepFailure(f"CI Job is getting triggered without permission on plan")
