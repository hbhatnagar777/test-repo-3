...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "V1 Hypervisor - Delete API validation for VM with packages"
    ...
    def run(self):
        ...
        try:
            ...
            VirtualServerUtils.decorative_log('Delete deconfig Vm through delete API with no force deletion')
            try:
