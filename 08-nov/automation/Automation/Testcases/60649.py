...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Collection Pruning integration test case for Sharepoint Online v2 client - validate create, run " \
                    "backup, delete client. Validate pruning of sharepoint datasource collections and audit trail logs"
        self.tcinputs = {
    ...
    def run(self):
        ...
        try:
            ...
            if self.sharepoint_pruning_helper.prune_orphan_datasources(datasource_actual_name):
            ...
            if not self.sharepoint_pruning_helper.prune_orphan_datasources(datasource_actual_name):
