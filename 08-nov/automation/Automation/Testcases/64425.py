...
class TestCase(CVTestCase):
    """ GUI Backup and out of place restore to same instance different DB check from MA post sweep for load copy images """
    ...
    def __init__(self):
        ...
        self.name = "Test for DB2 1 Min RPO from GUI to verify out of place restore from MA post sweep for load copy images"
    ...
    def setup(self):
        ...
        self.table_name = "T64425"
        self.tablespace_name = "TS64425"
