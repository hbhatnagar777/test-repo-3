...
APIs being validated inside collection file:
    ...
    PUT /v4/Subclient/{subclientId}/Backup/Action/Disable
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI Subclient"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified Subclient APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPISubclient.collection.json'
