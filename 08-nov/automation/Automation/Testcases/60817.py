...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of v2-Streaming - CTRee+ SOLR - Synthfull Backups with restores."""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "v2-Streaming - CTRee+ SOLR - Synthfull Backups with restores."
