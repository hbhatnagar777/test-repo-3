...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA Hyper-V DIFFERENTIAL Backup and Restore Cases with CBT Checks"
    ...
    def run(self):
        ...
        try:
            ...
            auto_subclient.backup(backup_options, zero_kb_files=False)

            self.log.info("%(boundary)s %(message)s %(boundary)s",
                          {'boundary': "-" * 25,
                           'message': "Perform CBT checks"})
