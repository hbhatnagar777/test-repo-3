...
APIs being validated inside collection file:
    GET /Role
    GET /Role?propertyLevel=1
    GET /Role?propertyLevel=10
    GET /Role?propertyLevel=30
    GET /Role/{{roleId}}
    POST /Role
    POST /Role/{{roleId}}
    DELETE /Role/{{roleId}}
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Role Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'RoleOperations.collection.json'
