...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Security operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Security Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'SecurityOperations.collection.json'
