...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Security - Commcell Admin User Operations."
        ...
        self._role1 = 'Automation_role1_48878'
        self._role2 = 'Automation_role2_48878'
        self._permission_list1 = ['Agent Management']
        self._permission_list2 = ['Administrative Management']
    ...
    def setup(self):
        ...
        user1 = UserProperties(name='TestUser_48878', cs_host=self.commcell.commserv_hostname,
        ...
        subclient_json = sched_helper_obj.entities_setup(client_name=
    ...
    def run(self):
        ...
        self.log.info("This test verifies that a Commcell Admin can perform only Admin Operations "
        ...
        try:
            for user in self._user_list:
                ...
                self._user_helper.create_user(user_name=user.username,
                                              password=user.password, email='test48878@test.com',
