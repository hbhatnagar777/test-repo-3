...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case - Oracle ZFS snap"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Oracle ZFS snap - Basic acceptance Test for intellisnap operations"
