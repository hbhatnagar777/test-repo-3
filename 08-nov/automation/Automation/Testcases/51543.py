...
"""Main file for executing testcase 51543
...
class TestCase(CVTestCase):
    ...
    """Class for validating the outputXML populated when the qoperation command returns error"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "WORKFLOW - Validate the outputXML populated when the qoperation command returns error"
        self._workflow = None
        self.workflow_name = 'WF_QOperation'
