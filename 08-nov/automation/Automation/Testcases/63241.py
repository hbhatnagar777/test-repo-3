...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA OracleVM Full Backup and in place restore for v2"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.run_backup(self, msg='v2 Streaming Full Backup')
            self.tc_utils. \
                run_virtual_machine_restore(self,
                                            in_place_overwrite=True,
                                            power_on_after_restore=True,
                                            unconditional_overwrite=True,
                                            msg='FULL VM in Place restores from Parent')
        except Exception:
            pass
