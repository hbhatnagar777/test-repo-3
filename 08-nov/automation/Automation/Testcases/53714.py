...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Amazon backup & file level restore to unix
    instance test case"""
    ...
    def run(self):
        ...
        try:
            ...
            try:
                decorative_log("Restoring data to Agentless Unix VM ")
    ...
    def tear_down(self):
        if self.vsa_obj:
            ...
            for _vm in self.vsa_obj._vms:
                decorative_log("Powering off backup instance")
