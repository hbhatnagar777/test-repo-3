...
APIs being validated inside collection file:
    ...
    POST Create Blackout Window
    GET Blackout Window Listing
    GET Blackout Window Details
    PUT Modify Blackout Window
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Blackout Window Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API : Blackout Window Operations (Tenant Admin)"
    ...
    def run(self):
        ...
        try:
            collection_json = 'BlackoutWindow-TenantAdmin.collection.json'
