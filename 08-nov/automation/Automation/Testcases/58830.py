...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA Nutanix AHV streaming restores from modofied" \
                    " & deleted data using Windows proxy and Unix MA"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                log.info("----------PIT file level restore from 1st incremental--------------")
            ...
            try:
                log.info("----------PIT file level restore from 2nd incremental---------------")
