...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Virtual Server - VMWare V2 - Snap Synth Full Scenarios for multiple subclients backing up same VM"
        self.tcinputs = {
            "ClientName": None,
            "AgentName": None,
            "InstanceName": None,
    ...
    def run(self):
        ...
        try:
            ...
            VirtualServerUtils.decorative_log("Incremental Snap Backup with backup copy - Subclient 1")
            ...
            VirtualServerUtils.decorative_log("SynthFull for Snap Backup (with backup copy) - Subclient 1")
            backup_options.backup_method = "SNAP"
