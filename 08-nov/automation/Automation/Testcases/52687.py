...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] Windows- Interactive - Push Sp Upgrade - CS can open communication to Client"
    ...
    def setup(self):
        ...
        self.dummy_client_name = "test_52687_" + self.time_stamp
    ...
    def run(self):
        ...
        try:
            ...
            self._network.push_config_clientgroup([self.clientCSName, self.client_group_name])
