...
class TestCase(CVTestCase):
    """Class for executing Testcase to verify One-time Auxiliary Copy, Data verification job schedules"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Schedule] - One Time - Auxiliary copy and Data Verification job"
    ...
    def run(self):
        ...
        try:
            ...
            self._server_tc.log_step(
                """
                            Test Case
                            1. Creates a one time Auxiliary copy job, Data verification job schedule
            ...
            self._server_tc.log_step("""Step 1)
                                        Create One Time Auxiliary Copy Schedule and wait for Job to trigger""")
            ...
            self._schedule_creator.create_schedule('aux_copy',
                                                   schedule_pattern={
                                                       ...
                                                       add_minutes_to_datetime(minutes=60)[1],
                                                       'time_zone': 'UTC'},
            ...
            self._server_tc.log_step("""Step 2)
                            Create One Time Data Verification
