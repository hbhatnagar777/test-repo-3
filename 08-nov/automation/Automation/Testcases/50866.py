...
"""Special Character in MySQL database names.
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.name = "Special Character in MySQL database names."
        self.browser = None
    ...
    def restore(self):
        ...
        self.database_subclient = self.client.agents.get('mysql').instances.get(
            self.tcinputs["InstanceName"]).subclients.get('default')
        self.db_group.access_restore()
        restore_panel = self.db_group.restore_folders(database_type=DBInstances.Types.MYSQL,
    ...
    def create_test_data(self):
        ...
        """
        db_list = self.helper_object.generate_test_data(database_prefix="automation db", num_of_databases=1)
    ...
    def run(self):
        ...
        try:
            ...
            self.restore_validate('before', 'after')
