...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Automation-Guest level restore of VM whose IP is not reachable to proxy"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                self.result_string = str('Using CVVMInfoGuestAPI interface.Guest tools approach used')
