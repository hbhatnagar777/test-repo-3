...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] Performance testing for Server Group page V$ APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_papi_server_groups,get_papi_servergroup_details,get_clientgroup_permissions,get_client_servergroups",
