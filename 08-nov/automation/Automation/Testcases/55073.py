...
Inputs:
    ...
    SnapEngine          --      snap engine to set at subclient
                                values: NEC DynamicSnapVolume or
                                        NEC DynamicDataReplication
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for NEC"
        self.snapengine_list = ['NEC DynamicSnapVolume',
                                'NEC DynamicDataReplication']
        self.browser = None
