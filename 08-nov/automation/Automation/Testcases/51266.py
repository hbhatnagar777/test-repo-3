...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Client Group Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - JSON - Client Group Operations"
    ...
    def run(self):
        ...
        try:
            collection_json = 'ClientGroupOperations.collection.json'
