...
class TestCase(CVTestCase):
    """Testcase : Fresh Installation of Unix Client as a non root user"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Fresh Installation of Unix Client as a non root user"
    ...
    def run(self):
        ...
        try:
            ...
            # Installing the client as a non root user
            ...
            # Performing check readiness on the client    
