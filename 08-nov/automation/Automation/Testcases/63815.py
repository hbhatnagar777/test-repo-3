...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute
                            ...
                            Snap Backup with content as Mountpath, backup Copy and restores from Tape copy
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Automation :  IFind test cases to be covered for each SP testing using mount paths
                    """
