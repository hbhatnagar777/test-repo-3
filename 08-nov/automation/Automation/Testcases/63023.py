...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Validate Usage by agents and licenses page
         of license summary worldwide at group level"""
        self.factory = None
        self.browser = None
    ...
    def run(self):
        try:
            ...
            self.grouphelper.generate_summary_and_validate(ual = True)
