...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Administrative operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Administrative Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'AdministrativeOperations.collection.json'
