...
"""Test Case for OneDrive v2 Client creation with Client Group and Custom Configuration
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "OneDrive v2: Client creation with Client Group and Custom Configuration"
        self.browser = None
        self.navigator = None
