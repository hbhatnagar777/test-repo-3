...
"""Main file for executing testcase 51516
...
class TestCase(CVTestCase):
    ...
    """Class for validating various workflow script APIs"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "WORKFLOW - Validate various workflow script APIs"
        self.workflow_name = 'WF_SCRIPTAPI'
