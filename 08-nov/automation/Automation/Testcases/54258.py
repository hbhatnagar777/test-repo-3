...
class TestCase(CVTestCase):
    """Class for executing MySQL BLB Redirect restore to different
    instance in the same client testcase"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()

        self.name = "MySQL BLB Redirect restore to different instance in the same client"
