...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Azure Blob Object Storage key based authentication from command center
        Example inputs:
        "56494": {
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 for Azure Blob Key-based Auth from Command center"
        self.browser = None
