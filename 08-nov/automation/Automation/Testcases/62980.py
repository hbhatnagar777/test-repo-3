...
TestCase:   Class for validating default user-group associations and
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.OKTA_url = None
        self.name = "Company SAML app with name different than Company name"
        self.browser = None
    ...
    def init_tc(self):
        ...
        try:
            ...
            # updating download directory of browser before launching it
            ...
            # commandcenter attributes mappings
            self.attr_mappings = {
                "user name": "un",
                "Email": "email",
                "user guid": "guid",
    ...
    def verify_slo(self):
        ...
        if not self.helper_obj.check_slo(self.OKTA_url):
            self.log.info("Skipping SLO verification & logging out manually at Okta")
    ...
    def run(self):
        try:
            ...
            # modify saml app to add group1 as default user-group
