...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Ownership Transfer for Commcell users [local user, AD user, LDAP user,
         OpenLDAP user and Oracle user]"""
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate(feature='ownership_transfer')
