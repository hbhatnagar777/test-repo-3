...
6: Run Scalable AuxCopy Job on all the 8 Storage Policies
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = 'Marking Referenced Chunks Bad by AuxCopy for DiskLibraries'
        self.tcinputs = {
    ...
    def cleanup(self):
        ...
        try:
            ...
            if not self.is_user_defined_lib:
                ...
                self.mm_helper.remove_content(self.mount_path_1, self.ma_machine_1)
    ...
    def run_verification_jobs(self):
        ...
        self.log.info('Running the Verification Jobs: Aux Copy')
        log_line = ''
    ...
    def produce_result(self):
        ...
        for sub_case in range(1, 9):
            ...
            # wont mark failed in 1)sfile idx cases
            if (sub_case < 5) \
                    and ((expected_statuses[sub_case - 1] in self.verification_statuses[sub_case - 1])
                         or (expected_statuses[sub_case + 7] in self.verification_statuses[sub_case + 7])):
                ...
                self.log.info(case_string_2)
                    ...
                    and ((expected_statuses[sub_case - 1] in self.verification_statuses[sub_case - 1])
                         or (expected_statuses[sub_case + 7] not in self.verification_statuses[sub_case + 7])):
                case_string_2 += ': DV STATUS: VALIDATION: PASSED'
                self.log.info(case_string_2)
            else:
            ...
            # new primary records for next backup
