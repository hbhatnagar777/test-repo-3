...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] WIN - Interactive - Push Sp Upgrade - Client to CS via Proxy"
    ...
    def setup(self):
        ...
        self.tcinputs["proxyPortNumber"] = str(self.config_json.Install.firewall_port)
        ...
        self.dummy_client_name = "test_52688_" + self.time_stamp
        self.clientCSName = "cs_proxy_cl_commserv_group"
        self.dummy_host_name = self.client_machine.machine_name
    ...
    def set_firewall_prerequisites(self):
        ...
        self.log.info("step 4: Block direct connection from client to CS")
        ...
        if not self.commcell.client_groups.has_clientgroup(self.client_group_name):
            self.commcell.client_groups.add(self.client_group_name, [self.client_obj.client_name])
        else:
            _client_group_obj = self.commcell.client_groups.get(self.client_group_name)
            _client_group_obj.remove_all_clients()
            _client_group_obj.add_clients([self.client_obj.client_name],
                                          overwrite=False)
    ...
    def run(self):
        ...
        try:
            ...
            self._network.push_config_clientgroup([self.clientCSName, self.proxy_group_name, self.client_group_name])
    ...
    def tear_down(self):
        ...
        self.client_machine.remove_firewall_rules(['BLOCK_CS'])
