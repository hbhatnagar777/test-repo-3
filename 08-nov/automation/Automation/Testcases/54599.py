...
Test cases to validate Basic operation window Data management features validation at client group level
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Acceptance] : Basic operation window Data management features validation at client group level"
    ...
    def run(self):
        ...
        try:
            ...
            op_window = OpHelper(self, self.clientgroup)
