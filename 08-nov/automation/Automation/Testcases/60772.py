...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Database Instances page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_db_instances,get_db_instance_details,get_sql_instance,"
                                  "get_subclient_fileserver,get_client_details,get_jobs_calendar,get_databases,"
                                  "get_database_details,get_database_clones",
