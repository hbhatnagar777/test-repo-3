...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Oracle Cloud Infrastructure : Linux proxy FULL backup with in-place FULL vm restore"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info('In placeVM Restore finished')
