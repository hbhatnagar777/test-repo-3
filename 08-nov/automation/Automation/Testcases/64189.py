...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DB2 One Min RPO with Sweep Job Acceptance TestCase"
        self.browser = None
    ...
    def setup(self):
        ...
        try:
            ...
            self.table_name = 'TBL64189'
            self.tablespace_name = 'TBS64189'
    ...
    def run_and_validate_sweep_job(self):
        ...
        try:
            ...
            self.db2_helper.run_sweep_job_using_regkey(self.tcinputs['media_agent'])
