...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Vmware Cloud Director enduser restores"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VMware Cloud Director Full VM Restore and guest files restore from Command center as end user"
    ...
    def run(self):
        ...
        try:
            ...
            self.admin_console.login(self.tcinputs['ACUsername'], self.tcinputs['ACPassword'], close_popup=False)
