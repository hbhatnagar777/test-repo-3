...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Validation] : [queue jobs for clientgroup, client level and continue after completed or failed state]"
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate(
                ['queue_job_client_group', 'queue_job_clientgroup_resume_after_failed'])
