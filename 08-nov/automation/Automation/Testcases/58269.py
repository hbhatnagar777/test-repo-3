...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Selective Copy Cases for Hourly & First Full Configuration With Sub-Client Disassociation"
        self.tcinputs = {
            "MediaAgentName": None
        }
    ...
    def run_jobs(self, jobType, numOfJobsToRun, numOfsubClientsToRunOn=0):
        """Run numOfJobsToRun jobs on given subclients from sc_list """
        running_job_list = []
        startSubclient = 0
