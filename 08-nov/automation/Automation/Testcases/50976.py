...
APIs being validated inside collection file:
    ...
    POST Storage Policy Copy
    GET Storage Policy Copy Details
    GET Storage Policy Copy Size
    GET Storage Policy Search Engine List
    GET Storage Policy List for a MediaAgent
    PUT Storage Policy
    PUT Storage Policy Copy
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Storage Policy operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Storage Policy Operations with JSON"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "nonDedupeStoragePool": self.tcinputs["nonDedupeStoragePool"],
                       "dedupeStoragePool": self.tcinputs["dedupeStoragePool"],
                       "mediaAgentId": self.tcinputs["mediaAgentId"]
                       }
    ...
    def run(self):
        ...
        try:
            collection_json = 'StoragePolicyOperations.collection.json'
