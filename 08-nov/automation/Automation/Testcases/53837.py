...
class TestCase(CVTestCase):
    """Class for executing GDPR Of OCR With Online Crawl"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "GDPR Of OCR With Online Crawl"
    ...
    def run(self):
        ...
        try:
            ...
            # Include all entities here including ocr entities
            self.entities_list = ['Person', 'Location']
            # Include only those entities here which needs enabling and disabling
            self.ocr_entities_list = ['Person', 'Location']
            wait_time = 2 * 60
            ...
            for entity_name in self.ocr_entities_list:
            ...
            gdpr_obj.plans_obj.create_data_classification_plan(
                ...
                self.tcinputs['ContentAnalyzer'], self.entities_list, enable_ocr=True)
