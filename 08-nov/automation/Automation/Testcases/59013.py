...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute
                            ...
                            Snap Backup, backup Copy, using Recursive scan and restores from Tape copy
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Automation : File scan Test cases for Intellisnap Backups using Recursive scan
                    """
