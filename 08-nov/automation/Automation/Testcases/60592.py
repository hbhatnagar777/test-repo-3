...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Install]:Silent Installation on a Unix machine with One-Way(CS->Client) Firewall"
        self.tcinputs = {
            "portNumber": None
        }
    ...
    def setup(self):
        ...
        self.install_inputs = {
            ...
            "networkGateway": self.tcinputs["portNumber"],
            ...
            "portNumber": self.tcinputs["portNumber"]
        }
        ...
        self.dummy_cs_group = "cs_group_" + self.time_stamp
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Step 3: Create Dummy Unix Client with default port")
            ...
            self._network.set_tunnelport([{'clientName': self.unix_client_name}], [int(self.tcinputs["portNumber"])])
            ...
            self.commcell.client_groups.add(self.dummy_cs_group, [self.commserv])

            self.log.info("Step 6: Set one way network Topology from commserve group to client group")
            topology_name = "cs_to_solaris_" + self.time_stamp
            self._network.one_way_topology(self.dummy_cs_group, self.client_group_name, topology_name)
            ...
            self.commcell.client_groups.delete(self.dummy_cs_group)
