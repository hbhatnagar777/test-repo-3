...
APIs being validated inside collection file:
    ...
    GET /v4/company/{{companyId}}?showInheritedAssociation=true
    PUT /v4/company/{{companyId}}
    DELETE /v4/company/{{companyId}}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI Company Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified Company APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPICompany.collection.json'
