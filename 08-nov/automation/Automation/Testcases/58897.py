...
class TestCase(CVTestCase):
    """Class for executing company username login test case"""

    def __init__(self):
        """Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = """Company User's[local user, AD user, AD as Generic LDAP user, Redhat as Generic LDAP user, 
        openldap user, oracle directory user] login with username from [adminconsole, Rest api, qlogin]"""
