...
APIs being validated inside collection file:
    ...
    POST /Organization
    GET /ServiceCommcell/IsUserPresent?email={{companyname}}@{{companyname}}.com
    GET /CommcellRedirect/RedirectListforUser?user={{companyname}}@{{companyname}}.com
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Router Commcell operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "API Collection for Router Commcell"
    ...
    def run(self):
        ...
        try:
            collection_json = 'RouterCollection.collection.json'
