...
class TestCase(CVTestCase):
    """Class for executing Testcase to verify Monthly Auxiliary Copy, Data verification job schedules"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Auxiliary copy and Data Verification job schedule - Monthly"
    ...
    def run(self):
        ...
        try:
            ...
            self._server_tc.log_step(
                """
                            Test Case
                            1. Creates a Monthly Auxiliary copy job, Data verification job schedule
            ...
            self._server_tc.log_step("""Step 1)
                                        Create Monthly Auxiliary Copy Schedule and wait for Job to trigger""")
            ...
            self._server_tc.log_step("""Step 2)
                            Create Monthly Data Verification
