...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Vmware extent restart validation when jobmgr service restart"
        ...
        try:
            ...
            for each_proxy in proxy_list:
                ...
                for each_server in machine_names:
                    self.tc_utils.sub_client_obj.start_service(each_server, None, None, self.commcell)
            # checking if any jobs to be backup copied
            self.tc_utils.sub_client_obj.run_backup_copy_subclient()
            # Running snap job
