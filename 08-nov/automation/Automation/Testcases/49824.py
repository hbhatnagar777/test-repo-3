...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA VMware Synthetic Full Backup & CBT Restore"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                self.tc_utils.sub_client_obj.backup_folder_name = "SYNTHETIC_FULL"
            ...
            try:
                ...
                self.log.info("{} is not present after inplace restore".format(self.tc_utils.sub_client_obj.backup_folder_name))
            except Exception as exp:
