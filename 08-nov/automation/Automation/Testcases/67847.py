...
class TestCase(CVTestCase):
    """Class for executing basic testcase for Backup and restore for Vcloud through vCloud Plugin as end user"""""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "Basic testcase for Backup and restore for Vcloud through vCloud Plugin as end user"
    ...
    def run(self):
        ...
        try:
            self.vcloud_helper.end_user_login()
            self.vcloud_helper.backup_and_restore(end_user=True)
