...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Intellisnap-Vmware: VSA V1- Snap backup/backup copy when there is a mix of NFS and VMFS Datastore for vendor: {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_v1(vmfs_nfs_vm_config = vmfs_nfs_vm_config)
