...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "OCI - Incr Backup and Restore"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                decorative_log("Case 2: Performing Full Virtual Machine restore from VM Level")
            ...
            handle_testcase_exception(self, exp)
            self.result_string = "Failure in Incremental Backup: " + self.result_string
