...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Huawei - Wild Cards for Subclient Content and Filter"
    ...
    def validate_filter(self, job, ptrn1, ptrn2):
        ...
        for item in ptrn1:
            if item in line1:
                ...
                for item1 in ptrn2:
                    if item1 in line2:
                        self.log.info(f"Wildcard {item1} is present")
                    else:
    ...
    def run(self):
        ...
        try:
            ...
            self._nas_helper.validate_filer_to_filer_restored_content(
                nas_client, new_content, filer_restore_location, filter_content=self.filter
            )
