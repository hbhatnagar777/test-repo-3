...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Metallic - File server interactive install & backups using existing tenant admin, gateway and storage"
        self.browser = None
        self.fs_obj = None
    ...
    def run(self):
        ...
        try:
            ...
            #for install cases, one backup/restore job is enough
