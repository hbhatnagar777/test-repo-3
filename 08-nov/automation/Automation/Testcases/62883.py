...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP Backup and restore: Cluster As a Client on Solaris MA"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Basic acceptance of NDMP Intellisnap Backups for Cluster as client on Solaris MA"
