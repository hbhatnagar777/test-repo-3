...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Apply subscription license (Permanent license with expiration date )"
    ...
    def run(self):
        ...
        try:
            ...
            '''Generate and apply new licens of Permanent License Expiry type'''
            ...
            '''Check the expiry warning Note: The warning window will open within 60 days before expiry date'''
