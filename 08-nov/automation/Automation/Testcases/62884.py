...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP Backup and restore: vserver with tunneling client on HP-UX MA"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test for vserver with tunneling enabled on HP-UX MA"
