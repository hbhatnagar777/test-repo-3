...
class TestCase(CVTestCase):
    ...
    4. Create a Kubernetes client with proxy provided
    5. Create application group for kubernetes with non-namespaced namespace as content
    6. Initiate Full Backup for App group created and verify job completed
    7. Initiate Incremental Backup for App group created and verify job completed
    8. Cleanup testbed
    9. Cleanup clients created.
    """
    def __init__(self):
        super(TestCase, self).__init__()

        self.name = "Kubernetes - Full and Incremental Backup of Non-namespaced Namespace "
    ...
    def create_testbed(self):
        ...
        self.content.append('non-namespaced')
    ...
    @TestStep()
    def verify_ns_backup(self, full=True):
        """
        Verify Backup of entire namespace as content
        """
        ...
        if full:
            ...
            self.log.info('Step 2 -- Run INCREMENTAL Backup job with Namespace as content')
            self.kubehelper.backup("INCREMENTAL")

        self.log.info('Backup job step with Namespace as content successfully completed')
    ...
    def run(self):
        ...
        try:
            ...
            self.verify_ns_backup()
            # Step 2 - Take INCR Backup of App Group
            self.verify_ns_backup(full=False)
