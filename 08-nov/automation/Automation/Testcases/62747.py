...
class TestCase(CVTestCase):
    """Test case for FSO Delete review action along with request manager and filters in Command Center"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "FSO: Advanced test case for Delete Review actions along with request manager and filters"
    ...
    @test_step
    def review_delete_fso_action(self):
        """
        ...
        try:
            ...
            delete_action_status = \
                self.gdpr_obj.data_source_review_obj.review_delete_action(
                    '', is_fso=True, all_items_in_datasource=True, review_request=True,
    ...
    @test_step
    def verify_delete_review_action(self):
        """
    ...
    def run(self):
        ...
        try:
            ...
            time.sleep(self.wait_time)
            self.review_delete_fso_action()
            self.verify_delete_review_action()
