...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Metallic basic acceptance test for Amazon-backup using gateway method"
        ...
        self.company_prefix = "VSA-Automation-AWS-"
    ...
    def setup(self):
        ...
        try:
            ...
            self.log.info("browse failed to open")
            self.log.info("sleeping for 60 sec")
            time.sleep(60)
            self.browser = factory.create_browser_object()
            self.browser.open()
