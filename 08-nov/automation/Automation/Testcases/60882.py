...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for APIs for HyperVisors PAGE"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_client_server,get_client_details,get_instance_hyperv,"
                                  "get_mediaagent_recoveryenabler,get_jobs_calendar,get_subclient_fileserver",
                       "email": self.tcinputs["email"],
                       "fileName": self.fileName,
                       "get_client_server": {
                           "PseudoClientType": "VSPseudo",
                           "excludeVendorId": "201",
                           "Fl": "VSPseudoClientsList.client,"
                                 "VSPseudoClientsList.clientActivityControl.activityControlOptions,"
                                 "VSPseudoClientsList.customAttributes,VSPseudoClientsList.instance.instanceId,"
                                 "VSPseudoClientsList.status,VSPseudoClientsList.VSInstanceType",
                           "Sort": "name:1",
                           "Limit": "20",
                           "Start": "0"
                       },
