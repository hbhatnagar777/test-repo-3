...
APIs being validated inside collection file:
    GET /client
    GET /Backupset?clientId={{ClientId}}
    GET /Backupset?clientName={{ClientName}}
    GET /Backupset/{{backupsetId}}
    POST /Backupset
    POST /Backupset/{{backupsetId}}
    POST /backupset/byName(clientName='{{ClientName}}',appName='File System',backupsetName='{{NewbackupsetName_2}}')
    DELETE /Backupset/{{backupsetId}}
    DELETE /Backupset/byName(clientName='{{ClientName}}',appName='File System',backupsetName='{{backupsetName}}')
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Backup Set Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Backup Set Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'BackupSetOperations.collection.json'
