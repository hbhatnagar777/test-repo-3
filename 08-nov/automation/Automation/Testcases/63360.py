...
"""
Ring Routing: Remote Links to Child Company [UI]

This test verifies the remote links from reseller idp to remote child company for:
    Edit icon
    Dashboard icon
    Company link
    Configure
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.rr_helper = None
        self.reseller = None
        self.name = "Ring Routing: Remote Links to Child Company [UI]"
        self.tcinputs = {}
