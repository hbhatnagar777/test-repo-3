...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Amazon S3 Cloud Object Storage from command center using Flat Mode Scan
            Example inputs:
                "71196": {
    ...
    def __init__(self):
        ...
        self.name = "ACC1 for Amazon S3 Object Storage Access and Secret Keys from command center using Flat Mode Scan"
        self.browser = None
