...
class TestCase(CVTestCase):
    """Class for executing this test case
        Test case for Subclient Directory Cleanup - Basic Acceptance with Scan Marking (Differential Not Supported)
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Subclient Directory Cleanup - Basic Acceptance with Scan Marking (Differential Not Supported)"
        self.tcinputs = {
            "TestPath": None,
    ...
    def setup(self):
        """Setup for automation -
            ...
            3. Creating regkeys CopySubclientJobResultsFolderAfterScan, bDifferentialJobSupported
        """
        ...
        self.log.info("Add additional setting to disable Differential Support.")

        self.client.add_additional_setting(
            "FileSystemAgent",
            "bDifferentialJobSupported",
            "INTEGER",
            "0"
        )
        self.log.info("Differential Support disabled.")
