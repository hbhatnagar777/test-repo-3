...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "MongoDB IDA Command Center - ACCT1 Out Of Place Granular Restore Without " \
                    "Overwrite"
        self.browser = None
    ...
    def _restore(self):
        ...
        self.restore_obj.restore_out_of_place(self.tcinputs['pseudo_client_name'], overwrite=False)
