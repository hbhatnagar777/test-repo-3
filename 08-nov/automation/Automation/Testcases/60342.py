...
class TestCase(CVTestCase):
    """Command Center- Network topology- One-way forwarding (server)"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Command Center- Network topology- One-way forwarding (server)"
        self.browser = None
        self.topology_name = "CG_60342_ONE_WAY_FORWARDING"
        self.admin_console = None
        self.navigator = None
        self._client_group_name1 = "CG_60342_SERVER"
        self._client_group_name2 = "CG_60342_INFRASTRUCTURE"
        self._client_group_name3 = "CG_60342_PROXY"
        self.tcinputs = {
            "ServerClient": "",
    ...
    def validate_summary(self, summary, source, destination, group_type, streams,
        ...
        if (check_proxy == 2 or check_server == 2) and check_tunnel_port and check_keep_alive:
            ...
            # Commented until validation is fixed
    ...
    def create_owf_gateway(self, client_group_list, client_list):
        ...
        try:
            # Create a onw-way forwarding topology from servers to Infrastructure client group
            self.networkpage.add_topology(self.topology_name, "One-way forwarding", client_group_list, "servertype")
            ...
            self.validate_summary(self.summary_list[1], client_list[1], client_list[0], 2,
                                  ...
                                  Proxy=client_list[2], Protocol='httpsa')
            # Validate the summary of Proxy/Dmz
    ...
    def configure_multi_streams(self, client_group_list, client_list):
        ...
        try:
            ...
            # Validate the network summary of the proxy client
            self.validate_summary(self.summary_list[2], client_list[0], client_list[1], 3,
    ...
    def validate_encrypt_network(self, client_group_list, client_list):
        ...
        try:
            # Enable the encrypt network topology
            self.networkpage.edit_topology(self.topology_name, None, EncryptTraffic=True)

            # Update the network summaries of the clients
            self.get_summaries()

            # Validation of network summary of servers and proxy
            self.validate_summary(self.summary_list[0], client_list[0], client_list[1],
                                  1, '4', '170', "2500", client_group_list[0],
            ...
            # Disable the encrypt network traffic
    ...
    def validate_smart_topology(self):
        ...
        cg_type = 2  # Infrastructure group
        ...
        # Update the variables with the smart group and client for validation
        ...
        try:
            ...
            self.log.info("Create a topology (owf) with the smart client group My CommServe Computer")
            ...
            self.log.info("Edit the topology with the smart client group My CommServe and My MediaAgents")
