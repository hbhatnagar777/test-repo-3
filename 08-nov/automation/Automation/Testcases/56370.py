...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Automation : New Copy Creation Wizard with SP/Copy Created using non-dedupe
                    pool and OCUM Server enabled"""

    def run(self):
        """Main function for test case execution"""

        self.tcinputs['sp_using_pool'] = True
        self.tcinputs['dedup'] = False
        try:
