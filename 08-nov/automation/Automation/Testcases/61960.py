...
class TestCase(CVTestCase):
    ...
    and Guest file Restore test case - V1 Indexing
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA V1 VMWARE Snap Backup and Guest File Restore Case using " \
                    "Windows Proxy, Linux Guest and Proxyless transport mode for : {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_v1_guestfile(
                vsaproxy_os="windows", guest_os="linux", transport_mode="directsan")
