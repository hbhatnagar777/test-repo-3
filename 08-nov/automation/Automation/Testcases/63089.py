...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Metallic - Azure PostgreSQL using Managed Identities Authentication
    Example:
        "63089": {
          "Region": "azure region",
          "StorageAccountName": "",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for Azure PostgreSQL using Managed Identities Authentication"
        self.browser = None
    ...
    def generate_test_data(self):
        ...
        db_prefix = "metallic_auto_dump_63089"
