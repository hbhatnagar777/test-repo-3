...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("Basic Acceptance Test for GDPR\
    ...
    @test_step
    def review_googledrive_datasource(self):
        """
        ...
        self.log.info(f"Sensative Files from Database are {self.sensitive_files}")
        for filepath in self.sensitive_files:
            if not self.gdpr_obj.compare_entities(filepath, cs.GOOGLE_DRIVE):
    ...
    def run(self):
        ...
        try:
            ...
            self.review_googledrive_datasource()
