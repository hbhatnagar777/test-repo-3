...
Input Example:
    "testCases":{
        ...
        "git_acctype": "<GitHub Account type>" (optional, default is Business/Institution),
        ...
        "dest_project": "<destination project>" (optional, default- automation_project_62642),
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "GitHub IDA - Verify Job Restartability For Out Of Place(GitHub) & Cross Client(Azure DevOps) Restore TC"
        self.browser = None
    ...
    def access_or_create_client(self):
        ...
        if not self.instances.is_instance_exists(self.az_app_name):
            if self.tcinputs.get("plan"):
                ...
                raise CVTestCaseInitFailure(f"Instance: {self.az_app_name} doesn't exist."
                                            f" Plan is required for creating new instance")
        self.instances.access_instance(self.git_app_name)
    ...
    def restore_and_validate_data_azure(self):
        ...
        self.git_data = {dest_project: self.git_data}
        self.azhelper.validate_test_data(self.git_data, self.githelper.backup_path,
    ...
    def run(self):
        ...
        try:
            ...
            self.admin_console.select_breadcrumb_link_using_text(self.git_app_name)
