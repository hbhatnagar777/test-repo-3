...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("AMAZON : V2: Streaming Full backup and Full VM restore for Linux VM with "
    ...
    def run(self):
        ...
        try:
            ...
            found, log_line = VirtualServerUtils.find_log_lines(
                cs=self.commcell,
                client_name=
                self.vsa_obj.auto_vsa_subclient.backup_job.details['jobDetail']['clientStatusInfo']['vmStatus'][0][
                    'Agent'],
                log_file='vsbkp.log',
