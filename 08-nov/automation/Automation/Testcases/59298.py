...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "AHV streaming proxy failover validation with coordinator services down"
    ...
    def run(self):
        ...
        Note: Reduce the number of data readers so failover can happen when some VM's are done
        """
        ...
        try:
            ...
            try:
                ...
                auto_subclient.backup(backup_options, job_status=True, op_id=3, entity_id=1)
            ...
            if auto_subclient and backup_options:
                ...
                auto_subclient.service_operation(op_id=2, entity_id=1, username=self.tcinputs['username'],
