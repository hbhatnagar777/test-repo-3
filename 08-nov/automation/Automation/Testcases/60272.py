...
class TestCase(CVTestCase):
    """Class for executing set retention action for files with UNC path present on a page in Review page in SDG"""
    test_step = TestStep()
    ...
    def __init__(self):
        ...
        self.name = "Set retention action for files with UNC path present on a page in Review page in SDG"
        self.tcinputs = {
