...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Security - Report/Alert Admin User Operations"
        ...
        self._role = 'Automation_role_48881'
        self._permission_list1 = ['Report Management']
    ...
    def setup(self):
        ...
        self._email = self._email = self.config_json.Security.email_id
        self.password = self._user_helper.password_generator()
        user1 = UserProperties(name='TestUser_48881', cs_host=self.commcell.commserv_hostname,
    ...
    def run(self):
        ...
        self.log.info("This test verifies that a Report/Alert Admin can perform only report/alert"
        ...
        try:
            ...
            for user in self._user_list:
                ...
                self._role_helper.delete_role(self._role)
                self._role_helper.create_role(role_name=self._role,
                                              permission_list=self._permission_list1)
                self._user_helper.create_user(user_name=user.username,
                                              password=user.password, email='test48881@test.com',
