...
TestCase:
    ...
    "testCases": {
        "59510": {
            ...
            "cql_port": "9042",
            "jmx_port": "7199",
            "plan": "cassandra_serverplan",
            "config_file_path": "/etc/dse/cassandra",
...
class TestCase(CVTestCase):
    ...
    non-default cql/jmx port and ssl
    """

    def __init__(self):
        super(TestCase, self).__init__()
        self.name = "Backup and restore for cluster with ssl enabled"
    ...
    def setup(self):
        ...
        self.cassandra_server_name = "automated_cassandra_server_62019"
    ...
    def run(self):
        try:
            ...
            self.cassandra.create_cassandra_instance(ssl=True)

            #connect to cql host
            self.cassandra.connect_to_db(ssl_enabled=True)
            ...
            self.cassandra.verify_restore(
                destinstance=self.destinationinstance, paths=[self.keyspace])
