...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("Virtual Server - HyperV - Live sync - Basic Before Synthetic full backup,"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_subclient.backup(backup_options, msg='SYNTHETIC_FULL BACKUP')
            ...
            self.vsa_subclient.validate_live_sync(self.schedule_name)
