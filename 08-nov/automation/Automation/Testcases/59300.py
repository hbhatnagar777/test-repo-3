...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "AHV streaming MA failover validation"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                auto_subclient.backup(backup_options, job_status=True, op_id=3, entity_id=3)
            ...
            if auto_subclient and backup_options:
                ...
                auto_subclient.service_operation(op_id=2, entity_id=3, username=self.tcinputs['username'],
