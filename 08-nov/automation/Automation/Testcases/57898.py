...
APIs being validated inside collection file:
    ...
    POST Job Resume
    POST Job Kill
    POST MultiJob Operation (Suspend)
    POST MultiJob Operation (Kill)
    GET Events
    GET Events - JobId
    GET Events for a client
    GET Events - anomalous
    POST List Anomalous Jobs
...
class TestCase(CVTestCase):
    ...
    def run(self):
        ...
        try:
            collection_json = 'JobOperationsEndpoints.collection.json'
