...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP - HNAS Advanced Backup Option - Backup Offline Data"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "NDMP - HNAS Advanced Backup Option - Backup Offline Data"
        self.tcinputs = {
