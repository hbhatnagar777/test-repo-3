...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Azure Blob Object Storage IAM AD Authentication from command center
        ...
        "60731": {
                  ...
                  "oop_account_name": "STORAGE ACCOUNT_NAME FOR OOP RESTORE" ,
                  "access_key": "ACCESS KEY FOR CLOUD HELPER",
                  "oop_access_key": "ACCESS KEY FOR CLOUD HELPER",
                  "tenant_id": "TENANT ID",
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 for Azure Blob IAM VM Auth from Command center"
        self.browser = None
        ...
        self.utils = None
        self.azure_dlg2_helper = None
        self.asdl_bucket_name = None
        ...
        self.endpoint = None
        self.is_asdl_bucket_created = False
        self.default_subclient_content = []
        self.tcinputs = {
            "proxy_client": None,
            "plan": None,
            "account_name": None,
            "oop_account_name": None,
            "access_key": None,
            "oop_access_key": None,
            "content": None,
            "bucket_name": None,
    ...
    def setup(self):
        ...
        self.azure_dlg2_helper = AzureDataLakeHelper(account_name=self.tcinputs.get('oop_account_name')[1:],
                                                     access_key=self.tcinputs.get("oop_access_key"))
        ...
        self.asdl_bucket_name = self.tcinputs["dest_cloud_path"][1:]
    ...
    def out_of_place_restore(self):
        ...
        self.db_helper.wait_for_job_completion(jobid)
        self.log.info("Restore job ran Successfully")
        self.restored_data_path = self.controller_object.join_path(self.azure_dlg2_helper.common_dir_path,
                                                                   'out_of_place')
        self.log.info("Downloading bucket started........")
        self.azure_dlg2_helper.download_container_dl(self.asdl_bucket_name, "out_of_place")
        self.restored_data_path = self.controller_object.join_path(self.restored_data_path, self.bucket_name)
        self.log.info("Downloading bucket done!")
        self.validate_data()
        self.is_asdl_bucket_created = True
    ...
    def cleanup(self):
        ...
        if self.is_asdl_bucket_created:
            self.azure_dlg2_helper.delete_container_azure_dl(self.asdl_bucket_name)
            self.azure_dlg2_helper.azure_data_lake_cleanup()
    ...
    def run(self):
        ...
        try:
            ...
            # Change the auth type of for the instance
