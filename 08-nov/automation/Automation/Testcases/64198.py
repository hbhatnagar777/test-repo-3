...
class TestCase(CVTestCase):
    """Testcase : Universal Installer: Use tenant admin credentials to install a windows client to Master CS"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Use tenant admin credentials to install a windows client to Master CS"
    ...
    def setup(self):
        ...
        self.silent_install_dict = {
            ...
            "commserveUsername": self.config_json.Install.mastercs.tenants.Auto_Tenant1.users.user1,
            "commservePassword": self.config_json.Install.mastercs.tenants.Auto_Tenant1.users.password1}
