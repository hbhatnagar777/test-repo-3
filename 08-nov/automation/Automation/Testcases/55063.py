...
Inputs:
    ...
    SnapEngine          --      snap engine to set at values :
                				Dell EMC VNX / CLARiiON SnapView / VNX Snap or	
                                Dell EMC VNX / CLARiiON SnapView Clone
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for EMC VNX"
        self.snapengine_list = ['Dell EMC VNX / CLARiiON SnapView / VNX Snap',
				                 'Dell EMC VNX / CLARiiON SnapView Clone']
        self.browser = None
