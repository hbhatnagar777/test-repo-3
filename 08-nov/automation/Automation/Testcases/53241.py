...
class TestCase(CVTestCase):
    ...
    IBMSVC  Space Efficient Flash copy (Snap) """
    ...
    def __init__(self):
        ...
        self.name = """Basic Acceptance Test of IntelliSnap backup and Restore for
                        Snap engine IBMSVC  Space Efficient Flash copy (Snap)"""

    def run(self):
        """Main function for test case execution run function of this test case calls SnapHelper
        Class to execute and Validate"""
