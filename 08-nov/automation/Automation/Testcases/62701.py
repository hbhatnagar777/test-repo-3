...
class TestCase(CVTestCase):
    ...
    def create_inventory(self):
        ...
        self.admin_console.log.info(f"Sleeping for {cs.ONE_MINUTE}")
    ...
    def review_setretention_action_filesystem(self):
        ...
        try:
            ...
            status = self.gdpr_base.data_source_review_obj.review_set_retention_action(
                '', cs.ONE_MONTH, all_items_in_page=True,  review_request=True, request_name=self.request_name, reviewer=reviewer,
                approver=approver
            )
    ...
    def validate_review_action(self):
        ...
        for filename in self.sensitive_files:
            # To check if the file is a sensitive file
