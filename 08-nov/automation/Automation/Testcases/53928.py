...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VMware INCR DIFFERENTIAL  backup
    and Restore test case - v2 Indexing"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE DIFF Backup and Restore Cases for v2 indexing"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                VirtualServerUtils.decorative_log("Files restores from backup copy")
