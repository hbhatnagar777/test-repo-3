...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Category for VMware with RestApi approach"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "v2: VSA VMWARE Full Backup and Full VM Restore for Category with RestAPI"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                self.tc_utils.sub_client_obj.validate_content("TagCategory")
