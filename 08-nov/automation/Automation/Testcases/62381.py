...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for CRUD APIs of ALERT"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "create_alert,create_servergroup,create_schedule_policy,create_pseudo_client,create_organization",
                       "email": self.tcinputs["email"],
                       "fileName": self.fileName,
                       "company_plan": self.tcinputs["company_plan"]
                       }
