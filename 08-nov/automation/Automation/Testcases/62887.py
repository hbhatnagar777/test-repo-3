...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP Backup and restore: Vserver with tunneling as a client on HP-UX MA"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Basic acceptance of NDMP Intellisnap Backups for Vserver with tunneling as a client on HP-UX MA"
