...
class TestCase(CVTestCase):
    """Testcase : Universal Installer: Use authcode to install a linux client to a company in service commcell using master cs endpoint"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Use authcode to install a linux client to a company in service commcell using master cs endpoint"
