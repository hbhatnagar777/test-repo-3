...
class TestCase(CVTestCase):
    """Class for executing data management job related operations through
    Workflow activities"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Perform data management job related operations"
    ...
    def setup(self):
        ...
        self._workflow = WorkflowHelper(self, "wf_job_control")
    ...
    def run(self):
        ...
        try:
            ...
            for job_type in ["JobControl", "JobControlAll",
                             "JobControlClient", "JobControlMA"]:

                self._log.info("Executing workflow test for job control type: {}".\
                                    format(str(job_type)))

                self._workflow.execute(
                    {
                        'INP_JOBCONTROL_TYPE': job_type,
                        ...
                        'INP_JOB_MEDIA_AGENT': self._workflow_ma,
                        'INP_JOB_REPORT_TYPE': "html",
                    }
                )
