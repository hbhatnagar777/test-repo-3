...
class TestCase(CVTestCase):
    """ ACCT1 for Azure PAAS PostgreSQL- Flexible Server from command center- AD MI
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 for Azure PAAS PostgreSQL- Flexible Server from command center- AD MI"
        self.browser = None
    ...
    def set_postgres_helper_object(self):
        ...
        self.postgres_helper_object = pgsqlhelper.PostgresHelper(
            ...
            backup_gateway=self.tcinputs['AccessNode'])
