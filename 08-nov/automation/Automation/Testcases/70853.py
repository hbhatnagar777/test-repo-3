...
TestCase:
    ...
    create_new_subclient()      --  creates new subclient with Rman_util device
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "SAP Oracle Acct1 from Command Center using RMAN_UTIL device"
        self.browser = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_70853_TSP'
        self.table_name = "CV_70853_TABLE"
