...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the local user groups by installing and activating with a domain
    user, such that the users in the local groups specified should become the laptop owners"""
    ...
    def __init__(self):
        ...
        installing and activating with a domain user, such that the users in the local groups specified should become\
        the laptop owners"
        self.browser = None
    ...
    def install_and_activate_with_user(self):
        """
            install and activate laptop with user
        """
