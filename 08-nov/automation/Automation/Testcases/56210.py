...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][AdminMode]:Laptop listing page validation """
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][AdminMode]:Laptop listing page validation"
    ...
    def run(self):
        ...
        try:
            ...
            self.laptop_helper.tc.log_step("""
                ...
                5. Validation - All Column values from listing page
                        -Name
                        -Owners
                        -Configured
                        -Total Backup Size
            ...
            self.laptop_obj.email = self.tcinputs['Activation_user_email']
            
            
            self.log.info("Laptop listing page Validation started")
            self.laptop_obj.navigate_to_laptops_page()
            self.laptop_obj.validate_laptop_listing_page()
            self.log.info("*****Laptop listing page Validation completed successfully*****")
