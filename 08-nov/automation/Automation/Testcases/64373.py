...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Metallic - File server interactive install & backup to Microsoft Azure using existing tenant admin and storage"
        self.browser = None
        self.fs_obj = None
    ...
    def configure_plan(self):
        ...
        self.metallic_fs.select_plan(self.plan_name, retention=None)
    ...
    def define_content_and_filters(self):
        ...
        self.metallic_fs.set_backup_content_filters(
            self.content, self.exclusions, self.exceptions)
    ...
    def backup_job(self, backup_type):
        ...
        job = self.fs_sub_client.backup_subclient(subclient_name=self.sub_client_name, backup_type=backup_type, backupset_name="defaultBackupSet")
    ...
    def open_file_server_wizard(self):
        ...
        """
        self.admin_console.click_button(value="Add server")
        self.admin_console.select_radio("WIN_OR_UNIX_FS")
    ...
    def cleanup(self):
        ...
        self.file_server_utils.disable_complaince_lock(self.commcell, self.plan_name)
