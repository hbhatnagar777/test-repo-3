...
class TestCase(CVTestCase):
    """
    Class for executing basic testcase for Full Backup Verifying disk filtering with browse disk and rules for VMware Cloud director through Admin Console
    """""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "VMware Cloud director Full Backup and Verification of disk filtering"
    ...
    def setup(self):
        ...
        self.vsa_obj.vm_group_disk_filters = self.tcinputs['DiskFilters']
    ...
    def tear_down(self):
        try:
            ...
            self.log.warning("Testcase and/or Restored vm cleanup was not completed {}".format(str(exp)))
