...
class TestCase(CVTestCase):
    """ Class for add/Edit/Delete array in Array Management for NetApp LSI from CC """
    ...
    def setup(self):
        """ Initialize pre-requisites for add/Edit/Delete array in Array Management for Netapp LSI from CC"""
    ...
    def tear_down(self):
        """ Tear down fn to cleanup for add/Edit/Delete array in Array Management
         for Dell NetApp LSI from CC """
