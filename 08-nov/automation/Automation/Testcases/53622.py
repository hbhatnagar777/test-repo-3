...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] Unix- Interactive - client can open communication to CS"
    ...
    def setup(self):
        ...
        self.default_log_directory = "/var/log/commvault/Log_Files"
        ...
        self.dummy_client_name = "test_53622_" + self.time_stamp
