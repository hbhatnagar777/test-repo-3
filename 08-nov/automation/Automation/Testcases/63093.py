...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Metallic - Azure MySQL using Non AD Authentication
    Example:
        "63093": {
          "Region": "azure region",
          "StorageAccountName": "",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for Azure MySQL using Non AD Authentication"
        self.browser = None
    ...
    def tear_down(self):
        ...
        if self.mysql_helper_object:
            ...
            self.mysql_helper_object.cleanup_test_data(database_prefix='metallic_auto_dump_63093')
    ...
    def generate_test_data(self):
        ...
        db_prefix = "metallic_auto_dump_63093"
    ...
    def run(self):
        ...
        try:
            ...
            backup_gateway = self.create_instance()
