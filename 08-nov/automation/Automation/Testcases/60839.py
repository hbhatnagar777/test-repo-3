...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Commcell page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_commcell_activitycontrol,get_commserv,get_emailserver,get_password_encryption_config,get_security_commcell,get_plan_commcell,get_commcell_properties,get_slaconfig",
