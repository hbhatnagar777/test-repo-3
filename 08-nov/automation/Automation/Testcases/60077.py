...
class TestCase(CVTestCase):
    """Class for executing ignore files action for files with local path present on a page in Review page in SDG"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Ignore files action for files with local path present on a page in Review page in SDG"
        self.tcinputs = {
