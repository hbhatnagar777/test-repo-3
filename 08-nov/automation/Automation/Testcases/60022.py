...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Alibaba PAAS MySQL backup and restore from command center
    ...
    Example if insatnce does not exist
    "60022": {
        "ClientName": "pseudo_ash",
        "PlanName": "plan_ash",
        "InstanceName": "mysql8[us-central1]",
    ...
    def __init__(self):
        ...
        self.name = "Alibaba PAAS MySQL ACC1 from Command Center"
        self.browser = None
    ...
    def connect_to_instance(self):
        ...
        if self.perform_instance_check:
            ...
            if self.db_instance.is_instance_exists(DBInstances.Types.MYSQL,
                ...
                self.db_instance.add_alibaba_mysql_instance(self.tcinputs['ClientName'],
