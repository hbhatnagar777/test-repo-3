...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA GCP  FULL Snap Backup and Restore Cases for v2 indexing - Parent"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.sub_client_obj.post_backup_validation(validate_cbt=False, skip_snapshot_validation=True)
            ...
            self.tc_utils.run_virtual_machine_restore(self,
                                                      ...
                                                      child_level=False,
                                                      msg='PARENT: Full VM Out-of-place restore from SNAP')
            ...
            self.tc_utils.run_virtual_machine_restore(self,
                                                      ...
                                                      unconditional_overwrite=True,
                                                      child_level=False,
                                                      msg='PARENT: Full VM Out-of-place restore from BACKUP COPY')
            ...
            self.tc_utils.run_guest_file_restore(self,
                                                 ...
                                                 browse_ma=self.tcinputs.get("restore_browse_ma"),
                                                 child_level=False,
                                                 msg='PARENT: Guest Files restores from Parent Snap copy')
            ...
            self.tc_utils.run_guest_file_restore(self,
                                                 ...
                                                 browse_ma=self.tcinputs.get("restore_browse_ma"),
                                                 child_level=False,
                                                 msg='PARENT: Guest Files restores from Parent backup copy')
