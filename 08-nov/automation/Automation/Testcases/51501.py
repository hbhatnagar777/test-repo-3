...
"""Main file for executing testcase 51501
...
class TestCase(CVTestCase):
    ...
    """Class for validating Embedded workflow with same unique name in the activity """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "WORKFLOW - Validate Embedded workflow with same unique name in the activity"
        self._workflow = None
