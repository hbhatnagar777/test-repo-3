...
class TestCase(CVTestCase):
    """SMTP_Automation: Verification of unicode data emails delivery for Contentstore Mailbox"""
    ...
    def __init__(self):
        ...
        self.name = "SMTP_Automation: Verification of unicode data emails delivery for Contentstore Mailbox"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("---------------- SENDING EMAILS WITH UNICODE SUBJECT, BODY AND ATTACHMENTS ----------------")
            cs_object.send_email(15, Exchangeconstants.CSSendEmailHelper.DEFAULT,
                                 Exchangeconstants.CSSendEmailHelper.UNICODE)
            time.sleep(120)
            ...
            for xml_O365 in glob.glob(o365emails_dir + "\\*"):
                unique_id_indx = xml_O365.rfind('\\') + 1
                unique_id_file = xml_O365[unique_id_indx:]
                ...
                if len(diff) != 0:
                    ...
                    raise Exception("There is a difference in metadata fields of unicode email. Please check file:",
                                    xml_smtp)
            self.log.info("There is no difference in metadata. Testcase to verify unicode email delivery is successful")
