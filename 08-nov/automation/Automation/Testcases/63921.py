...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][AdminMode]: File versions Download validation as tenant admin"""
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][AdminMode]: File versions Download validation as tenant admin"
