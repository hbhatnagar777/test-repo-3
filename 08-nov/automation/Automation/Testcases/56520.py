...
class TestCase(CVTestCase):
    """Admin Console: DynamoDB agent: Basic acceptance test case"""
    ...
    def __init__(self):
        ...
        self.name = "DynamoDB agent acceptance test case from command center"
        self.browser = None
    ...
    def submit_backup(self, level='Incremental'):
        ...
        if level != 'Incremental':
            backup_type = RBackup.BackupType.FULL
        else:
            backup_type = RBackup.BackupType.INCR
        bkp = self.dynamodb_subclient.backup(backup_type=backup_type)
    ...
    def submit_in_place_restore(self, table_name):
        ...
        restore_panel_obj = self.dynamodb_subclient.restore_files_from_multiple_pages(
            self.database_type, mapping_dict, 'Sub_56520')
    ...
    def run(self):
        ...
        try:
            ...
            add_subclient_obj.add_dynamodb_subclient('Sub_56520', self.tcinputs['plan'],
                                                     subclient_content)
    ...
    def tear_down(self):
        ...
        self.dynamodb_helper.delete_dynamodb_table('TC_56520')
