...
Inputs:
    ...
    SnapEngine          --      snap engine to set at
								Values: Huawei Oceanstor Snap or 
										Huawei OCeanstor Clone
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Huawei"
        self.snapengine_list = ['Huawei OceanStor Snap',
								'Huawei OceanStor Clone']
        self.browser = None
