...
class TestCase(CVTestCase):
    """ Class for executing Basic acceptance Test for SAP HANA SNAP Backup """
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "SAP HANA Snap ACCT1-Acceptance Test case from command center"
        self.browser = None
    ...
    def run_backup(self, backup_type, backupset_name=None):
        """ method to run backup fro HANA DB
            Args:
    ...
    def run_restore(self):
        ...
        self.log.info("#### Running SapHana Snap most recent In_place Restore ####")
        job_id = self.restore_panel.in_place_restore()
        self.wait_for_job_completion(job_id)
        self.log.info("#### SapHana Snap Most recent In_place restore is completed ####")
