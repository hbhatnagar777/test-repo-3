...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of 'Export To PST'
    ...
    def __init__(self):
        ...
        self.name = "Basic acceptance Test of 'Export To PST' operation " \
    ...
    @test_step
    def perform_export_to_pst_selected_items(self):
        """
            Perform 'Export To PST' operation on given set of results
        """
        ...
        self.app.do_export_to("PST", self.selected_item_count, downloadsetname, self.exportset_name)
    ...
    def validate_pst_results_from_restore(self):
        ...
        self.log.info(f"result is: {result.rows}")
    ...
    def run(self):
        try:
            ...
            self.perform_export_to_pst_selected_items()
