...
class TestCase(CVTestCase):
    """Class for executing basic testcase for Synth Full Backup and restore for VMware Cloud director in admin Console"""""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test of VMware Cloud director synth Full Backup and Restore in AdminConsole"
    ...
    def setup(self):
        self.log.info("Initalising Browser objects")
    ...
    def run(self):
        ...
        try:
            decorative_log("Performing Synth Full Backup")
            ...
            try:
                decorative_log("Performing Full VM Out of Place restore")
