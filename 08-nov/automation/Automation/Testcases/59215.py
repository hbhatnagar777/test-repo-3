...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Exchange Online GUID Verification"
    ...
    def setup(self):
        ...
        self.on_powershell = ExchangePowerShell(ex_object=self.exmbclient_object, cas_server_name=None,
                                                exchange_server=None,
                                                exchange_adminname=self.exmbclient_object.exchange_online_user,
                                                exchange_adminpwd=self.exmbclient_object.exchange_online_password,
                                                server_name=self.exmbclient_object.server_name,
                                                domain_name=self.tcinputs["OnPremDomain"])
    ...
    def run(self):
        ...
        try:
            ...
            migrates_users_ad_guid = self.on_powershell.get_mailbox_guid(mailbox_list=self.migrated_users,
                                                                         environment="AzureAD")
