...
"""Main file for executing testcase 52846
...
class TestCase(CVTestCase):
    ...
    """Class for validating Output of Script activity from Embedded Workflow should not override
        Parent Workflows script activity"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "WORKFLOW - Validate Output of Script activity from Embedded Workflow should not override \
                    Parent Workflows script activity"
        self._workflow = None
