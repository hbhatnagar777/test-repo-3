...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center file servers V4 APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_papi_fileservers,get_client_servers,get_client_details,get_client_shares,get_vmallocationpolicy,get_slaconfig,get_client_hierarchy,get_backupsets,get_subclient_fileserver,get_jobs_calendar,get_role_papi",
