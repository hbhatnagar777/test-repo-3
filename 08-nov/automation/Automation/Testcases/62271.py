...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DB2 Indexing V1: Reconstruction Case for DB2 Table Level."
    ...
    def setup(self):
        ...
        self.src_database_name = "IDXV1TB"
    ...
    def add_subclient(self):
        ...
        self.backupset.subclients.add(subclient_name=self.id,
                                      storage_policy=self.tcinputs['storage_policy'],
                                      description="Index V1 Reconstruction DB2 Table Level")
        self.backupset.refresh()
    ...
    def prepare_data_on_client(self):
        ...
        stogrp_created = self.db2_helper_object.create_storage_group(storage_group_name=self.sto_grp,
                                                                     path=self.home_path,
    ...
    def tear_down(self):
        ...
        self.log.info("### Teardown for the test case 62270 ###")
        try:
