...
from Web.AdminConsole.Helper import CompanyHelper, global_search_helper
from Web.AdminConsole.AdminConsolePages import Companies
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Global Search]: Global search listing and action automation for Companies"
        self.entity_list = []
    ...
    def setup(self):
        ...
        self.companyHelper = CompanyHelper.MSPHelper(self.admin_console,self.commcell)
        self.company = Companies.Companies(self.admin_console)
    ...
    def create_and_search(self):
        ...
        for _ in range(5):
            entity = self.gs_helper.validate_add_entities("Companies")
            if self.gs_helper.validate_global_entity_search("Companies", entity):
    ...
    def listing_page_search(self, entity_list):
        ...
        for entity in entity_list:
            if self.company.company_exists(entity):
                self.log.info("Entity listed in listing page")
    ...
    def edit_entity(self, entity_list):
        ...
        edited_entities = []
        for entity in entity_list:
            self.navigate.navigate_to_companies()
            self.company.edit_company_name(name=entity, new_name="edited_" + entity)
            if self.gs_helper.validate_global_entity_search("Companies", "edited_" + entity):
    ...
    def actions(self, entity_list):
        ...
        for entity in entity_list:
            self.gs_helper.verify_company_actions(entity)
    ...
    def tear_down(self):
        ...
        self.browser.close()
        organizationhelper.OrganizationHelper(self.commcell).cleanup_orgs("GS_test_company")
