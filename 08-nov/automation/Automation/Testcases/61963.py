...
Input Example:
    "testCases":{
        "61963":{
            ...
            "database": "<Database to be backed up> (optional, default - autodb_61963)",
                If db name is autodb_61963, tc will cover all table and file formats else uses tcinputs
            ...
            "test_data": "<string representation of test data dictionary>" (optional,eg."{'key':'val'}")
                ...
                "table_modes": "<Managed/External tables>" (optional, default - ["Managed", "External"])
                "table_types": "<types of tables to be generated>" (optional, default - ["default", "partition_bucket"])
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Hive - Verify Backup & Restore Functionality"
        self.browser = None
    ...
    def generate_data_and_backup(self, backup_type='Full'):
        ...
        if test_data.get('skip_create') or is_incremental:
            ...
            if self.source_db != f'autodb_{self.id}':
                table_modes = test_data.get('table_modes', ['managed', 'external'])
                table_types = test_data.get('table_types', ['default', 'partition_bucket'])
    ...
    def run(self):
        ...
        2) Generates data in given database and runs full backup using hive backup workflow
