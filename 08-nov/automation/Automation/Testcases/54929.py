...
class TestCase(CVTestCase):
    """Test case class for testing Amazon Redshift basic snap backup and restore operations
        ...
        Input JSON:
            ...
            Optional Parameters Example:
            {
                ...
                "Content": [{
                    ...
                    "path": "us-east-2",
                    "displayName": "redshift-cluster-2",
    ...
    def __init__(self):
        ...
        self.name = "Amazon Redshift Basic Acceptance - Snapshot Backup and Restore"
        self.tcinputs = {
            'AccessNode': None,
            'StoragePolicy': None,
            'AccessKey': None,
    ...
    def setup(self):
        ...
        self.subclient_name = "subclient_54929"
        self.content = [
            {
                'type': 'root'
            }
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("""\n
                    Amazon Redshift Basic Acceptance - Snap Backup and Restore
