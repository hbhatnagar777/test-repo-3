...
DATABASE = 'tc_62341'
APP_NAME = f"TC_62341_{datetime.now().strftime('%d_%B_%H_%M')}"
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Salesforce: Backup and Restore of Large Object"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            ...
            self.data = \
                self.sf_helper.create_records(self.sf_helper.sf_object, fields=self.sf_helper.fields, rec_count=12000)
            # Run full backup
            self.backup_full()
