...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Fujitsu ETERNUS Replication"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Fujitsu ETERNUS
        Replication"""
