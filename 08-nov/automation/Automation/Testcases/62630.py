...
class TestCase(CVTestCase):
    ...
    and Full VM Restore test case
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE Snap Backup and Full VM Restore case using " \
                    "Windows Proxy, Windows Guest and NBD transport mode for: {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_v2(
                vsaproxy_os="windows", guest_os="windows", transport_mode="nbd")
