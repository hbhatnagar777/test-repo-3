...
class TestCase(CVTestCase):
    """Testcase : Push Updates to the Exisiting Windows Client"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Push Updates to the Exisiting Windows Client"
    ...
    def run(self):
        ...
        try:
            ...
            if download_job.wait_for_completion(10):
                self.log.info("WindowsX64 Packages Downloaded successfully")
            ...
            self.log.info("Pushing Feature release upgrades to the client: {0}".format(windows_client.client_name))
            upgrade_job = windows_client.push_servicepack_and_hotfix()
