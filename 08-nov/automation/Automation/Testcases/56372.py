...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.tcinputs = {
            ...
            "NAS_attached_lib_name": None,
            "drive_pool": None,
            "scratch_pool": None,
            "NAS_MediaAgent": None
            }
        self.name = """Automation : New Copy Creation Wizard with SP/Copy Created using NAS Attached
                    library and OCUM Server enabled"""

    def run(self):
        """Main function for test case execution"""

        self.tcinputs['nas_attached_lib'] = True
        try:
