...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VMWARE Intellisnap: Allowing parallel backup copy
     to process VMs independently for same VM group"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA V2 VMWARE Intellisnap Allow Parallel Backup copy to process VM's independently: {0}"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_parallel_bkpcpy()
