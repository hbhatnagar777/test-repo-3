...
class TestCase(CVTestCase):
    """Class for executing ignore files action for a single file with UNC path in Review page in SDG"""
    test_step = TestStep()
    ...
    def __init__(self):
        ...
        self.name = "Ignore files action for a single file with UNC path in Review page in SDG"
        self.tcinputs = {
