...
class TestCase(CVTestCase):
    """Hyperscale test class for HSX 3.x Firewall validations for Smoke Testing"""

    def __init__(self):
        """Initialization function"""
        super(TestCase, self).__init__()
        self.name = "Test Case for HSX 3.x Firewall validations for Smoke Testing"
        self.result_string = ""
        self.mas = []
    ...
    def run(self):
        ...
        try: 
            ...
            self.log.info(f"Validating firewall protection")
            ...
            if not result: 
                reason += f"Firewall validations failed"
