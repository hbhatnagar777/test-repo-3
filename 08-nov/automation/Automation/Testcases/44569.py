...
class TestCase(CVTestCase):
    """Testcase for 1-touch backup and Vme to VMware Clone"""
    ...
    def run(self):
        """Runs 1-touch backup and Virtualize me to VMWare Clone"""
        try:
            self.log.info(self.applicable_os)
            ...
            time.sleep(60)
            if self.tcinputs['CloneClientName']:
                dest_machine = self.commcell.clients.get(self.tcinputs['CloneClientName'])
            else:
