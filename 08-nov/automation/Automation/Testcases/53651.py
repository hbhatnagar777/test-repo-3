...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Category for VMware with PowerCLI approach"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE Full Backup and Full VM Restore for Category with PowerCLI"
