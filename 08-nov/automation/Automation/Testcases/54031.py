...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp Open Replication for FanOut
    Configuration"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Netapp
        Open Replication for FanOut Configuration"""
