...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp Open Replication for All
    ...
    def __init__(self):
        ...
        self.name = """Automation: Snapshot Replication: Open replication certification
