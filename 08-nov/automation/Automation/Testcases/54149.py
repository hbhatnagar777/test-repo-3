...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Oracle Cloud Infrastructure : Linux proxy INC backup with in-place FULL vm restore"
    ...
    def run(self):
        ...
        try:
            ...
            # sending indexing as False here because the code
            # in virtualserverhelper cannot handle it correctly.
