...
class TestCase(CVTestCase):
    """ Class for executing basic test case for Event Viewer Alert notification verification"""

    # Constructor for the testcase
    def __init__(self):
        """Initializes the testcase object"""
        super(TestCase, self).__init__()
        self.name = 'Testcase for Verifying Alert notification through Windows Event Viewer Logs'
        self.cache = None
        tcinputs = {
          "AgentName":None,
          "BackupsetName":None,
    ...
    def run(self):
        ...
        try:
            ...
            alert_data = alert_helper.get_alert_xml(name='TestAlertEventViewer',
                                                    notif_type=['Event Viewer'],
            ...
            alert_helper.check_if_event_logged(short_interval=20, patterns=[self.cache.get("job_id"),
