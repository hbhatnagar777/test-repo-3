...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Basic acceptance test of advanced backup options for LNDOC"
        self.applicable_os = self.os_list.WINDOWS
        self.product = self.products_list.LOTUSNOTESDOC
    ...
    def run(self):
        ...
        try:
            self.lnhelp.verify_template_and_encrypted_db_backup()
            self.lnhelp.verify_data_docs_restore()
