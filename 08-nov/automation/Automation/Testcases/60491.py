...
TestCase:
    ...
    create_plan()                   --  Creates a FSO Data Classification Plan"
...
from dynamicindex.utils.constants import HOST_NAME, INDIA_COUNTRY_NAME, CI_POLICY_TYPE, FILE_SYSTEM_IDA
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Activate FSO : v2 Import index job on File system data source"
        self.tcinputs = {
            "MediaAgentName": None,
            "Library": None,
    ...
    def setup(self):
        ...
        self.index_server_roles = [IndexServerConstants.ROLE_DATA_ANALYTICS,
                                   IndexServerConstants.ROLE_FILE_SYSTEM_INDEX]
    ...
    def create_plan(self):
        """Creates a FSO Data Classification Plan"""
    ...
    def create_commcell_entities(self):
        ...
        policy_object = self.commcell.policies.configuration_policies.\
            get_policy_object(CI_POLICY_TYPE, self.file_policy_name)
        policy_object.index_server_name = self.index_server_name
        policy_object.data_access_node = self.index_node_name
