...
class TestCase(CVTestCase):
    """Class for Validation of OCI New Replication Group"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Virtual Server - OCI - Validate Replication - New Replication Group"
    ...
    def run(self):
        ...
        try:
            self.vsa_obj.oci_subnet_name_prop = self.tcinputs['subnetName']
        ...
        try:
            ...
            self.vsa_obj.validate_live_sync()
        except Exception as exp:
            self.test_individual_status = False
            self.test_individual_failure_message = str(exp)
            decorative_log(str(exp))
