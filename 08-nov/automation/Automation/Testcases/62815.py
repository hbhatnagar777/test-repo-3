...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "MS Teams: Verify incremental job doesn't pick up old backed up data"
    ...
    def run(self):
        ...
        try:
            ...
            created_teams = [team.mail for team in self.created_team_list]
            created_teams_name = [team.mail for team in self.created_team_list[:3]]

            self.helper.set_content(created_teams, self.plan)
            ...
            self.log.info(f"Job Details: \n{incremental_job.details}")
            ...
            if num_items_in_inc_job > num_items_in_full_job:
