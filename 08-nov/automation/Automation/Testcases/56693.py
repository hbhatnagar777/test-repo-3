...
APIs being validated inside collection file:
   ...
   GET Instance using clientId
   GET Instance using client name
   GET Instance using parameters
   GET Instance using InstanceId
   POST Instance
   POST modify instance using instance id
   POST modify instance using name
   DEL instance
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Instance Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Instance Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'InstanceOperations.collection.json'
