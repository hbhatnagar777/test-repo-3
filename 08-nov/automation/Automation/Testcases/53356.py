...
class TestCase(CVTestCase) :
    """Class for executing virtual lab in existing network from backup copy"""

    def __init__(self) :
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE Virtual Lab in Existing network- from Backup/Backup copy"
    ...
    def run(self) :
        ...
        try :
            ...
            try:
                ...
                virtual_lab_job = auto_commcell.dev_test_virtual_lab_job(lab_name)
                ...
                auto_client.virtual_lab_validation(source_vm_name=VMs, hvobj=hvobj, vmpolicy=vmpolicy,
                                                   ...
                                                   live_mount_job=virtual_lab_job, virtual_lab=True)
            except Exception as exp:
