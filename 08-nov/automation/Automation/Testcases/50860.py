...
from Install.update_helper import UnixUpdateHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Interactive - Feature release upgrade by copying the software from bootstrapper downloaded media"
    ...
    def run(self):
        ...
        try:
            ...
            self.get_service_pack_to_install(minus_value=self.config_json.Install.minus_value)
            ...
            self.update_helper = UnixUpdateHelper(self.commcell, self.cs_machine)
            ...
            try:
                ...
                self.log.info(f"Software cache deletion failed {exp}")
            ...
            self.log.info("Copy Software Job Successful")
            self.log.info("Performing a Service Pack Upgrade using Bootstrapper downloaded media")
            ...
            install_validation = InstallValidator(_commserv_client.client_hostname, commcell_object=self.commcell,
                                                  ...
                                                  media_path=_media_path if _media_path else None)
