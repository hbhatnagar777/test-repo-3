...
from Server.clients_cache_validator import ClientsCacheValidator
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Entity Caching] - validate the data for server entity"
        self.tcinputs = {
            'fq_filter': None,
    ...
    def setup(self):
        ...
        self._helper = ClientsCacheValidator(self.commcell)

    def run(self):
        """ run function of this test case """
        try:
            self._helper.validate_clients_cache_data()
