...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Metallic office365 OneDrive"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Metallic: office365: OneDrive: Basic case"
        self.browser = None
    ...
    def setup(self):
        ...
        self.tcinputs['office_app_type'] = Office365Metallic.AppType.one_drive_for_business
    ...
    def run(self):
        ...
        try:
            ...
            self.tcinputs['Name'] = self.office365_obj.get_app_name()
            self.office365_obj.add_onedrive_users()
