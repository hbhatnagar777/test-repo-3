...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Streaming Amazon Backup & File Level, Full VM Restore test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "AMAZON : V2: Streaming Incremental backup and File level restore and Full VM restore Automated"
        self.browser = None
        self.vsa_obj = None
    ...
    def run(self):
        ...
        try:
            ...
            try:
                decorative_log("Performing Full VM Restore from VM Level")
