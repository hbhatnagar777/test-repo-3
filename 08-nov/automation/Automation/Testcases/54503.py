...
"""Test case verifies that FSBLR point-in-time pair operations are working from APIs
Sample JSON: {
...
class TestCase(CVTestCase):
    """Class for validating FSBLR point-in-time pair operations from SDK"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "BLR point-in-time Replication Validation"
        self.tcinputs = {
            "source_name": None,
            "source_volume": None,
    ...
    def create_replica_copy(self, idx):
        ...
        self.log.info('Waiting for 5 minutes to let RP store creation')
        time.sleep(300)
