...
APIs being validated inside collection file:
    ...
    GET /{{ServerURL}}/Security/TwoFactorAuth/Status?username={{UserName}}
    GET /{{ServerURL}}/Security/TwoFactorAuth/Pin?username={{UserName}}
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Authentication Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'AuthenticationOperations.collection.json'
