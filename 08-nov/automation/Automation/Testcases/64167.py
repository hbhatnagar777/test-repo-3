...
class TestCase(CVTestCase):
    """Testcase: CommandLine: Override gateway using cmd line argument - windows client"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "CommandLine: Override gateway using cmd line argument - windows client"
    ...
    def setup(self):
        ...
        self.silent_install_dict = {
            ...
            "enableProxyClient" : "1",
            "proxyHostname" : "abc.com",
            "proxyPortNumber": "0",
            "cmdline_args": {
                "authcode": self.authcode,
                "gateway": self.config_json.Install.mastercs.tenants.Auto_Tenant1.gateways.gatewaywin}
        }
    ...
    def run(self):
        ...
        try:
            ...
            # Validation of client installation
