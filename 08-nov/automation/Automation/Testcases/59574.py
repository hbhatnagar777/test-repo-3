...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Activate Performance Automation - FSO live crawl job"
        self.tcinputs = {
    ...
    def setup(self):
        ...
        self.plan_name = "PerformanceFSO_live_TestPlan_%s" % self.id
        self.ds_name = "PerformanceFSO_live_DataSource_%s" % self.id
        self.inv_name = "PerformanceFSO_live_Inventory_%s" % self.id
        ...
        self.monitor_config = self.perf_helper.form_fso_monitor_param(index_server=self.tcinputs['IndexServerName'],
                                                                      job_type=JobTypes.FSO_LIVE_CRAWL,
                                                                      access_node=self.tcinputs['FsoClientName']
                                                                      )
    ...
    def add_fso_server(self):
        ...
        fso_client_obj = self.fso_obj.add_file_server(
            ...
            crawl_path=[self.tcinputs['LocalPath']]
        )
        ...
        try:
            ...
            self.perf_monitor.start_monitor(job_id=self.job_id,
                                            ...
                                            **{GeneralConstants.DATA_SOURCE_NAME_PARAM: self.data_source_name,
                                               GeneralConstants.DYNAMIC_COLUMN_SOURCE_NAME: "Live_Crawl_Scale_Data",
