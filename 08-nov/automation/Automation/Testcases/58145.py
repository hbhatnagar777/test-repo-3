...
class TestCase(CVTestCase):
    ...
    """Class for executing Acceptance test case for Add/Delete NAS server in the Array Management for
       Hitachi NAS from Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Add/Delete NAS Array in the Array Management for NAS Server :  Hitachi NAS from Command center"
    ...
    def setup(self):
        ...
        self.nashelper_obj.array_vendor = 'Hitachi NAS'
