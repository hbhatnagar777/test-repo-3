...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "AMAZON V2: Full backup and Full Instance restore & Distribute Workload Validation"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.run_backup(self, msg='Streaming Full Backup', backup_type="FULL")
            ...
            self.tc_utils.run_virtual_machine_restore(self,
                                                      ...
                                                      validate_restore_workload=True
                                                      )

            self.tc_utils.run_virtual_machine_restore(self, child_level=True,
