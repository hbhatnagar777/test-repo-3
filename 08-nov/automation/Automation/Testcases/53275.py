...
class TestCase(CVTestCase):
    """Class for executing Daily Schedule with Repeat Pattern"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Schedule] - Daily - \"Repeat Every n days\"  and \"Exceptions\""
    ...
    def run(self):
        ...
        try:
            ...
            self._server_tc.log_step(
                """
                            Test Case
                            1) Create a Daily Schedule with "Repeat Every 2 Days"
                               for a Full Backup job on a subclient
                            2) Create a Daily Schedule with "Exception" set as next day
                               of the schedule for an incremental Backup Job on the same subclient.
                            """, 200
            )
            ...
            self._server_tc.log_step("""Step 1)
                            Create Daily Full Backup Schedule with repeat every 2 days
            ...
            self._server_tc.log_step("""Step 2)
                                        Create Daily Inc Backup Schedule with next day from
