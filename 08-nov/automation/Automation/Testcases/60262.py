...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to all AD users by installing using authcode, such that all logged-in
    AD users should become the owners of the laptop"""
    ...
    def __init__(self):
        ...
        installing using authcode, such that all logged-in AD users should become the owners of the laptop"
        self.browser = None
