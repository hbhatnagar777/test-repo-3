...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Test Case for creating cleaning up a storage pool, recreating it and expanding it horizontally"
    ...
    def run(self):
        try:
            ...
            self.log.info("Additional time for the MAs to populate the "
                          "CSDB with brick health and blcok device health "
                          "info ")
            time.sleep(500)
