...
class TestCase(CVTestCase):
    """Testcase : Universal Installer: pass endpointURL as cmdline argument - linux client"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Pass endpointURL as cmdline argument - linux client"
    ...
    def setup(self):
        ...
        self.silent_install_dict = {
            "csClientName": "",
            "csHostname": self.config_json.Install.comp_details.dummy_endpoint,
            "authCode": "",
            "cmdline_args": {
    ...
    def run(self):
        ...
        try:
            ...
            install_validation = InstallValidator(
                ...
                self,
                achine_object=self.unix_machine,
