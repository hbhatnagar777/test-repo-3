...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][EdgeMode]- Downloads from Private Share"""
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][EdgeMode]- Downloads from Private Share"
    ...
    def delete_the_share_as_owner(self):
        ...
        self.edgeshares.delete_private_share(self.tc_test_foldername)
    ...
    @test_step
    def validate_download_from_private_shares(self, share_tab):
        """
        verifying downloads from private shares
        """
        ...
        self.edgeshares.download_items_from_shares(self.tc_test_foldername, select_all=True)
    ...
    def run(self):
        ...
        try:
            ...
            self.validate_download_from_private_shares('SharedByMe')
            ...
            self.validate_download_from_private_shares('SharedWithMe')
