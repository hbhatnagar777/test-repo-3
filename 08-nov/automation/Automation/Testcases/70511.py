...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Vmware extent restart when jobmgr service restart and Restore test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Vmware extent restart validation Vmware extent restart validation when jobmgr service restart for streaming job"
    ...
    def run(self):
        ...
        try:
            ...
            self.tc_utils.sub_client_obj.validate_restart_extents(self.tcinputs.get('username'),
                                                                  ...
                                                                  operation='suspend',
                                                                  clientname=proxy_list[0], jobmgr='Yes',
