...
TestCase:
    ...
    run()               --  run function of this test case calls SnapHelper Class to execute 
                            ...
                            Snap Operations like Mount Unmount Revert Delete etc.
"""
...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap 
        backup and Restore test case - Vplex 3PAR Clone(Distributed volume)"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Vplex 3PAR Clone - Basic acceptance Test for intellisnap operations-Distributed volume."

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['skip_revert'] = True # setting revert flag to skip revert operation for this engine
        self.tcinputs['vplex_engine'] = True
        try:
