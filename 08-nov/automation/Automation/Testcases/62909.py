...
from Install.installer_constants import REMOTE_FILE_COPY_LOC, WINDOWS_FIREWALL_INBOUND_EXCLUSION_LIST
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] Unix - Interactive - CS can open communication to Client"
    ...
    def setup(self):
        ...
        self.tcinputs["commservePassword"] = self.config_json.Install.cs_password
        ...
        self.dummy_client_name = "test_62909_" + self.time_stamp
    ...
    def set_firewall_prerequisites(self):
        ...
        if not self.commcell.is_linux_commserv:
            ...
            self.cs_machine.block_client_firewall_rule(machine_to_block=self.machine_name,
                                                       port=int(self.port_number))
