...
class TestCase(CVTestCase):
    ...
    and Full VM Restore test case - V1 Indexing"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA V1 VMWARE Snap Backup and Full VM Restore case using " \
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_v1(
