...
APIs being validated inside collection file:
        GET /Agent?clientId={{ClientId}}
        GET /Agent?clientName={{ClientName}}
        POST /Agent
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for agent operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Agent Operations using JSON body"
    ...
    def run(self):
        ...
        try:
            collection_json = 'AgentOperations.collection.json'
