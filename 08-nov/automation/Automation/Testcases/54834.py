...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VMware Full Backup and Restore in AdminConsole"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                if self.tcinputs.get('RestoreDestination'):
                    self.vsa_obj.restore_client = self.tcinputs['RestoreDestination']
