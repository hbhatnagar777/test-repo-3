...
class TestCase(CVTestCase):
    """ 
     Class for Metallic AaaS - configure new access node, add new content group, archive and analyze
    """
    test_step = TestStep()
    ...
    def __init__(self):
        ...
        self.name = "Metallic AaaS: add new access node and test content group creation via Archive"
        self.contentgroupname = "auto_archive_63190"
        self.archiving_auto_plan = "auto_plan_63190"
    ...
    def add_content_group(self):
        ...
        #generate test data after new access node is installed and before creating content group
        ...
        self.contentgroup.configure_plan(self.archiving_auto_plan, self.tcinputs["Storage"])
    ...
    def init_pre_req(self):
        ...
        #create custom install input dictionary
        self.installinputs = {}
    ...
    def run(self):
        ...
        5)    add new automation content group and enable archiving
              ...
              if archiving plan does not exist, create new archiving plan
        6)    validate content group is created correctly
        7)    access newly content group, explore archiving rules
        8)    run archiving job
        9)    run in place restore job
        10)   validate the restored data
        11)   delete the test data once test is done
