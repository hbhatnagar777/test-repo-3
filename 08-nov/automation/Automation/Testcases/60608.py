...
TestCase:
    ...
    delete()                    --  Deletes Salesforce app and Connected App credentials from Commcell
...
DATABASE = 'tc_60608'
APP_NAME = f"TC_60608_{datetime.now().strftime('%d_%B_%H_%M')}"
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Salesforce: ACCT1 with OAuth"
        self.browser = None
    ...
    def restore(self):
        ...
        try:
            self.admin_console.navigator.navigate_to_salesforce()
            self.sf_apps.click_on_restore(APP_NAME)
    ...
    def delete(self):
        ...
        try:
            ...
            CredentialManager(self.admin_console).action_remove_credential(APP_NAME)
        except Exception as exp:
            raise CVTestStepFailure from exp
