...
Test cases to validate Basic operation window Data Management features at subclient level
...
class TestCase(CVTestCase):
    """Class for executing Basic operation window Data Management features validation at subclient level"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[Functional] : Basic operation window Data Management features validation at subclient level " \
    ...
    def run(self):
        ...
        Follows the following steps
                ...
                2) Creates an operation window at subclient level for a list of operations:
        ...
        try:
            operations_list = ["FULL_DATA_MANAGEMENT",
                               "NON_FULL_DATA_MANAGEMENT"]
            self.log.info("Validating subclient level operation window for the features:%s",
                          operations_list)
            ...
            self.op_window = OpHelper(self, self.subclient)
