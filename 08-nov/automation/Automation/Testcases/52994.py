...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Schedule] - One Time - All Backup Types & Restore Types"
    ...
    def run(self):
        ...
        try:
            ...
            self._server_tc.log_step(
                """
                            Test Case
                            1. Creates a one time full, incremental, differential,
                               synth full backup schedule
                            2. checks whether the respective job got triggered for schedule
                            3. Creates a one time restore in place schedule
                            4. Checks whether the job got triggered for this schedule
                            5.  Creates a one time restore out of place schedule
            ...
            for backup_type in backup_types:
                self._server_tc.log_step("""Step {0})
                            Create One Time {1} Backup Schedule and wait for Job to trigger"""
            ...
            self._server_tc.log_step("""Step 5)
                            Create One Time restore in place
            ...
            self._server_tc.log_step("""Step 6)
                                        Create One Time restore out of place
                                        Schedule and wait for Job to trigger""")
