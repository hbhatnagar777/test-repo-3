...
class TestCase(CVTestCase):
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("company operations...")
            self.auto_discover_object.organization_with_auto_discover(
                self.tcinputs['CompanyName'], self.tcinputs['CompanyAliasName'],
                self.tcinputs['email'])
            ...
            self.log.info("disable autodiscover option at company level...")
            self.auto_discover_object.company_obj.disable_auto_discover()
