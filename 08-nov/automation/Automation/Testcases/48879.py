...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "This test verifies that a Report/Alert Admin can perform only report/alert " \
        ...
        self._role = 'Automation_role_48879'
        self._permission_list1 = ['Job Management']
    ...
    def setup(self):
        ...
        user1 = UserProperties(name='TestUser_48879', cs_host=self.commcell.commserv_hostname,
        ...
        try:
            for user in self._user_list:
                ...
                self._user_helper.create_user(user_name=user.username,
                                              password=user.password, email='test48879@test.com',
