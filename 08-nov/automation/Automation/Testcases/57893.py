...
APIs being validated inside collection file:
            ...
            GET View Key Management Servers
            GET View Details of Key Management Servers
            POST Create a Key Management Server
            PUT Update a Key Management Server
            DELETE Delete a Key Management Server
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Key Management Server operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Key Management Server Operations with JSON"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "awsUsername": self.tcinputs['awsUsername'],
                       "awsPassword": self.tcinputs['awsPassword']
                       }
    ...
    def run(self):
        ...
        try:
            collection_json = 'KeyManagementServerOperations.collection.json'
