...
class TestCase(CVTestCase):
    """Class For executing Activate Automation to support SDG File system datasource to read from source
    on a 'Agent not installed' client in the tenant environment for verifying create and edit of inventory,
    ...
    def __init__(self):
        ...
        self.name = "Activate Automation to support SDG File system datasource to read from source" \
                    "on a 'Agent not installed' client in the tenant environment for verifying create and " \
    ...
    def setup(self):
        ...
        try:
            ...
            self.client_name = _TENANT_CONFIG_DATA.FileServer.AgentNotInstalled.client_name
            self.access_node = _TENANT_CONFIG_DATA.FileServer.machine_name
    ...
    def run(self):
        ...
        try:
            self.activate_tenant_helper.cleanup_all(self.company_prod_name, self.prod_index_server,
                                                    self.access_node, self.server_plan_name, self.storage_pool_name,
    ...
    def add_activate_solution_to_company(self):
        ...
        self.activate_tenant_helper.move_client_to_company(self.company_prod_name, self.access_node)
    ...
    def add_file_server_datasource(self):
        ...
        self.gdpr_obj.file_server_lookup_obj.add_file_server(
            ...
            self.directory, _TENANT_CONFIG_DATA.FileServer.AgentNotInstalled.username,
            _TENANT_CONFIG_DATA.FileServer.AgentNotInstalled.password,
    ...
    def perform_cleanup(self):
        ...
        self.activate_tenant_helper.remove_client_association(self.company_prod_name, self.access_node)
