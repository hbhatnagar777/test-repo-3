...
class TestCase(CVTestCase):
    """Class for executing Commvault logs test for Unix clients of Log Monitoring"""
    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Log Monitoring test case for CommVault Logs Template for Unix clients"
    ...
    def setup(self):
        ...
        self.file_path = self.mobj.join_path(
            self.commcell.clients.get(self.unix_clients[0]).log_directory,
    ...
    def run(self):
        ...
        try:
            self.monitoring.create_monitoring_policy(
                ...
                self.unix_clients[0], self.file_path)
            ...
            if count != "0":
                self.log.info("Unix CommVault Logs indexed successfully")
