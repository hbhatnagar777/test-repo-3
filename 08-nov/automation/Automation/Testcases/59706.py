...
class TestCase(CVTestCase):
    """Class for executing PGSQL index reconstruction testcase for block level V2 client"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()

        self.name = "PGSQL- Index reconstruction testcase for block level V2 client"
        self.tcinputs = {
            'TestDataSize': None
        }
