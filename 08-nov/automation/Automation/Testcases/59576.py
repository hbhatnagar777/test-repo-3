...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Activate Performance Automation - FSO full scan from client backup data"
        self.tcinputs = {
    ...
    def init_tc(self):
        ...
        try:
            self.file_server_display_name = f"{self.id}_Performance_fso_backup_fullscan"
            ...
            self.monitor_config = self.perf_helper.form_fso_monitor_param(
                ...
                job_type=JobTypes.FSO_BACKUP_FULL_SCAN)
    ...
    def run(self):
        ...
        client_obj = self.commcell.clients.get(self.tcinputs['FsoClientName'])
        ...
        self.perf_monitor.start_monitor(job_id=self.job_id,
                                        ...
                                        **{GeneralConstants.DATA_SOURCE_NAME_PARAM: self.data_source_name,
                                           GeneralConstants.DYNAMIC_COLUMN_SOURCE_NAME: "FullScan_Backup_Scale_Data",
                                           GeneralConstants.DYNAMIC_COLUMN_SOURCE_SIZE: "30Million",
                                           GeneralConstants.COLUMN_CLIENT_ID: str(client_obj.client_id)})
