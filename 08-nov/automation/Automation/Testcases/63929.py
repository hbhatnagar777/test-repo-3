...
class TestCase(CVTestCase):
    """ [Laptop] [AdminConsole][EdgeMode]: Deleted items Download validation as enduser"""
    ...
    def __init__(self):
        ...
        self.name = "[Laptop] [AdminConsole][EdgeMode]: Deleted items Download validation as enduser"
    ...
    def download_deleted_data(self):
        ...
        self.log.info("-- Deleted Folder download started : [{0}] --".format(self.folder_name))
        ...
        self.log.info("Download job id is : [{0}]".format(download_job_id))
