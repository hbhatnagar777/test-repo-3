...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "test_querysetshare_deleteall_positive"
    ...
    def test_querysetshare_deleteall_positive(self):
        """Creates a query set, shares it with 'DELETE' permission, checks if it can be deleted."""
    ...
    def run(self):
        try:
            self.init_tc()
            self.test_querysetshare_deleteall_positive()
