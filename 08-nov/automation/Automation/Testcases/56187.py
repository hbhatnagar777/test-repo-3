...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DM2 - OwnershipTransfer - Verify basic transfer of Open datasource & Handlers"
    ...
    def setup(self):
        ...
        self.user = f"TestUser1_56187_{self.timestamp}"
        self.new_user = f"TestUser2_56187_{self.timestamp}"
        ...
        self.user_helper.create_user(
            user_name=self.user, email=f"test{self.id}_{self.timestamp}_1@test.com", full_name="Test User Created by Dm2 Automation",
            password=self.password, security_dict=self.security_dict)

        self.user_helper.create_user(
            user_name=self.new_user, email=f"test{self.id}_{self.timestamp}_2@test.com", full_name="Test User Created by Dm2 Automation",
            password=self.password, security_dict=self.security_dict)
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Execute the default handler to get data from this datasource")
