...
from NAS.NASUtils.HNASbasicacceptance import HNASBasicAcceptance
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = ("NewAutomation HNAS - V2 - Solaris MA - Basic Acceptance "\
                      "Test of NDMP Streaming Backup and Restore - NDMP iDA")
    ...
    def run(self):
        ...
        try:
            ...
            basic_acceptance = HNASBasicAcceptance(self, is_cluster=False)
