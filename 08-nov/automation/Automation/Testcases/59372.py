...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "AHV Snap/backup copy proxy failover validation with coordinator services down"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                auto_subclient.backup(backup_options, bkpcopy_job_status=True, op_id=3, entity_id=1)
