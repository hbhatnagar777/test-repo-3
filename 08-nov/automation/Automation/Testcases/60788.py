...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Security Page APIs"
    ...
    def setup(self):
        ...
        version = self.commcell.commserv_version
        if int(version) >= 25:
            apiList = "papi_user,papi_userGroup,get_kms,get_kms_details,get_credentials,user_details,usergroup_details,get_role_papi"
        else:
            apiList = "get_users,getusergroup,get_kms,get_kms_details,get_credentials,user_details,getusergroup_details,get_role,get_role_details,get_laptops"
