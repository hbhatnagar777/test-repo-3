...
class TestCase(CVTestCase):
    """Class for executing basic network case to validate different types of tunnel connection
        protocols for outgoing routes with one-way firewall
    ...
    def __init__(self):
        ...
        self.name = ("[Network & Firewall] : Tunnel connection protocol "
                     "validation(HTTPS, HTTPSA and RAW) "
                     "and multistreams with one-way firewall")
        ...
        self._client_group_name = 'CG_53644'
        self.commserv = None
        self._network = None
    ...
    def run(self):
        ...
        try:
            ...
            self._network.serverbase.restart_services([self.tcinputs['FirewallClient1'],
                                                       self.tcinputs['FirewallClient2'],
                                                       self.tcinputs['FirewallClient3']])
