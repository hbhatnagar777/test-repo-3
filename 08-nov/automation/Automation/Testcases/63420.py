...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "MS Teams: Create Client using express configuration"
        self.browser = None
    ...
    def setup(self):
        ...
        self.app_name = dt.now().strftime("TeamsClient_63420_%d%h%Y_%H%M")
        self.office365_obj = Office365Apps(self.admin_console, O365AppTypes.teams)
    ...
    def run(self):
        ...
        try:
            ...
            app_name = self.office365_obj.create_team_cvpysdk_express(self.app_name, plan, global_admin,
                                                                      global_pass, infra_details)
            ...
            if not self.office365_obj.validate_infra(self.app_name, plan, infra_details, global_admin=global_admin):
