...
class TestCase(CVTestCase):
    """Class for executing store workflow Delete V8 Firewall Files from Clients"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = ("WORKFLOW - [Software Store]- Validate Delete "
                     "V8 Firewall Files from Clients workflow")
        ...
        self.workflow = "Delete V8 Firewall Files From Clients"
        self.workflow_id = "Delete V8 Firewall Files from Clients"
        self._workflow = None
        self.tcinputs = {
            "emailId": None
        }
    ...
    def start_step3(self):
        ...
        forms.set_textbox_value("Provide email ID to send report", self.tcinputs["emailId"])
