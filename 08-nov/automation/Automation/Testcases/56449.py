...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Office365- SharePoint Online-Data protection-Full Backup and Restore-General"
    ...
    def setup(self):
        ...
        self.testdata.create_site_structure_for_backup(site_url_list=site_url_list, folder=True,
                                                       list=True, versions=False)
