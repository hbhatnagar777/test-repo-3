...
from Install.installer_constants import UNIX_REMOTE_FILE_COPY_LOC, \
    WINDOWS_FIREWALL_INBOUND_EXCLUSION_LIST,\
    BLOCK_INCOMING_CONNECTION
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "[Install & Firewall] UNIX - Interactive - Client to CS via Proxy"
    ...
    def setup(self):
        ...
        self.dummy_client_name = "test_53625_" + self.time_stamp
    ...
    def set_firewall_prerequisites(self):
        """
        This method does all the firewall setting to be executed for the testcase
        Returns: None
        """
