...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of MySQL Enterprise backup and restore test
    case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test for MySQL Enterprise backup and restore"
    ...
    def tear_down(self):
        ...
        # Disabling MySQL Enterprise Backup functionality on MySQL Instance Property if it was
        # disabled before start of automation
    ...
    def run(self):
        ...
        try:
            if 'windows' in self.client.os_info.lower():
                raise Exception("Kindly provide unix/linux client as input")
            ...
            restore_job = self.mysql_helper.run_meb_restore_flow(
                ...
                from_time=inc_backup_2.start_timestamp,
                to_time=inc_backup_2.end_timestamp,
