...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "OneDrive Content Indexing Basic Testcase"
    ...
    def setup(self):
        ...
        self.log.info("Creating OneDrive app with name: " + self.client_name)
