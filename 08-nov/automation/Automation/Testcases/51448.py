...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of Exchange online Discovery validation"""
    ...
    def __init__(self):
        ...
        self.name = ("Basic acceptance test for Exchange Online User/AD Discovery "
                     "User/AD association Validation")
