...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Performance testcase - SDG backed up FS with CI enabled"
        self.tcinputs = {
    ...
    def run(self):
        ...
        try:
            ...
            self.perf_config = self.perf_helper.form_sdg_fs_monitor_param(
                job_type=JobTypes.FILE_SYSTEM_BACKUP_IMPORT_INDEX,
                index_server=self.index_server_name,
                content_analyzer=self.ca_client_name,
                search_engine=[self.tcinputs['SearchEngineName']]
            )
