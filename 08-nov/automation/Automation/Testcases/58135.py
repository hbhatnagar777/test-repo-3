...
TestCase:
    ...
    brick_replacement() - triggers brick replacement for a node
...
13. Trigger brick replacment
14. check fstab and /ws/ for cvcontext
15. validate whether mount paths are protected after doing some backups
	Performing penetration testing on protected mount paths
	 ( append content, delete content, add file)
16. add denial logs from audit.log to denials_log file.
17. disable protection
