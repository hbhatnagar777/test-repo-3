...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case - IBM XIV Snap"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - IBM XIV Snap- Basic acceptance Test for intellisnap operations"
