...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp OCUM Replication for All
    ...
    def __init__(self):
        ...
        self.name = """Automation: Snapshot Replication: OCUM based replication certification
        with all the protocol types"""

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "all"
