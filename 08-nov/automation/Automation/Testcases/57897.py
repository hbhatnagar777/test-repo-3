...
APIs being validated inside collection file:
    ...
    POST Deploying a Workflow
    POST Executing a Workflow as a Job
    GET Executing a Workflow as an API
    POST Executing a Workflow as an API
    POST Executing a Workflow as a Job with JSON
    DELETE Workflow
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "REST API - Workflow Operation with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'WorkflowOperationsEndpoints.collection.json'
