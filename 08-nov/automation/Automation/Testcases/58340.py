...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """Login for User's [commcell user, AD user, LDAP user] with key 
        DefaultADUserDomain and DefaultCSDomain"""
    ...
    def run(self):
        ...
        try:
            ...
            validator.validate(feature='domain_less_login', default_ad_user_domain="security",
                               default_cs_domain="commcell")
