...
class TestCase(parent_test_case_module.TestCase):
    """HS Automation: 3x: Offline platform upgrade using metadata.tar from cloud.commvault.com
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.id = "71093"
        self.name = "HS Automation: 3x: Offline platform upgrade using metadata.tar from cloud.commvault.com"
