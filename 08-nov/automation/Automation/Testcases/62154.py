...
6: Pick jobs for DV and Initiate Non-Scalable DV for each of Storage Policies
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = 'Marking Referenced Chunks Bad by Non-Scalable DV for DiskLibraries'
        self.tcinputs = {
            "MediaAgentName": None
        }
        self.utility = None
    ...
    def run_verification_jobs(self):
        ...
        self.log.info('Running the Verification Jobs: Non-Scaleble DVs')
        log_line = ''
        for index in range(8):
