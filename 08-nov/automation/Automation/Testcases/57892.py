...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Storage Pool operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Storage Pool Operations with JSON"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "libraryName": self.tcinputs["libraryName"]
                       }
    ...
    def run(self):
        ...
        try:
            collection_json = 'StoragePoolOperations.collection.json'
