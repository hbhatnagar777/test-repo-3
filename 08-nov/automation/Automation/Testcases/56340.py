...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Attach disk restore to Existing instance from a snap copy in tenant account"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Attach disk restore to existing instance from a snap copy in tenant account"
    ...
    def setup(self):
        ...
        vsa_obj_inputs = {
            ...
            'existing_instance': self.tcinputs['existing_instance'],
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.backup()
            decorative_log("Restoring the snap copy to the Existing Instance in tenant account")
            self.vsa_obj.attach_disk_restore('Other instance', False)
