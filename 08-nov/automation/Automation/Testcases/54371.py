...
class TestCase(CVTestCase):
    """Class for executing
        IBMi pre-defined subclient "*ALLUSR" backup and restore with optimized scan
        Step1, configure BackupSet and Subclients for TC
        Step2: On client, create a library AUT54371 with objects
        ...
        Step5: On client, Create another library AUT543711 with objects.
    ...
    def __init__(self):
        ...
        self.name = "IBMi - Optimized scan: Backup of pre-defined subclient: *ALLUSR"
    ...
    def run(self):
        ...
        try:
            ...
            self.helper.configure_ibmi_default_sc(backupset_name="backupset_{0}".format(self.id),
                                                  ...
                                                  delete=False)
            sc_options = {'savact': '*LIB', 'savactwait': 0}
