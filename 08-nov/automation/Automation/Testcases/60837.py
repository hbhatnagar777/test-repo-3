...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Alerts APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_alerts,get_alert_details,get_alert_definitions,get_alert_definitionDetail",
