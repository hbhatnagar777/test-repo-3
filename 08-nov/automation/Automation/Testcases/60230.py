...
APIs being validated inside collection file:
    ...
    PUT /v4/ServerGroup/{serverGroupId}/Restore/Action/Disable
    ...
    PUT /v4/ServerGroup​/{serverGroupId}​/Backup​/Action​/Enable
    PUT /v4/ServerGroup/{serverGroupId}/DataAging/Action/Enable
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI Server Group"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified ServerGroup APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPIServerGroup.collection.json'
