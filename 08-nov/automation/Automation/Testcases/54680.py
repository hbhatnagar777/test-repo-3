...
class TestCase(CVTestCase):
    """Class for unplanned fail over validation"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "OCI Unplanned Failover and Failback"
    ...
    def run(self):
        ...
        try:
            self.log.info("Performing Unplanned Failover Validation")
            self.vsa_obj.validate_unplanned_failover(self.replication_group)
