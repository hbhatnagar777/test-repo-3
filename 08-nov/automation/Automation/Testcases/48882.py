...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Security - Schedule Admin User Operations"
        ...
        self._role1 = 'Automation_role1_48882'
        self._role2 = 'Automation_role2_48882'
        self._permission_list1 = ['Agent Scheduling', 'Data Protection Operations',
                                  'In Place Recover']
        self._permission_list2 = ['Create Schedule Policy']
    ...
    def setup(self):
        ...
        user1 = UserProperties(name='TestUser_48882', cs_host=self.commcell.commserv_hostname,
    ...
    def run(self):
        ...
        self.log.info("This test verifies that a Schedule Admin can perform only Scheduling "
                      "Operations on a particular entity.")
        try:
            ...
            for user in self._user_list:
                ...
                self._user_helper.create_user(user_name=user.username,
                                              password=user.password, email='test48882@test.com',
                ...
                self._server_tc.log_step(
                    """step 2: Analysing security associations and fetching valid and invalid
                     operations for user""")
                operations = self._operations_helper.fetch_operations_for_user(username=
                                                                               user.username)
                self._server_tc.log_step(
            ...
            if self.count:
                self.log.info("Testcse Execution FAILED!!!")
