...
Inputs:
    ...
    SnapEngine          --      snap engine to set at    
                                values: Dell EMC VPLEX Snap
                                        Dell EMC VPlEX Clone
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Dell EMC Vplex-3par"
        self.snapengine_list = ['Dell EMC VPLEX Snap',
                                'Dell EMC VPLEX Clone'] 
        self.browser = None
