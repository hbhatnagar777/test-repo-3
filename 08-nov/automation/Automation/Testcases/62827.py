...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Metallic Archiving: acceptance test for analyze then archive"
        self.contentgroupname = "auto_archive_tc62827"
        self.archiving_auto_plan = "auto_plan_tc62827"
