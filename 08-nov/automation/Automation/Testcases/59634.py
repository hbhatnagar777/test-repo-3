                ...
                "59634":
                        {
                          ...
                          "DestinationInstance": "instance",(optional, default: "blbclone")
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Oracle IDA Command Center - Instant clone from block level backup"
        self.browser = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_59634'
        ...
        self.destination_instance_name = self.tcinputs.get("DestinationInstance") or "blbclone"
    ...
    def run_instant_clone(self):
        ...
        instant_clone_panel = self.database_instances.instant_clone(
            database_type=self.database_type, source_server=self.tcinputs['ClientName'],
