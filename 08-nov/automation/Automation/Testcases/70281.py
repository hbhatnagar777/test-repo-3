...
TestCase:
    ...
    core_validation()                            -- Verifies that threat scan core is created
...
class TestCase(CVTestCase):
    """Class for executing threat scan core validation"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Threat scan core validation"
        self.tcinputs = {
    ...
    def core_validation(self):
        """
        Verifies that the threat scan core is created
        """
        ...
        self.log.info(
            f"Core present for client {self.client_obj.client_id} is {core_status[1]}")
