...
APIs being validated inside collection file:
    ...
    GET /OperationWindow/OpWindowList?clientId=2
    PUT /OperationWindow
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Operation window operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Operation window Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'OperationWindow.collection.json'
