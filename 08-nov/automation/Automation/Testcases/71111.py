...
"""Test Case for 2x: Platform upgrade post add node
...
class TestCase(parent_test_case_module.TestCase):
    """Test Case for 3x: Platform upgrade post add node
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.id = "71111"
        self.name = "Test Case for 3x: Platform upgrade post add node"
