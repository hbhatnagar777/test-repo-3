...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA Azure VMGroups CRUD case"
    ...
    def run(self):
        try:
            ...
            self.vmgroup_obj.add_vm_group(vm_group_name=self.vm_group_name,
                                          ...
                                          vendor=hypervisor_type.MICROSOFT_AZURE.value)
            ...
            self.admin_console.navigator.navigate_to_vm_groups()
            self.vmgroup_obj.set_vm_group_content(vendor=hypervisor_type.MICROSOFT_AZURE.value,
