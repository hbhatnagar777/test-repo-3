...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to all AD users, by logging in as Administrator and installing and
    activating using always activate flag, such that all logged-in AD users should become the laptop owners"""

    test_step = TestStep()

    def __init__(self):
        super(TestCase, self).__init__()
        self.name = "[Laptop] [Admin Console]: Test for setting automatic owner assignment to all AD users, by logging\
        in as Administrator and installing and activating using always activate flag, such that all logged-in AD users\
        should become the laptop owners"
        self.browser = None
