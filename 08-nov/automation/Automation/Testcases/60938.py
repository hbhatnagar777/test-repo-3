...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP Backup and restore: vserver with tunneling - V1 windows MA"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Basic acceptance of NDMP Intellisnap Backup & Restore for vserver with tunneling"
