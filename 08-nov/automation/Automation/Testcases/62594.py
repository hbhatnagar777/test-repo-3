...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Vmware Full Snap backup and Guest File Restore test case
    """

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Snap Automation:VSA VMWARE Snap Backup and restore cases for metro configured " \
                    "DS using : {0} engine"
    ...
    def run(self):
        ...
        try:
            ...
            return_values = vsa_snap_templates.vsasnap_template_metro_backup()
