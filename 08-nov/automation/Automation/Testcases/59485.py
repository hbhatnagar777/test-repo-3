...
class TestCase(CVTestCase):
    """Class for executing the test case of Office365- SharePoint Online- Incremental Backup - Advance
    """
    ...
    def __init__(self):
        ...
        self.name = "Office365- SharePoint Online- Incremental Backup - Advance"
