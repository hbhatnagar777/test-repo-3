...
APIs being validated inside collection file:
    POST /logmonitoring/Policy/Operations
    GET /AnalyticsServers
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Log Monitoring operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Negative Test cases for Log Monitoring"
    ...
    def run(self):
        ...
        try:
            collection_json = 'LogMonitoringOperations.collection.json'
