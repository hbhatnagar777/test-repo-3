...
TestCase:
    ...
    DestinationClient : A client computer other than commserve
"""
...
class TestCase(CVTestCase):
    """Command Center- Network topology- OneWay CS->CC(laptop)"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Command Center- Network topology- OneWay CS->CC(laptop)"
        self.browser = None
        self.topology_name = "CG_60334_OW_CS_CC"
        self.admin_console = None
        self.navigator = None
        self._client_group_name1 = "CG_60334_CS"
        self._client_group_name2 = "CG_60334_Client"
        self.tcinputs = {
            "DestinationClient": ""
        }
