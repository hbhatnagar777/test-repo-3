...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] Performance testing for Search APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_searchEntity,get_basicSearch,get_searchDetails,"
                                  "get_multicommcellsearch,get_multicommcell",
