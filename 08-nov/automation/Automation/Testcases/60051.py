...
TestCase:
    ...
    redirect_to_admin_console_fom_hub() --  Redirects to Admin Console from Metallic Hub
...
class TestCase(CVTestCase):
    """ Class for executing Basic acceptance Test for oracle on metallic """
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "ACCT1-Acceptance Test for Oracle iDA from Metallic Command Center"
        self.browser = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_60051'
    ...
    def initial_setup(self):
        ...
        self.oracle_metallic_configuration.do_pkg_install(pkg_file_path=pkg_file_path, install_inputs=install_inputs,
    ...
    def redirect_to_admin_console_fom_hub(self):
        ...
        self.oracle_metallic_configuration.redirect_to_admin_console()
    ...
    def create_helper_object(self):
        ...
        self.client = self.commcell.clients.get(self.tcinputs["HostName"])
    ...
    def active_jobs_action(self, action="kill"):
        ...
        """
        self.commcell.refresh()
        display_name = self.tcinputs["HostName"]
        for client in self.commcell.clients.all_clients:
            if client.startswith(self.tcinputs["HostName"]):
                display_name = client
                break
