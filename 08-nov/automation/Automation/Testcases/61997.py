...
class TestCase(CVTestCase):
    """
    Testcase to create Kubernetes Cluster, perform backup and restore and validate CV Resources cleanup.
    ...
    def __init__(self):
        ...
        self.name = "Kubernetes Cleanup Validation For Successful Backup And Restore"
    ...
    def run(self):
        ...
        try:
            ...
            VirtualServerUtils.decorative_log("Step 2 -- Run Restore and validate cleanup")
            ...
            VirtualServerUtils.decorative_log(
                "Step 5 -- Verify INC job followed by Full Application Out of place Restore"
            )
