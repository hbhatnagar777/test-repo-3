...
class TestCase(CVTestCase):
    """Class for executing
        IBMi- Validation of IFS wildcard exception content
    ...
    def __init__(self):
        ...
        self.name = "IBMi- Validation of IFS wildcard exception content."
    ...
    def configure_sc(self):
        ...
        self.helper.create_subclient(name=self.subclient_name,
                                     ...
                                     exception_content=self.exception,
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("*** STARTING VALIDATION OF WILDCARD EXCEPTIONS WITH IFS ***")
            self.generate_data()
            self.configure_sc()
            self.job = self.helper.run_backup(backup_level="Full")[0]
            self.restore_verify()
            self.cleanup()
            self.log.info("**IBMi: VALIDATION OF USING WILDCARD EXCEPTION CONTENT FOR IFS HAS COMPLETED SUCCESSFULLY**")
