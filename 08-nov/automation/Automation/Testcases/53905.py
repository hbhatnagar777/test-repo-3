...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Azurestack  backup and Restore test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA Azurestack INCREMENTAL Snap Backup and Restore Cases using Unix MA"
