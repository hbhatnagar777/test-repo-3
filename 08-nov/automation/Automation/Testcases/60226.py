...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI File Server"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified File Server APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPIFileServers.collection.json'
