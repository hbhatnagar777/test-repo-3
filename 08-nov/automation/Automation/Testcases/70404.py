...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Amazon Backup & OOP Full VM Restore by editing the Volume Type,
    IOPS, Throughput, Encryption"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = ("AMAZON : V2: Full backup and OOP Full VM Restore by editing the Volume Type, IOPS, Throughput, "
                     "Encryption")
        self.browser = None
        self.vsa_obj = None
    ...
    def setup(self):
        ...
        self.vsa_obj = AmazonAdminConsole(self.instance, self.browser,
    ...
    def run(self):
        ...
        try:
            ...
            try:
                self.vsa_obj.volumeEdit = self.tcinputs['volumeEdit']
                self.vsa_obj.iops = self.tcinputs['iops']
                self.vsa_obj.throughput = self.tcinputs['throughput']
