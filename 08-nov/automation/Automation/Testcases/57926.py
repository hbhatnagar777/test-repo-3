...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Test case for Replacing Brick, changing Storage Pool name"
        self.result_string = ""
        self.policy = ""
        self.policy_name = ""
        self.subclient_obj = ""
    ...
    def setup(self):
        ...
        self.new_storage_pool_name = "rename_" + self.storage_pool_name
    ...
    def run(self):
        ...
        """
        try:
            self.log.info("*************Replacing Brick, changing Storage Pool name **************")
            status_fstab = False
            ...
            replaced_gluster_brick = self.hyperscale_helper.check_gluster_brick_online(self.node, self.storage_pool_name,
                                                                                       self.new_device_os_path)
