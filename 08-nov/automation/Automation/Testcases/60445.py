...
class TestCase(CVTestCase):
    """ Command center: Validate Archive and restore functionality for Lustre client from command center """
    test_step = TestStep()

    def __init__(self):
        """ Initializing the reference variables """
        super(TestCase, self).__init__()
        self.name = "Testcase to Validate Archive and restore functionality for Lustre client from command center"
        self.browser = None
    ...
    def add_server(self):
        ...
        self.archiving.add_distributed_app(pkg=DistributedClusterPkgName.LUSTREFS, server_name=self.hostname,
