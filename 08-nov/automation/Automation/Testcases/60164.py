...
TestCase:
    ...
    review_ignorerisks_action_filesystem()       -- Verifies that a file's risk is getting ignored in the review page
...
class TestCase(CVTestCase):
    """Class for executing ignore risks action for a single file with local path in Review page in SDG"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Ignore risks action for a single file with local path in Review page in SDG"
        self.tcinputs = {
    ...
    def review_ignorerisks_action_filesystem(self):
        """
        Verifies that a file's risk is getting ignored in the review page
        """
        try:
