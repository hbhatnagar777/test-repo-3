...
class TestCase(CVTestCase):
    """Class for executing Acceptance test case for Add/Edit/Delete Array in the Array Management for
        HPE 3PAR StoreSev Intellisnap from Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Add/Edit/Delete Array in the array management for HPE 3PAR StoreSev Intellisnap test case from Command center"
    ...
    def setup(self):
        """Initializes pre-requisites for Acceptance test case for Add/Edit/Delete Array in the Array Management for
        HPE 3PAR StoreSev Intellisnap from Command Center """  
    ...
    def tear_down(self):
        """Tear down function to perform cleanup operations for Acceptance test case for Add/Edit/Delete Array in the Array Management for
        HPE 3PAR StoreSev Intellisnap from Command Center"""
        try:
