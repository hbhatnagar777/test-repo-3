...
Inputs:
            ...
            ndmpUser                --      NDMP Username
            
            ndmpPassword            --      NDMP Password
            
            CredentialManager       --      Use saved credentials True or False
            
            CredentialManagerName   --      Saved credential name to be used
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "NewAutomation Command center - Using NDMP Credential Manager"
        self.browser = None
