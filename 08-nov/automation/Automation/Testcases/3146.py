...
class TestCase(CVTestCase):
    """Class for executing Incremental SP - Restore - From Full and Incremental storage policy"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "Incremental SP - Restore - From Full and Incremental storage policy"
        self.tcinputs = {
