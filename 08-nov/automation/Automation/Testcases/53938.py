...
APIs being validated inside collection file:
    ...
    GET /CommCell/Credentials?propertyLevel=30
    GET /CommCell/Credentials/{{credentialName}}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Credentials Manager Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - JSON - Credentials Manager Operations"
    ...
    def run(self):
        ...
        try:
            collection_json = 'CredentialsManagerOperations.collection.json'
