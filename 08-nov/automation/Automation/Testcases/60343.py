...
class TestCase(CVTestCase):
    """ Class for executing test case for Custom Alert to notify when Restore job in pending state exceeds threshold"""

    # Constructor for the testcase
    def __init__(self):
        """Initializes the testcase object"""
        super(TestCase, self).__init__()
        self.name = 'Testcase to for Custom Alert to notify when Restore job in pending state exceeds threshold'
        self.cache = None
        self.rule_name = "Restorejobinpendingstateexceedsthreshold.xml"
        # Some custom alerts require additional query info to be injected into the alert XML
        self.custom_query_details = ''
        self.pending_state_threshold = 1  # Job Pending State Threshold in minutes
        self.wait = 200
        tcinputs = {
          "AgentName":None,
          "BackupsetName":None,
    ...
    def populate_custom_query_details(self, query_id, pending_state_threshold):
        """Populates the custom query xml which is required by some custom alerts"""
        self.custom_query_details = f'''&lt;?xml version='1.0' encoding='UTF-8'?&gt;&lt;CVGui_CustomQueryDetailsForAlert queryId=&quot;{query_id}&quot; additionalQueryInfo=&quot;&amp;lt;?xml version='1.0' encoding='UTF-8'?&gt;&amp;lt;CVGui_QueryAdditionalInfo&gt;&amp;lt;queryParameters&gt;&amp;lt;queryParameters paramName=&amp;quot;JobPendingStateThreshold&amp;quot; value=&amp;quot;&amp;amp;lt;JobPendingStateThreshold&gt;{pending_state_threshold}&amp;amp;lt;/JobPendingStateThreshold&gt;&amp;quot; /&gt;&amp;lt;/queryParameters&gt;&amp;lt;/CVGui_QueryAdditionalInfo&gt;&quot; /&gt;'''
    ...
    def run(self):
        ...
        try:
            ...
            self.populate_custom_query_details(query_id=query_id,
                                               pending_state_threshold=self.pending_state_threshold)

            # Get Custom alert details
            custom_alert_details = alert_helper.get_custom_alert_xml(name='RestoreJobPendingState',
                                                                     notif_type=['Email'],
                                                                     query_id=query_id,
            ...
            alert_helper.alert_situations.restore_job_pending_state_threshold(client=self.client, subclient=subclient_obj)
