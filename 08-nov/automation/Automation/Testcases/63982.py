...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Metallic - Azure PostgreSQL using Non AD Authentication
    Example:
        "63088": {
          "Region": "azure region",
          "StorageAccountName": "",
    ...
    def __init__(self):
        ...
        self.name = "Metallic - ACC1 for Azure PostgreSQL using Non AD Authentication"
        self.browser = None
    ...
    def generate_test_data(self):
        ...
        db_prefix = "metallic_auto_dump_63982"
