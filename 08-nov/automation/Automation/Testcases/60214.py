...
class TestCase(CVTestCase):
    """Test for setting automatic owner assignment to the first user to login by logging in as domain user 1 and using
    authcode to activate, and then logging in as domain user 2 and restarting the services, so that only domain user 1
    should become the owner of the laptop"""
    ...
    def __init__(self):
        ...
        by logging in as domain user 1 and using authcode to activate, and then logging in as domain user 2 and\
        restarting the services, so that only domain user 1 should become the owner of the laptop"
        self.browser = None
    ...
    @test_step
    def install_and_activate_with_authcode(self):
        """
    ...
    def login_with_user_2_and_restart(self):
        ...
        self.tcinputs["Skip_RDP_Users"] = [self.tcinputs["Activation_User"], self.tcinputs["Activation_User3"]]
    ...
    def run(self):
        ...
        try:
            ...
            self.install_and_activate_with_authcode()
