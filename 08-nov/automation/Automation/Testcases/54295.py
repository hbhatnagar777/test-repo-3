...
class TestCase(CVTestCase):
    """Class for executing NetApp 7 mode - Basic acceptance Test of IntelliSnap backup and \
        Restore test case"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "NetApp 7 mode - V2 subclient level index - Windows MA - Basic Acceptance Test of IntelliSnap \
            Backup and Restore"
