...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Vmware Synthetic Snap backup and File level restore"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA Synthetic Full Snap Backup and and backup copy with metadata" \
