...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of Amazon VPC backup and restore of entities in cross region."""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "AMAZON  : Amazon VPC backup and restore of entities in cross account"
        self.browser = None
        self.vsa_obj = None
