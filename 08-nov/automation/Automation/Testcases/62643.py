...
Input Example:
    "testCases":{
        ...
        "des_server":  "<Destination server>" (optional, uses an access node if not specified),
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "GitHub IDA - Verify Job Restartability For Restore To Disk TC"
        self.browser = None
    ...
    def restore_and_validate_data(self):
        ...
        dest_path = self.tcinputs.get("des_path") or self.githelper.restore_path
        rest.restore_to_disk(
            des_server=self.githelper.client_machine.machine_name, des_path=dest_path)
        ...
        self.githelper.validate_test_data(self.git_data, bkp_path, disk_path=dest_path,
    ...
    def run(self):
        ...
        try:
            ...
            if "des_path" in self.tcinputs:
                self.githelper.client_machine.remove_directory(self.tcinputs["des_path"])
