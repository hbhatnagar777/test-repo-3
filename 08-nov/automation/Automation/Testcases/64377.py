...
class TestCase(CVTestCase):
    """
    Class for executing test case for Metallic GuardRail - AWS cloud vm interactive install & backup using aws
    ...
    def __init__(self):
        ...
        self.name = "Metallic GuardRail - AWS cloud vm interactive install & backup using aws gateway and S3 storage"
        self.browser = None
        self.fs_obj = None
    ...
    def set_installinputs(self, isClient=True):
        ...
        try:
            ...
            elif len(self.tcinputs.get("EC2PrivateIP")) != 0:
                inputs["remote_clientname"] = self.tcinputs.get("EC2PrivateIP")
            else:
                inputs["remote_clientname"] = self.tcinputs.get("EC2FQDN")
