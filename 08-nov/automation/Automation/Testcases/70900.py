...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "N Level Reseller - Companies - deactivate_company and Delete company"
    ...
    def run(self):
        ...
        try:
            ...
            if self.using_existing_client:
                self.client.change_company_for_client('Commcell' if self.tcinputs.get('reseller_level', 0) == 0 else self.reseller_company_info['company_name'])
