...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Automation- SMB restore enabling metadata option for V1"
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                auto_subclient.agentless_file_restore(
                    file_restore_options, Indextype = self.tcinputs.get('Indextype'))
