...
class TestCase(CVTestCase):
    """Class for executing VM disk filtering test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "v2: VSA VMWARE Disk filtering from streaming backup"
    ...
    def run(self):
        ...
        try:
            ...
            if not auto_subclient.auto_vsaclient.isIndexingV2:
                ...
                self.failure_message = 'This testcase is for indexing v2. The client passed is indexing v1'
            ...
            try:
                ...
                auto_subclient.post_restore_clean_up(vm_restore_options, status=self.self.status_ind)
            except Exception:
