...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Verify Fresh installation of CA package on Linux machine and validate custom entity & NER" \
                    " on open datasource"
        self.tcinputs = {
    ...
    def setup(self):
        ...
        try:
            ...
            self.datasource_name = "FreshCAClient_56545_" + str(self.timestamp)
