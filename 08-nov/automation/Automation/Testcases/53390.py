...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of VSA Google cloud backup and
    Restore [to project where one vm is] test case"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA Google cloud Incremental Backup and Restore [to a project with one source vm] Cases"
