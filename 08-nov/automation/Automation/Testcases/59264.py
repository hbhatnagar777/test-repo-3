...
APIs being validated inside collection file:
    ...
    GET Entity Details via Search Operations
    GET Basic Serach Details
    GET Commcell Redirect via Multicommcell Operations
    GET Search with Detailed Property via Search Operations
    GET Multicommcell search via Search Operations
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Search operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Search Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'SearchOperations.collection.json'
