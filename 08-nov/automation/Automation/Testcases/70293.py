...
from Web.AdminConsole.GlobalConfigManager.Helper.gcm_role_helper import GCMRolesHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "	[GCM][UI]: Create Roles from cloud console and validate propagation to service commcells"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            gcm_helper_obj = GCMRolesHelper(self.admin_console, self.commcell, self.csdb)
