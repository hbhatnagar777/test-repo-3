...
class TestCase(CVTestCase):
    """Class for verifying Basic NDMP backup and restore operation for Oracle ZFS Storage client"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Oracle ZFS Storage - NDMP iDA - Basic Acceptance NDMP backup and restore"
        self.tcinputs = {
            "HostName": None,
            "Agent": None,
            "NDMPUserName": None,
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Run Inc backup job for NDMP iDA")
            ...
            self.log.info("Run Diff backup job for NDMP iDA")
            job = self.subclient.backup(backup_level='Differential')
