...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA Nutanix AHV container filter testcase"
    ...
    def run(self):
        ...
        try:
            ...
            if VirtualServerConstants.JM_Failure_Reason['DiskFilter'] not in res[3]['description']:
                self.log.error(
