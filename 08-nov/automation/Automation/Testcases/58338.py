...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = """User's [commcell user, AD user, AD as Generic LDAP user, Redhat as Generic LDAP user, openldap
         user, oracle directory user] login with username from [adminconsole, webconsole, Rest api, qlogin]"""
