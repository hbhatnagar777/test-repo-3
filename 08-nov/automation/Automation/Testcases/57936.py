...
TestCase:
    ...
    "testCases": {
				...
				"57936": {
					...
					"CloudMA1": "saikatpower2",
					"CloudMA2": "saikatpower1",
					"CloudMA3": "idcpower1",
					"MA1":"ssrup1",
					"PsudoClientName": "NewAzure",
					"VSAProxyForPsudoClient":"ssrv11console",
					"AzureSubsID":"****",
					"AzureTenantID":"****",
					"AzureAppID":"****",
					"AzureAppPassword":"****"
...
class TestCase(CVTestCase):
    """Power Management Aux Copy :: Primary Copy-Cloud and Aux Copy-non-cloud and DDB1-cloud and DDB2-Cloud"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Power Management Aux Copy :: Primary Copy-Cloud and Aux Copy-non-cloud and DDB1-cloud and DDB2-Cloud"
    ...
    def setup(self):
        ...
        self.ddb_ma1 = self.tcinputs['CloudMA2']
        self.ddb_ma2 = self.tcinputs['CloudMA3']
        ...
        self.power_management.configure_cloud_mediaagent(self.tcinputs['PsudoClientName'], self.source_ma_obj)
    ...
    def power_off_all_cloud_mediaagents(self):
        ...
        """
        self.power_management.power_off_media_agents([self.source_ma_obj, self.ddb_ma1_obj, self.ddb_ma2_obj])

    def power_on_all_cloud_mediaagents(self):
        """
        Power-on all cloud MediaAgents
        """
        self.power_management.power_on_media_agents([self.source_ma_obj, self.ddb_ma1_obj, self.ddb_ma2_obj])
    ...
    def verify_non_cloud_media_agents(self):
        ...
        if self.destination_ma_obj._is_power_management_enabled:
    ...
    def run(self):
        try:
            ...
            self.power_management.validate_powermgmtjobtovmmap_table(self.job_obj.job_id,
                                                                     self.source_ma_obj._media_agent_id, self.csdb)
            self.power_management.validate_powermgmtjobtovmmap_table(self.job_obj.job_id,
                                                                     self.ddb_ma1_obj._media_agent_id, self.csdb)
            self.power_management.validate_powermgmtjobtovmmap_table(self.job_obj.job_id,
                                                                     self.ddb_ma2_obj._media_agent_id, self.csdb)
            self.verify_mediaagents_are_on([self.source_ma_obj, self.ddb_ma1_obj, self.ddb_ma2_obj])
