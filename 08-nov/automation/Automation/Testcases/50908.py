...
class TestCase(CVTestCase):
    """ Custom Package Installation of additional packages on already existing instance"""
    ...
    def __init__(self):
        ...
        self.name = "Custom Package Installation of additional packages on already existing instance"
    ...
    def run(self):
        ...
        try:
            ...
            # Installing the Base Media Instance
            self.log.info("Generating JSON for base media creation")
            ...
            self.log.info("Installing the Base Media")
            self.custom_package_generator.create_custom_package()

            # Creating the Custom Package for additional packages on the same Instance
            self.log.info("Generating JSON for additional custom package creation on existing instance")
            self.custom_package_generator.generate_json_for_custom_package(
                **{"CustomPackageDir": self.id,
                   ...
                   "installOption": "Add Packages"
                   })
            self.custom_package_generator.create_custom_package()

            # Installing the Custom Package for additional packages on same Instance
            self.log.info("Generating JSON for additional custom package installation on existing instance")
            self.custom_package_generator.generate_json_for_custom_package(
