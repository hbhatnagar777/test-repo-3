...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] Performance testing for VMs page of Protect V4 APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_papi_virtualmachines,get_vm_details,get_subclient_details,get_vmallocationpolicy,get_permission_details,get_jobs_calendar",
