...
This test case verifies alert rule "Backup for Subclients failed consecutively for X attempts"
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Web automation for Backup for Subclients failed consecutively for X attempts alert"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            ...
            self.alert_definitions.create_alert_definition({
                ...
                "template":{
                    "email":
                    {
                        ...
                        "content":"<ALERT CATEGORY - ALERT TYPE>| <DETECTED CRITERIA>| <JOB ID>| <CLIENT DISPLAY NAME>| <SUBCLIENT NAME>| <FAILURE REASON> |<FAILED COUNT>"
                    },
                    "console":
                    {
                        "content":"<ALERT CATEGORY - ALERT TYPE>| <DETECTED CRITERIA>| <JOB ID>| <CLIENT DISPLAY NAME>| <SUBCLIENT NAME>| <FAILURE REASON> |<FAILED COUNT>"
            ...
            alert_notif_text = self.alert_helper.get_alert_notification_text("Test Custom Alert").split('|')
            
            self.alert_helper.validate_console_notification("Test Custom Alert", text_to_verify)
            
            # 4.b) Validate the alert email
            self.log.info("Validating the alert email")
