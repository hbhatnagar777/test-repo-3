...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[CC Acceptance] roles: CRUD operations on roles page"
    ...
    def setup(self):
        ...
        self.sdk_roles_helper = RoleHelper(self.commcell)
    ...
    def tear_down(self):
        ...
        self.sdk_roles_helper.cleanup_roles('del automated')
