...
from dynamicindex.utils.constants import USA_COUNTRY_NAME, CLIENT_NAME, TREE_SIZE_DASHBOARD
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Validate CSV export of File Security dashboard -> All Data"
        self.tcinputs = {
    ...
    def download_csv(self):
        ...
        self.fso_helper.navigate_to_datasource_details(self.tcinputs['HostNameToAnalyze'],
                                                       self.file_server_display_name)
        self.fso_helper.fso_data_source_discover.select_fso_dashboard(self.admin_console.props['reports.fileSecurity'])
        self.fso_helper.fso_data_source_discover.download_csv_treesize_dashboard()
    ...
    def run(self):
        try:
            ...
            attributes = {"Size", "Url", "DocumentType", "AllowWriteUsername", "AllowModifyUsername",
                          "AllowFullControlUsername", "OwnerName", "AllowListUsername"}
