...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance Test of NDMP Intellisnap 
	   Backup and Restore for Celerra VDM test case using Unix MA"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = ("DELL EMC VNX/ CELERRA - VDM - V2 - Unix MA -Basic Acceptance Test of "
    ...
    def run(self):
        ...
        try:
            ...
            basic_acceptance = Unity_VNX_SnapBasicAcceptance(self, is_vdm=True)
