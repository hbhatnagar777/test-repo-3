...
class TestCase(CVTestCase):
    """ Class for executing Basic acceptance Test for oracle Block level"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Block Level ACCT1-Acceptance Test for Oracle iDA from Command Center"
        self.browser = None
        self.browse = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_59633'
    ...
    def enable_snapshot(self):
        """Method enables volume copy for the subclient"""
        self.navigate_to_instance()
        self.db_instance_details.click_on_entity('default')
        ...
        self.subclient_page.enable_snapshot(
            ...
            backup_copy_interface="Volume copy")
