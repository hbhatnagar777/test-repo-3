...
class TestCase(CVTestCase):
    """SDG basic acceptance test for Azure Cloud App"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "SDG basic acceptance test for Azure Cloud App"
    ...
    def create_credential(self):
        ...
        self.credential_manager.add_credential(
            ...
            authentication_type=cs.CLOUD_APP_AUTH_TYPES[self.cloud_app_type][0])
    ...
    def verify_data_source(self):
        ...
        """
        meta_data = self.azure_helper.fetch_file_metadata(
