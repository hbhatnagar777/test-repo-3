...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Multicommcell - Token validation cases"
    ...
    def run(self):
        ...
        try:
            ...
            self._log.info("\tVerifying token validity")
            self.multicommcell_helper.token_validity_check(
                self.idp_user_commcell,
                self.sp_user_commcell,
                validity_mins=2
            )

            self._log.info("\tVerifying token's tampered time validity")
            self.multicommcell_helper.tampered_validity_check(
                self.idp_user_commcell,
                self.sp_user_commcell,
                validity_mins=2
            )
