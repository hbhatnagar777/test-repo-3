...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VMware Full Backup and Backup validation from Snap / Backup Copy"
    ...
    def run(self):
        ...
        try:
            ...
            # Backup validation from backup copy
            backup_validation_options['recovery_target'] = self.tcinputs["recovery_target"]
            backup_validation_options['snap_copy'] = False
            self.vsa_obj.setup_backup_validation(backup_validation_options)
            self.vsa_obj.run_validate_backup_vmgroup(backup_validation_options)
