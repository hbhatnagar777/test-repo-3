...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance for NDMP Advanced NAS Restore option DAR on/off - Dell EMC Celerra/VNX"""

    def __init__(self):
        """"Initializes TestCase object"""
        super(TestCase, self).__init__()
        self.name = "NDMP Advanced NAS Restore option DAR on/off - Dell EMC Celerra/VNX"
        self.tcinputs = {
