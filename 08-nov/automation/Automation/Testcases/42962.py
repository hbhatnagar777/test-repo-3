...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "VSA Hyper-V DIFFERENTIAL Backup and Restore Cases without Metadata"
    ...
    def run(self):
        ...
        try:
            ...
            backup_options.collect_metadata = False
            ...
            try:
                ...
                VirtualServerUtils.set_inputs(self.tcinputs, disk_restore_options)
