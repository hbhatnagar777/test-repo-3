...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case - Vplex XtremIO snap"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Vplex XtremIO snap - Basic acceptance Test for intellisnap operations-Simple volume"
