...
class TestCase(CVTestCase):
    """Testcase: Universal Installer: Use authcode to install a windows client to master CS company"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Use authcode to install a windows client to master CS company"
