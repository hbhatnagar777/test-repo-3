...
TestCase:
    ...
    "58661":
    {
        ...
        "HostName":"#####",
        "OSType":"Windows",
        "BackupPlan":["Server Plan 1"],
        "JobResultsDirectory":"G:\\",
        "Nodes"	:["ClusterCL1", "ClusterCL2"],
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Create a New Windows Cluster Client"
        self.browser = None
    ...
    @test_step
    def add_cluster_client(self):
        """ Adding cluster client """
        self.navigator_obj.navigate_to_servers()
        self.helper.add_clusterclient(
            self.tcinputs['ClusterName'],
            self.tcinputs['HostName'],
            self.tcinputs['OSType'],
            self.tcinputs['BackupPlan'],
            self.tcinputs['JobResultsDirectory'],
            self.tcinputs['Nodes'],
            self.tcinputs['Agents']
        )
    ...
    def validate_cluster_properties(self, properties):
        ...
        if agents and job_dir and nodes:
