...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Oracle table level out of place restore with cv created aux from command center"
        self.browser = None
        self.browse = None
    ...
    def run_table_level_restore(self, table_option):
        ...
        self.job_id = self.restore_panel.out_of_place_restore(
            ...
            recover_to='Most recent backup', table_options=table_option, staging_path=self.tcinputs['Staging_path']
        )
