...
APIs being validated inside collection file:
    ...
    GET Media Agent
    GET V2 Media Agent
    PUT Set MA Maintenance Mode
    GET Media Agent Power Management
    POST Library
    GET Library
    GET Library Details
    GET Media Agent for Library
    GET Device Controller
    POST Edit Device Controller
    POST Delete Device Controller
    POST Delete Library
    POST Lock MM Configuration
    POST Unlock MM Configuration
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Storage Resource operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Storage Resource Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'StorageResourceOperation.collection.json'
