...
from Application.CloudApps.amazon_helper import AmazonCLIHelper, AmazonCloudFormationHelper, AmazonEC2Helper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Metallic GuardRail - AWS cloud vm push install & backup using aws linux gateway and S3 storage"
        self.browser = None
        self.fs_obj = None
    ...
    def create_aws_role_gateway_parameter(self):
        ...
        self.backup_gw_param.append({"ParameterKey": "InstanceType",
                                     "ParameterValue": self.config.AWS.BackupGateway.InstanceType})
        ...
        self.backup_gw_param.append(
            {
                ...
                "ParameterValue": self.config.AWS.BackupGateway.BackupGatewayPackageLinux})
