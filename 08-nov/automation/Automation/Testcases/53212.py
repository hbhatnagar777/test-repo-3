...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case - Dell Equallogic Clone"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Dell Equallogic Clone- Basic acceptance Test for intellisnap operations"
