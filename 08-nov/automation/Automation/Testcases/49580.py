...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Windows- Interactive - Feature release upgrade using Bootstrapper"
    ...
    def run(self):
        ...
        try:
            ...
            silent_helper = SilentInstallHelper.create_installer_object(self.config_json.Install.
                                                                        commserve_client.client_name,
                                                                        self.service_pack,
                                                                        self.cs_machine,
                                                                        self.tcinputs)
