...
from Web.AdminConsole.GlobalConfigManager.Helper.gcm_plan_helper import GCMPlanHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[GCM][UI]: Create Plans from cloud console and validate propagation to service commcells"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            gcm_helper_obj = GCMPlanHelper(self.admin_console)
