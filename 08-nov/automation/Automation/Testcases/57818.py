...
APIs being validated inside collection file:
    ...
    GET {{ServerURL}}/SubclientPolicies
    GET {{ServerURL}}/SubclientPolicies/{{subclientPolicyId}}
    POST {{ServerURL}}/SubclientPolicies
    DELETE {{ServerURL}}/SubclientPolicies/{{subclientPolicyId}}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Subclient Policy operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Subclient Policy Operations with JSON"
    ...
    def run(self):
        ...
        try:
            collection_json = 'SubclientPolicyOperations.collection.json'
