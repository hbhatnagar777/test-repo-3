...
Inputs:
    ...
    SnapEngine          --      snap engine to set at subclient
                                Values: Dell EMC Storage Center Snap (DSM)
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Command Center: Snap Acceptance Test for Dell EMC Storage Center Snap (DSM)"
        self.snapengine_list = ['Dell EMC Storage Center Snap (DSM)']
        self.browser = None
