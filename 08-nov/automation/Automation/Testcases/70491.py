...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Entity Caching] - validate the data for companies entity"
        self.tcinputs = {
            'fq_filter': None,
    ...
    def setup(self):
        ...
        self._helper = OrganizationHelper(self.commcell)

    def run(self):
        """ run function of this test case """
        try:
            self._helper.validate_organization_cache_data()
    ...
    def tear_down(self):
        ...
        self._helper.cleanup_orgs('caching_automation_')
