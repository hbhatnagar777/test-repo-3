...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.name = "Unix service granular management on Instance002"
    ...
    def setup(self):
        ...
        self.unix_machine = self.install_helper.get_machine_objects(
            type_of_machines=2, **{"instance": "Instance002"})[0]
    ...
    def get_services_list(self, packages):
    ...
    def tear_down(self):
        ...
        self.unix_helper.uninstall_client(delete_client=True, instance="Instance002")
