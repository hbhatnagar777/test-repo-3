...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Create index Server with a Backup Plan and verify it using FSO"
        self.tcinputs = {
    ...
    def create_index_server(self):
        ...
        self.index_servers_obj.create_index_server(
            ...
            backup_plan=self.tcinputs['BackupPlan'],
    ...
    def run(self):
        try:
            ...
            self.index_servers_obj.verify_backup_plan(self.index_server_name, self.tcinputs['BackupPlan'])
