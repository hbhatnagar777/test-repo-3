...
APIs being validated inside collection file:
    ...
    POST /CommServ/SNMPV3Configuration (update operation)
    POST /CommServ/SNMPV3Configuration (delete operation)
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for SNMPV3 Configuration Operations"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - JSON - SNMPV3 Configuration Operations"
    ...
    def run(self):
        ...
        try:
            collection_json = 'SNMPV3ConfigurationsOperations.collection.json'
