...
class TestCase(CVTestCase):
    """Class for executing basic acceptance test for SQL Metallic onboarding, backup and restore on windows servers"""
    ...
    def create_sqlhelper_object(self):
        ...
        for i in range(0, 5):
            try:
                ...
                self.log.error("Ran into SDK exception. Sleeping for 1 min and trying again")
                sleep(60)
                continue
            break
