...
class TestCase(CVTestCase):
    """Class For executing basic acceptance test of Sensitive data governance using default inventory for \
       share point files  configured to use Sharepoint (V2) Advanced Configuration from Activate in command center """
    test_step = TestStep()

    def __init__(self):
        super(TestCase, self).__init__()
        self.name = ("Basic acceptance of Sensitive data governance using default inventory for share point files \
        configured to use Sharepoint (V2) Advanced Configuration from Activate in command center")
