...
Example input:
    "54050": {
        "clientName": "mifxlin",
        "fileSystemSubclient": "default1",
        "informixInstanceName": "ol_informix1210"
        }
"""
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Store: Install,Execute Workflow 'Informix Snap Script Creation'"
        self.workflow = "Informix Snap Script Creation"
        self.tcinputs = {
            "clientName": None,
            "fileSystemSubclient": None,
            "informixInstanceName": None
        }
        ...
        self.workflow_obj.execute(
            {
                ...
                'file_sys_subclient':self.tcinputs['fileSystemSubclient'],
                'informix_instance':self.tcinputs['informixInstanceName']
            })
