...
class TestCase(CVTestCase):
    ...
    Backward Compatibility - Firewall Connection via Network gateway - Acceptance validation
    ...
    def __init__(self):
        ...
        self.name = ("[Firewall] : Backward Compatibility - "
                     "Firewall Connection via Network gateway - Acceptance validation")
        ...
        self.tcinputs = {
            ...
            "NetworkClient1v11": None,
            "NetworkClient2v11": None,
            "NetworkClient3v11": None,
            "NetworkGateway": None
        }
        self._client_group_name = 'CG_48893_CL'
        self._cs_client_group = 'CG_48893_CS'
        self._gw_client_group = 'CG_48893_GW'
        self.commserv = None
        self._network = None
        self.client_group_obj = None
        self.topology_name = "TOPOLOGY_48893"
    ...
    def setup(self):
        ...
        self.client_list.extend([self.commserv,
                                 ...
                                 self.tcinputs['NetworkClient1v11'],
                                 self.tcinputs['NetworkClient2v11'],
                                 self.tcinputs['NetworkClient3v11'],
                                 self.tcinputs['NetworkGateway']])
        ...
        self.client_group_obj3 = self.client_groups[self._gw_client_group]['object']
    ...
    def run(self):
        ...
        try:
            ...
            self.client_group_obj3.add_clients([self.client_list[6]])

            self.log.info("Started executing testcase")

            self._network.serverbase.check_client_readiness(self.client_list)

            self._network.proxy_topology(self._client_group_name,
                                         self._cs_client_group,
                                         self._gw_client_group,
                                         self.topology_name)
