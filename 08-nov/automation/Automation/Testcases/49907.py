...
class TestCase(CVTestCase):
    """Class for executing basic network case to validate proxy network topology
    ...
    def __init__(self):
        ...
        self.name = ("[Network & Firewall] : Proxy Network Topology basic acceptance")
        ...
        self._client_group_name1 = 'CG1_49907'
        self._client_group_name2 = 'CG2_49907'
        self._client_group_name3 = 'CG3_49907'
        self.commserv = None
        self._network = None
        self.client_group_obj = None
        self.topology_name = "TOPOLOGY_49907"
    ...
    def run(self):
        ...
        try:
            ...
            self._network.validate_proxy_topology(self.topology_name)
            ...
            self.log.info("Creating proxy topology again with wildcard routes")

            self._network.proxy_topology(self._client_group_name1,
                                         self._client_group_name2,
                                         self._client_group_name3,
                                         self.topology_name, wildcard=True)
