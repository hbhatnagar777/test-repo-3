...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Azure DevOps IDA - Verify Backup and Restore for Artifacts"
        self.browser = None
    ...
    def setup(self):
        ...
        try:
            ...
            self.tcinputs['azure_services'] = ['Artifacts']
    ...
    def download_data_and_backup(self):
        ...
        for project in content:
            self.azure_app_helper.azhelper.download_services_data(project, services=['Artifacts'])
        self.log.info("Successfully downloaded services data for test projects : %s", content)
        self.azure_app_helper.backup_from_repository_groups(repository_group, services=['Artifacts'])
    ...
    def restore_and_validate_data_in_place(self):
        ...
        for iteration in range(0, 2):
            ...
            if iteration == 1:
                ...
                # Choose only Artifacts in iteration 0
                services = ['Artifacts']
            ...
            self.azure_app_helper.download_and_validate_services_data(content, services=['Artifacts'], in_place=True)
    ...
    def restore_and_validate_data_out_of_place(self):
        ...
        for iteration in range(0, 2):
            ...
            new_content = []
            for project in content:
                dest_project = self.tcinputs.get("dest_project", f"destination_project_of_{project}")
            ...
            self.azure_app_helper.download_and_validate_services_data(new_content, services=['Artifacts'],
                                                                      out_of_place=True,
    ...
    def run(self):
        ...
        2) Backup selected content(projects and repositories) with only Artifacts service,download service data
        3) Restore all projects and repositories for in place azure restore, select only Artifacts service
        ...
        6) Restore all projects and repositories for out of place azure restore, select only Artifacts service
