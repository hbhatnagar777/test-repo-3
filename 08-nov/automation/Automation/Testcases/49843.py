...
class TestCase(CVTestCase):
    """Class for workflow suspend/resume and user impersonation through
    Workflow activities"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Impersonate user and suspend/resume workflow job"
    ...
    def setup(self):
        ...
        self._workflow = WorkflowHelper(self, "wf_miscellaneous")
