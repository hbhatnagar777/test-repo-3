...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Entity Caching] - validate the data for user entity"
        self.tcinputs = {
            'fq_filter': None,
    ...
    def setup(self):
        ...
        self._helper = UserHelper(self.commcell)

    def run(self):
        """ run function of this test case """
        try:
            self._helper.validate_users_cache_data()
    ...
    def tear_down(self):
        ...
        self._helper.cleanup_users('caching_automation_')
