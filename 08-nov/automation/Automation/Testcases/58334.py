...
class TestCase(CVTestCase):
    """[Laptop] [Admin Console]: Derived Plan validation with Override restriction as not allowed"""
    test_step = TestStep()
    def __init__(self):
        """
        ...
        self.name = "[Laptop] [Admin Console]: Derived Plan validation with Override restriction as not allowed"""
        self.browser = None
    ...
    def create_base_plan(self):
        ...
        self.plan_obj.retention = {'deleted_item_retention': {'value': '15', 'unit': ['year(s)']},
    ...
    def override_required_for_base_plan(self):
        """ Allowing base plan to be overridden, with all parameters as Override not allowed """
        self.plan_obj.edit_plan_dict = {
            ...
            "backup_data": "",
            "alerts": None,
            "override_restrictions": {"Storage pool": "Override not allowed",
    ...
    def validate_overriding(self):
        ...
        override_entities = {
            ...
            'RPO': {'Backup frequency': 'Runs every 33 hour(s)'},
            'Retention': {'Deleted item retention': '15 year(s)', 'File versions': '15 versions'},
    ...
    def login_to_adminconsole(self, login_username, login_password):
        ...
        self.base_plan_name = "Automation_Base_58334" 
        self.derived_plan = "Automation_derived_58334"
    ...
    def run(self):
        ...
        try:
            ...
            self.server_obj.log_step("""
                ...
                2. Create Base Plan AS MSP Admin With required components as "override  not allowed"
