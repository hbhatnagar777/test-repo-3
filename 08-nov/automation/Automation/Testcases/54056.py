...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp OCUM Replication for FanOut
    Configuration"""
    ...
    def __init__(self):
        ...
        self.name = """Automation : SnapShot Replication: Verifies Netapp OCUM based
        Replication for FanOut Configuration"""

    def run(self):
        """Main function for test case execution"""
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "fanout"
