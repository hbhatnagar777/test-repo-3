...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = 'Verification of all types of restores using all possible combinations in both scenarios when ' \
    ...
    def run(self):
        ...
        try:
            ...
            # Perform inplace restores
            self.log.info("Peroforming inplace restores with skip file permissions enabled")
            self.perform_inplace_restores()

            # Perform inplace restores with skip file permissions disabled
            self.log.info("Peroforming inplace restores with skip file permissions disabled")
            self.perform_inplace_restores(skip_file_permissions=False)

            # Include deleted items option verification
            self.log.info("Peroforming restores with include deleted items option")
