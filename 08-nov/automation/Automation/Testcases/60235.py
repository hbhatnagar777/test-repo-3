...
APIs being validated inside collection file:
    ...
    GET /v4/FirewallTopology
    POST /v4/FirewallTopology
    GET /v4/FirewallTopology/{topologyId}
    PUT /v4/FirewallTopology/{topologyId}
    DELETE /v4/FirewallTopology/{topologyId}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI Network Topology"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified Firewall Topology APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPIFirewallTopology.collection.json'
