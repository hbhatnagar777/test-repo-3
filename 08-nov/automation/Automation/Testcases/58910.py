...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[Cloud Laptop]: Validate removal of exception after backup"
    ...
    def exception_validate(self, operation="ADD"):
        ...
        folder_path=(self.dest_path + str(self.slash_format) + data_path_leaf)
        restore_file_list = self.machine_object.get_folder_or_file_names(folder_path)
        ...
        if operation == 'ADD':
            if not (docfilecount == 5 and txtfilecount == 5):
                raise Exception("Exception content is not honored  and not backedup correctly")
    ...
    def run(self):
        ...
        try:
            ...
            if self.tcinputs['os_type']=='Mac':
                ...
                self.data_folder = self.test_folder + "/TC_58910"
            ...
            for i in range(0,5):
                ...
                self.machine_object.create_file(text_file_path, "Validation of Exception of backup with text file")
                self.machine_object.create_file(doc_file_path, "Validation of exception of the backup doc file")
            ...
            self._log.info("*****Remove  Exception as *.txt and validate backup******")
            ...
            self.utility.sleep_time(60, "sleep until restore goes to pending")
            ...
            self._log.info("***** Validation of removal of exception content completed successfully *****")
