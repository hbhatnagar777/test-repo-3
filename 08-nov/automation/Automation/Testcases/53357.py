...
from VirtualServer.VSAUtils import VirtualServerHelper, OptionsHelper, VirtualServerUtils, VsaTestCaseUtils
from AutomationUtils import logger, constants


class TestCase(CVTestCase):
    """Class for executing virtual lab in isolated network from snap backup"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "VSA VMWARE Virtual Lab in Isolated network- from Snap Backup (copy precedence 1)"
