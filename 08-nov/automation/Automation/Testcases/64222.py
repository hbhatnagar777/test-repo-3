...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Dynamics 365 Basic Acceptance Case for Service Catalogue"
        self.browser = None
        self.navigator = None
    ...
    def run(self):
        ...
        try:
            ...
            self.d365_helper.dynamics365_apps.add_association(assoc_type=D365AssociationTypes.TABLES,
                                                              plan=self.d365_plan,
