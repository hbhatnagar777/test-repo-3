            ...
            "64267":
                {
                    ...
                    "SrcWalletPassword": password for source db wallet
                    "DestWalletPassword": password for destination db wallet
                }
        }
...
class TestCase(CVTestCase):
    """ Class for executing wallet restore for out of place pdb clone Test for oracle rac"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Oracle RAC on Command Center - out of place pdb clone with wallet"
        self.browser = None
        self.admin_console = None
        self.navigator = None
        self.tablespace_name = 'CV_64267'
    ...
    def run_restore(self):
        ...
        job_id = restore_panel.out_of_place_restore(
            ...
            dest_wallet_password = self.tcinputs.get("DestWalletPassword"))
        self.wait_for_job_completion(job_id)
