...
class TestCase(CVTestCase):
    """Testcase : Universal Installer: Use tenant admin credentials to install a linux client to Master CS"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Universal Installer: Use tenant admin credentials to install a linux client to Master CS"
