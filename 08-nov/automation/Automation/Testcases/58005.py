...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Verify Fresh installation of CA package on Linux machine and validate RER & custom entity" \
    ...
    def setup(self):
        ...
        try:
            ...
            self.storage_policy = f"58005_{option_helper_obj.get_custom_str()}"
            self.subclient = f"58005_{option_helper_obj.get_custom_str()}"
