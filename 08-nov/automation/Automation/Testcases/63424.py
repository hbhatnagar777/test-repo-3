...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Isilon -Backupcopy- NDMP Single Path Multi-stream restartability (all paths are restarted)"
    ...
    def run(self):
        ...
        try:
            ...
            if self.tcinputs['all_streams'].upper() == 'TRUE':
                all_streams = True
            else:
                all_streams = False
            self._nas_helper.run_restartable_backup(job, all_streams)
