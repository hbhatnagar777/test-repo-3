...
class TestCase(CVTestCase):
    """Testcase : Fresh Installation and Interactive Repair of Unix Client"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.install_inputs = {}
        self.name = "Fresh Installation and Interactive Repair of Unix Client"
    ...
    def run(self):
        ...
        try:
            ...
            # Repairing the client interactively with bootstrapper
            silent_helper = SilentInstallHelper.create_installer_object(self.machine_name,
                                                                        self.tcinputs["ServicePack"],
                                                                        self.unix_machine,
                                                                        self.install_inputs)
            silent_helper.silent_repair()
