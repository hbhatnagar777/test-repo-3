...
class TestCase(CVTestCase):
    ...
    "56192": {
        ...
        "database_options": {
                ...
                "port":"pgsqldb2.postgres.database.azure.com:5432",
    ...
    def __init__(self):
        ...
        self.name = "Basic Acceptance Test of Azure Paas PostgreSQL backup and restore"
    ...
    def run(self):
        ...
        try:
            ...
            for i in ["postgres", "template0", "azure_maintenance","azure_sys"]:
