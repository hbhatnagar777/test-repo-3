...
class TestCase(CVTestCase):
    """Class for executing use proxy and revert restore for PostgreSQL SNAP using command center"""
    test_step = TestStep()

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Backup and restore using proxy and revert restore for intellisnap " \
    ...
    def run_restore_validate(self, backup_metadata, restore_type="revert"):
        """ method to run restore, validate test data and restore options
        Args:
        ...
        Raises:
            CVTestStepFailure exception: if restore option check in commvault logs fail
        """
        ...
        if restore_type == 'backup_copy':
            ...
            text = "= " + str(copy_precedence_primary)
