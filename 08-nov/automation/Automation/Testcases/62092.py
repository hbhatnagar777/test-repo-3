...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[SAML] Create, Edit, Delete, Association, Disassociation via REST API"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "adminUser": self.tcinputs['ADAdmin'],
                       "pass": self .tcinputs['ADAdminPass'],
                       "netBiosName": self.tcinputs['netBiosName']}

    def run(self):
        """Main function for test case execution"""

        try:
            collection_json = 'SAMLOperations.postman.collection.json'
