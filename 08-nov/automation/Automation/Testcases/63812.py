...
class TestCase(CVTestCase):
    """Class for executing basic testcase for attach disk restore from SYNTH VMware Cloud director backups through Admin Console"""""

    def __init__(self):
        """" Initializes test case class objects"""""
        super(TestCase, self).__init__()
        self.name = "VMware Cloud director Synth Full Backup and Attach Disk Restore"
