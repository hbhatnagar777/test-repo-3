...
class TestCase(CVTestCase):
    """Class for verifying proxy distribution during restore to different hypervisor for VMware from Command Center"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Proxy workload validation for full VM restore to different hypervisor from command center"
    ...
    def setup(self):
        ...
        self.vsa_obj.destination_host = self.tcinputs.get('Host', None)
        self.vsa_obj.destination_datastore = self.tcinputs.get('Datastore', None)
