...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center Laptops page APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_laptops,get_laptop_details,get_laptop_security,get_alertrule_laptop,get_laptop_permissions,get_laptop_schedule,get_laptop_jobs,get_tag_entity",
