...
APIs being validated inside collection file:
    GET /v4/UserGroup
    POST /v4/UserGroup
    PUT /v4/UserGroup/action/delete
    GET /v4/UserGroup/{userGroupId}
    PUT /v4/UserGroup​/{userGroupId}
...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for PAPI User Groups"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "[PAPI] : Simplified UserGroup APIs"
    ...
    def run(self):
        ...
        try:
            collection_json = 'PAPIUserGroup.collection.json'
