...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = 'Testcase for Verification of JSON Console Alert when Backup Job Succeeds'
        tcinputs = {
          "AgentName":None,
          "BackupsetName":None,
          "BackupType":None,
    ...
    def run(self):
        ...
        try:
            ...
            alert_name = 'Test Console Backup Job ' + self.generate_random_string()
            alert_data = alert_helper.get_alert_details(name=alert_name,
                                                        notif_type=['Console Alerts'],
            ...
            # Sleep for 100s before checking
            time.sleep(100)
            # Function to read check if console alert generated and matches alert details
            alert_helper.check_if_console_alert_contains(patterns=[self.cache.get("job_id"),
