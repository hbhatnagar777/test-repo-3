...
TestCase:
    ...
    edit_credential()                           -- Edits Credential from Credential Manager Page

    create_credential()                         -- Creates Credential from Credential Manager Page
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "DB2 Add/Delete Instance and Backupset Test"
        self.dbtype = None
        self.browser = None
        ...
        self.servers = None
        self.new_password = ''.join(secrets.choice(string.ascii_letters + string.digits) for _ in range(12))
        self.tcinputs = {
            "instance_name": None,
            "db2_username": None,
    ...
    def setup(self):
        ...
        try:
            ...
            self.credential_manager = CredentialManager(admin_console=self.admin_console)
    ...
    def run(self):
        ...
        self.db2_helper.modify_db2_instance_password(self.new_password)
    ...
    def edit_credential(self):
        """Edits the credential from Credential Manager page"""
        self.navigator.navigate_to_credential_manager()
        self.credential_manager.edit_credential(credential_name=self.tcinputs["credential_name"],
