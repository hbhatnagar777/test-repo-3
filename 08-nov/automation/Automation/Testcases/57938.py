...
class TestCase(CVTestCase):
    ...
    def power_off_all_cloud_mediaagents(self):
        ...
        """
        self.power_management.power_off_media_agents([self.source_ma_obj, self.destination_ma_obj, self.ddb_ma2_obj])

    def power_on_all_cloud_mediaagents(self):
        """
        Power-on all cloud MediaAgents
        """
        self.power_management.power_on_media_agents([self.source_ma_obj, self.destination_ma_obj, self.ddb_ma2_obj])
    ...
    def run(self):
        try:
            ...
            self.verify_mediaagents_are_on([self.source_ma_obj, self.destination_ma_obj, self.ddb_ma2_obj])
            ...
            self.power_management.validate_powermgmtjobtovmmap_table(self.job_obj.job_id,
                                                                     self.ddb_ma2_obj._media_agent_id, self.csdb)
            self.verify_mediaagents_are_on([self.destination_ma_obj, self.ddb_ma2_obj])
