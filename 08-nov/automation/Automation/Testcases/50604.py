...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Custom Package creation- validate Save User Answers option"
    ...
    def run(self):
        ...
        try:
            ...
            _retcode = self.custom_package_generator.compare_screens(
                **{"dir_name": "CustomPackageLOC",
                   "custom_package_flag": True,
                   "self.id": self.id}
            )
            ...
            if not _retcode:
                self.log.info("Screens do not match")
