...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "NetApp C mode - Wild Cards for Subclient Content and Filter"
    ...
    def run(self):
        ...
        try:
            ...
            nas_client = self._nas_helper.get_nas_client(self.client, self.agent, is_cluster=self._is_cluster)
