...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap Netapp
    Open Replication for PVV Configuration"""
    ...
    def run(self):
        ...
        log = logger.get_log()
        self.tcinputs['ReplicationType'] = "pvv_replica" #PVV open replication
