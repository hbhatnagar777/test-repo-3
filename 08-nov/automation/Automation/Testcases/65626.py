...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[GCM]: Negative Case - Basic Active Management Flow - Windows Service CommCell - Software Only Customer"
        self.tcinputs = {
            "CommcellName": ""
        }
        self.browser = None
    ...
    def validate_active_mgmt_flow(self):
        """Validates the AM flow for SW only user on windows commcell with negative validation"""
        self.__open_browser()
