...
TestCase:
    ...
    run_backup_restore()    --  To run backup and restore jobs
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Admin Console - Basic Disk Configuration Case, auxiliary copy and restore via CC"
        self.browser = None
    ...
    def create_storage(self):
        ...
        self.storage_helper.add_disk_storage(
            ...
            deduplication_db_location=[
                self.ddb_location + "_1",
                self.ddb_location + "_2",
                self.ddb_location + "_3",
                self.ddb_location + "_4",
            ])
