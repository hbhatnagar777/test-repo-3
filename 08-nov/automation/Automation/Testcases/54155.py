...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap HPE 3PAR StoreServ Replication"""
    ...
    def __init__(self):
        ...
        self.name = """V1 Indexing : SnapShot Replication: Verifies HPE 3PAR StoreServ
        Replication"""
