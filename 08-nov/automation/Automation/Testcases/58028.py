...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Azure VM region based restore- Incremental / Full backup"
    ...
    def run(self):
        ...
        try:
            ...
            self.vsa_obj.azure_cross_region_restore = True
            ...
            try:
                ...
                self.vsa_obj.full_vm_in_place = False
                self.vsa_obj.managed_vm = True
                self.vsa_obj.create_public_ip = True
