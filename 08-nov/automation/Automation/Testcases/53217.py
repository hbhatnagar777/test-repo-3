...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of IntelliSnap backup and Restore test case - Vplex 3PAR snap"""
    ...
    def __init__(self):
        ...
        self.name = "Automation - Vplex 3PAR snap - Basic acceptance Test for intellisnap operations-Simple volume"
