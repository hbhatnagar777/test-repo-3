...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Entity Developer Settings on client level"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Developer Settings Command Center - Entity settings on client level"
    ...
    def run(self):
        ...
        try:
            collection_json = 'AdditionalSettingsEntityClientLevel.collection.json'
