...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[REST API - Locust] - Performance testing for Command Center VM GROUPS Page V4 APIs"
    ...
    def setup(self):
        ...
        self.inputs = {"webserver": self.inputJSONnode['commcell']['webconsoleHostname'],
                       ...
                       "apiList": "get_papi_vmGroups,get_papi_vmGroupdetails,get_client_details,get_laptop_schedule,get_subclient_details,get_jobs_calendar",
