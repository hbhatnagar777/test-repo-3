...
class TestCase(CVTestCase):
    """Power Management Aux Copy :: Primary Copy-Cloud and Aux Copy-non-cloud and DDB1-Non-cloud and DDB2-non-Cloud"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Power Management Aux Copy :: Primary Copy-Cloud and Aux Copy-non-cloud and DDB1-Non-cloud and DDB2-non-Cloud"
    ...
    def verify_non_cloud_media_agents(self):
        ...
        if self.destination_ma_obj._is_power_management_enabled or self.ddb_ma1_obj._is_power_management_enabled or self.ddb_ma2_obj._is_power_management_enabled:
    ...
    def run(self):
        try:
            ...
            self.verify_mediaagents_are_on([self.source_ma_obj,])
            ...
            # DV2 is not required for this case as only the source MA is powered managed
