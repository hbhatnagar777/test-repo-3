...
from Web.AdminConsole.GlobalConfigManager.Helper.gcm_servergroup_helper import GCMServerGroupHelper
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "[GCM][UI]: Create Server groups from cloud console and validate propagation to service commcells"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            gcm_helper_obj = GCMServerGroupHelper(self.admin_console)
