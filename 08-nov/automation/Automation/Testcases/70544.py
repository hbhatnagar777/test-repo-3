...
class TestCase(CVTestCase):
    """Testcase : Fresh Installation of Windows Web Server"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self._service_pack_to_install = None
        self.name = "Fresh Installation of Windows Web Server"
    ...
    def run(self):
        ...
        try:
            ...
            self.windows_helper.silent_install(
                ...
                tcinputs=self.silent_install_dict, feature_release=_service_pack, packages=['WEB_SERVER'])
            ...
            install_validation = InstallValidator(self.client_obj.client_hostname, self,
                                                  ...
                                                  package_list=[WindowsDownloadFeatures.WEB_SERVER.value],
