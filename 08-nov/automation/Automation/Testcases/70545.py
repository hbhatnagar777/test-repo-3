...
class TestCase(CVTestCase):
    """Testcase : Fresh Installation of Unix Web Server"""

    def __init__(self):
        """Initializes test case class object"""
        super().__init__()
        self.name = "Fresh Installation of Unix Web Server"
    ...
    def setup(self):
        ...
        self.unix_machine =  Machine(
            machine_name=self.config_json.Install.web_server.machine_host,
            username=self.config_json.Install.web_server.machine_username,
            password=self.config_json.Install.web_server.machine_password)
        ...
        self.silent_install_dict = {
            ...
            "sqlSaPassword": self.config_json.Install.web_server.saPassword
        }
    ...
    def run(self):
        ...
        try:
            ...
            self.unix_helper.silent_install(
                ...
                tcinputs=self.silent_install_dict, packages=['WEB_SERVER'])
            ...
            install_validation = InstallValidator(self.client_obj.client_hostname, self,
                                                  ...
                                                  package_list=[UnixDownloadFeatures.WEB_SERVER.value],
