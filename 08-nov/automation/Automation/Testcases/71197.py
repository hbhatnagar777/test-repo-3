...
TestCase:
    ...
    add_azure_blob_oss_client()         -- creates an azure blob client
...
class TestCase(CVTestCase):
    """ Basic acceptance Test for Azure Blob Object Storage key based authentication using Flat Mode Scan from command center
        Example inputs:
        "71197": {
    ...
    def __init__(self):
        ...
        self.name = "ACCT1 for Azure Blob Key-based Auth from Command center using Flat Mode Scan"
        self.browser = None
    ...
    def run(self):
        ...
        try:
            ...
            # Change the scan type of the content group to FLAT_MODE
            self.object_storage.change_scan_type(object_storage_name=self.object_storage_name, scan_type="FLAT_MODE", content_group_name=self.content_group_name)
