...
class TestCase(CVTestCase):
    """Class for executing Basic acceptance test of Journal Mailbox backup and restore
    with journal recpient"""
    ...
    def __init__(self):
        ...
        self.testdata = None
        self._client = None
        self.name = "Journal Mailbox backup and restore with journal envelope"
