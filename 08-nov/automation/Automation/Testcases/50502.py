...
class TestCase(CVTestCase):
    """Class for executing set of REST APIs for Basic Login Logout With XML & JSON body"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "REST API - Basic Login Logout With XML & JSON body"
    ...
    def run(self):
        ...
        try:
            collection_json = 'BasicLoginandLogout.collection.json'
