...
"""Test case to verify vmware replication group creation and secondary copy job completion
...
class TestCase(CVTestCase):
    ...
    def __init__(self):
        ...
        self.name = "Vmware - Zeal Replication group CRUD test with Aux copy"
