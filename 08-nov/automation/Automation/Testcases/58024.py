...
class TestCase(CVTestCase):
    """ Class for executing test case for Save to Disk Alert Notification verification"""

    # Constructor for the testcase
    def __init__(self):
        """Initializes the testcase object"""
        super(TestCase, self).__init__()
        self.name = 'Testcase for Verifying Alert notification through Save to Disk Notification Type'
        self.cache = None
    ...
    def run(self):
        ...
        try:
            ...
            alert_data = alert_helper.get_alert_xml(name='TestAlertSaveToDisk',
            ...
            alert_helper.check_if_alert_saved(short_interval=30, patterns=[self.cache.get("job_id"),
