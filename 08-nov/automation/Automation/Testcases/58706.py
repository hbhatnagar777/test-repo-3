...
class TestCase(CVTestCase):
    """
        Class for executing Basic acceptance test of MySQL Amazon cloud paas backup and Restore test case
    ...
    def __init__(self):
        ...
        self.name = "Basic Acceptance Test of Amazon cloud Paas MySQL backup and restore"
