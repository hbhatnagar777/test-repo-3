...
class TestCase(CVTestCase):
    """Class for executing Basic Acceptance Test of File Indexing from FULL Streaming Backup
         - v1/v2 File Indexing"""

    def __init__(self):
        """Initializes test case class object"""
        super(TestCase, self).__init__()
        self.name = "Basic Acceptance Test of v1/v2 File Indexing from FULL Streaming Backup"
    ...
    def run(self):
        ...
        try:
            ...
            self.log.info("Now verify that File Indexing job runs and completes successfully")
