...
hypervisor_vm_web_restore_option_mapping = {
    ...
    hypervisor_type.Google_Cloud.value.lower(): {
        'volume_type': 'volumetype',    #Ask - not needed in web, should be in preset
        # 'datastore': 'destination_datastore',   #Ask - not needed in web, should be in preset
        'createPublicIP': 'create_public_ip',
        'publicReservedIP': 'public_reserved_static_ip',
        'privateReservedIP': 'private_reserved_ip',
        'ServiceAccount': 'service_account',
        'CustomMetadata' : 'custom_metadata',
        # 'Disk&SnapshotPruning': 'disk_snapshot_pruning',     #Ask - naming convention
    },
...
preset_hypervisor_vm_restore_options = {
    ...
    hypervisor_type.Oracle_Cloud_Classic.value.lower(): {},
    hypervisor_type.Google_Cloud.value.lower(): {
        "DiskType: disk_type"    #Ask - if merged keep one DiskType only
    },
    hypervisor_type.OPENSTACK.value.lower(): {},
    hypervisor_type.Azure_Stack.value.lower(): {},
    hypervisor_type.Rhev.value.lower(): {},
