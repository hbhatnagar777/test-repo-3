...
class SQLServerInstance(Instance):
    ...
    def _restore_request_json(
        ...
        """Returns the JSON request to pass to the API as per the options selected by the user.
            ...
            Args:
                ...
                schedule_pattern (dict, optional): Schedule pattern to associate to the restore request

                hardware_revert (bool, optional): Does hardware revert restore
    ...
    def restore(
        ...
        request_json = self._restore_request_json(
            ...
            hardware_revert=hardware_revert
        )
